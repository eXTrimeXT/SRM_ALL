import{N as NavTabs}from"./index-9a7f2446.js";import{ak as defineComponent,al as usePageHelper,aq as defineSchemas,ad as expression,ah as generateXindexInOrder,ae as i18nExpression,b$ as dataTimeSelectorSegment,af as yearMonthDaySelectorSegment,ar as RenderEngine,n as normalizeComponent}from"./index-6b6051d8.js";import{C as CategorySelect}from"./categorySelect-fd2521a2.js";const _sfc_main$1=defineComponent({__name:"list",setup(__props){const{t:$t,app}=usePageHelper(),schema=defineSchemas({OrderConfig:{type:"void","x-decorator":"el-container","x-decorator-props":{class:"flex-container",direction:"vertical"},"x-component":"QueryEngine","x-query-engine":{service:"sup-ce"},properties:{bus:{type:"void","x-component":"BusEvent","x-component-props":{eventName:"refreshList","@listener":expression(`() => {
