import{N as NavTabs}from"./index-9a7f2446.js";import{ak as defineComponent,aq as defineSchemas,ad as expression,ae as i18nExpression,af as yearMonthDaySelectorSegment,ah as generateXindexInOrder,ai as editTableFormItemValid,am as useAttrs,al as usePageHelper,ar as RenderEngine,ax as omit,ck as composeFormCollapse,a9 as OrganizationSelector,T as QuickSearch,n as normalizeComponent,b$ as dataTimeSelectorSegment,c9 as yearMonthDayHourMinuteSecondSelectorSegment,bD as changeFieldVisibleByDeps,cl as onActivated,cm as bus}from"./index-6b6051d8.js";import"./TableView-eb18d7e8.js";/* empty css                                                                   */import"./mixins-edc77a54.js";import"./i-order-detail.vue_vue_type_style_index_0_scoped_3fcf1ed6_lang-4ed993c7.js";import{d as deppOmit}from"./util-1e55288f.js";import"./index-d31c36cb.js";import"./drag-5571e5c7.js";const _sfc_main$2=defineComponent({__name:"edit-engine",setup(__props){const handleSubmit=(type="submit",$values,$queryEngine)=>{if(type==="submit"){for(let i=0;i<$values.perPlanMilestoneId.length;i+=1)if(!$values.perPlanMilestoneId[i].practicallyEndDate){app.__jump_error__("perPlanMilestone","component",$t("cusEntry.supplement20250205.milestoneActualEndTime"));return}}let data=deppOmit($values,["lastUpdateDate","creationDate","creationDate","contractCreationDate","currentPlanEndDate"]);return data=omit(data,["perPlanId.contractClass","perPlanId.contractNo","perPlanId.includeTaxAmount","perPlanId.vendorName","perPlanId.buName","perPlanId.currencyName","perPlanId.templateName","perPlanId.perPlanNo","perPlanId.processNum","perPlanMilestoneId.serialNumber","perPlanMilestoneId.milestoneType","perPlanMilestoneId.nodePersonName","perPlanMilestoneId.planStartDate","perPlanMilestoneId.planEndDate","perPlanMilestoneId.remarks","perPlanMilestoneId.fileId","perAcceptanceAttList.fileName","perAcceptanceAttList.createdUserName"]),$queryEngine.request.save({...data,perPlanMilestoneId:data.perPlanMilestoneId&&data.perPlanMilestoneId[0]},{customizeAction:type==="submit"?"vendorSubmit":void 0})},schema=defineSchemas({PerAcceptance:{type:"void","x-component":"FormContainer","x-decorator":"QueryEngine","x-query-engine":{service:"cm",actions:{vendorSubmit:{autoFormatResult:!1,transformRequest:expression(`(data, headers) => {
          ...
          $form.setValues(res.data[0])
              ...
              $handleSubmit('submit', $values, $queryEngine).then(() => {
                ...
                emitTabRemove($attrs.tabName)
                      ...
                      }`)},"x-query-engine-skip":!0,title:i18nExpression("perfMod.planEndDate"),"x-render-table-column":{minWidth:130}},nodePlanNum:{type:"string","x-query-engine-skip":!0,"x-disabled":expression(`
                      $disabled
                      || ['SUPPLIER_SUBMITTED','FIRST_PASS'].includes($values.status)
                    `),"x-render-table-column":{title:i18nExpression("perfMod.numberOfNodesDelivered"),minWidth:130},...editTableFormItemValid},practicallyEndDate:{"x-query-engine-skip":!0,...yearMonthDaySelectorSegment,"x-component-props":{...yearMonthDaySelectorSegment["x-component-props"],formatter:expression(`({ cellValue, row, column }) => {
                        parseTime(row.practicallyEndDate, '{y}-{m}-{d}')
                      }`)},"x-disabled":expression(`
                      $disabled
                      || ['SUPPLIER_SUBMITTED','FIRST_PASS'].includes($values.status)
                    `),"x-render-table-column":{title:i18nExpression("perfMod.actualEndTime"),minWidth:130},...editTableFormItemValid},remarks:{type:"string",title:i18nExpression("perfMod.specialRemarks"),"x-query-engine-skip":!0,"x-render-table-column":{minWidth:130}},fileId:{type:"string",title:i18nExpression("dataConfMod.attachmentTemplate"),"x-component":"SrmCommonFile","x-query-engine-skip":!0,"x-component-props":{readonly:!0,"default-file":{fileId:"{{$table.getRowByIndex($self.index)?.fileId}}",fileName:"{{$table.getRowByIndex($self.index)?.fileName}}"}},"x-render-table-column":{minWidth:130}}})}}},relevantAttachment:{type:"void","x-component":"CollapseItem","x-component-props":{title:i18nExpression("accountMod.relevantAttachment")},properties:{toolbar:{type:"void","x-component":"Space","x-component-props":{style:"margin-bottom: 16px"},properties:{add:{type:"void",title:i18nExpression("common.add"),"x-component":"RButton","x-component-props":{type:"primary",disabled:expression("$disabled"),"@click":expression(`(rowIndex) => {
          ...
          }`)}},query:{type:"object","x-query-engine-skip":!0,"x-component":"QueryFormByQueryEngine",properties:generateXindexInOrder({perAcceptanceNo:{type:"string",title:i18nExpression("bid_mod.perAcceptanceNo"),"x-query-engine-query-operator":"contains"},buId:{type:"string",title:"{{$t('bid_mod.businessEntity')}}","x-component":"OrganizationSelector","x-component-props":{multiple:!1},"x-query-engine-relation":"perPlanId"},createdFullName:{type:"string",title:"{{$t('common.creator')}}","x-query-engine-query-operator":"contains"},contractNo:{type:"string",title:"{{$t('contractMod.contractNo_1')}}","x-query-engine-query-operator":"contains","x-query-engine-relation":"perPlanId","x-query-engine-relation-strict":!0},status:{type:"string",title:i18nExpression("vendorMod.relegation.documentStatus"),"x-component":"DictSelect","x-component-props":{code:"CONTRACT_CHECK_STATUS"}},creationDate:{title:i18nExpression("common.creationDate"),...dataTimeSelectorSegment,"x-query-engine-query-operator":"between"}})},toolbar:{type:"void","x-query-engine-skip":!0,"x-component":"Space","x-component-props":{style:"margin-bottom: 16px;height:28px;"},properties:{void:{}}},table:{type:"array","x-component":"RenderTable","x-component-props":{class:"table-view-vxe-table",style:"flex: 1",preColumns:"seq",openCustomTable:!0},properties:generateXindexInOrder({perAcceptanceId:{type:"string","x-hidden":!0,"x-query-engine-primary-key":!0},lastUpdateDate:{type:"string","x-hidden":!0,"x-query-engine-primary-key":!0},perAcceptanceNo:{type:"string","x-component":"TableButton","x-component-props":{type:"text","@click":expression(`({ row }) => {
                let type = ['SUBMITTED', 'APPROVED'].includes(row.status) ? 'approval' : 'view'
                $editTab(type, row)
              }`)},"x-render-table-column":{title:i18nExpression("bid_mod.perAcceptanceNo"),minWidth:150,customRender:!0}},perPlanNo:{type:"string",title:i18nExpression("bid_mod.perPlanNo"),"x-query-engine-relation":"perPlanId","x-render-table-column":{minWidth:150}},status:{type:"string",title:i18nExpression("vendorMod.relegation.documentStatus"),"x-component":"DictSelect","x-component-props":{code:"CONTRACT_CHECK_STATUS"},"x-render-table-column":{minWidth:110}},buName:{type:"string",title:"{{$t('bid_mod.businessEntity')}}","x-query-engine-relation":"perPlanId","x-render-table-column":{minWidth:130}},vendorName:{type:"string",title:"{{$t('common.vendorName')}}","x-query-engine-relation":"perPlanId","x-render-table-column":{minWidth:150}},vendorCode:{type:"string",title:"{{$t('common.vendorCode')}}","x-query-engine-relation":"perPlanId","x-render-table-column":{minWidth:120}},contractNo:{type:"string",title:i18nExpression("bidMod.compactIndex"),"x-query-engine-relation":"perPlanId","x-render-table-column":{minWidth:100}},nodePersonName:{type:"string",title:i18nExpression("common.nodeLeader"),"x-query-engine-relation":"perPlanMilestoneId","x-render-table-column":{minWidth:130}},createdFullName:{type:"string",title:i18nExpression("common.creator"),"x-render-table-column":{minWidth:120}},creationDate:{"x-query-engine-sort":"desc",title:i18nExpression("common.creationTime"),...yearMonthDayHourMinuteSecondSelectorSegment,"x-component-props":{...yearMonthDayHourMinuteSecondSelectorSegment["x-component-props"],formatter:expression(`({ cellValue, row, column }) => {
                parseTime(row.creationDate, '{y}-{m}-{d} {h}:{i}:{s}')
              }`)},default:void 0,"x-render-table-column":{minWidth:150}},operation:{type:"void",title:"{{$t('common.operation')}}","x-render-table-column":{minWidth:120,fixed:"right"},"x-component":"RenderTableButtonList",properties:{deliver:{type:"void",title:i18nExpression("supRisk.deliver"),"x-reactions":changeFieldVisibleByDeps([".status"],"['DRAFT'].includes($deps[0])"),"x-component-props":{type:"text","@click":expression(`({ row }) => {
                      $editTab('edit', row)
                    }`)}},edit:{type:"void",title:i18nExpression("common.edit"),"x-reactions":changeFieldVisibleByDeps([".status"],"['FIRST_REJECTED'].includes($deps[0])"),"x-component-props":{type:"text","@click":expression(`({ row }) => {
                      $editTab('edit', row)
                    }`)}}}}})}}}}),{emitTabAdd,app,t:$t}=usePageHelper(),$editTab=(type,row)=>{let name=row.perAcceptanceNo||"";emitTabAdd({component:ContractPerformanceCheckDetailEngine,params:{flag:type,row:{...row,perPlanMilestoneId:row.perPlanMilestoneId?.perPlanMilestoneId??row.perPlanMilestoneId},tabName:$t("contractMod.contractAcceptance")+name,fromContractPerformancePlan:app.$route.params?.from==="contractPerformancePlan"},title:name?$t("contractMod.contractAcceptance")+name:$t("contractMod.newContractAcceptance"),name:$t("contractMod.contractAcceptance")+name})};return onActivated(()=>{app.$route.params?.from==="contractPerformancePlan"&&app.$route.params?.row&&$editTab("edit",app.$route.params.row)}),{__sfc:!0,schema,emitTabAdd,app,$t,$editTab,scope:{$editTab},RenderEngine}}});var _sfc_render$1=function(){var _vm=this,_c=_vm._self._c,_setup=_vm._self._setupProxy;return _c(_setup.RenderEngine,{attrs:{pageAttrs:_vm.$attrs,schema:_setup.schema,scope:_setup.scope,schemaKey:"PerAcceptance"}})},_sfc_staticRenderFns$1=[],__component__$1=normalizeComponent(_sfc_main$1,_sfc_render$1,_sfc_staticRenderFns$1,!1,null,null,null,null);const ContractPerformanceCheckListEngine=__component__$1.exports,activeTab="ContractPerformanceCheckListEngine",_sfc_main={name:"ContractPerformanceCheckVendor",components:{NavTabs},data(){return{activeTab,tabs:[{title:this.$t("contractMod.contractAcceptance"),name:activeTab,component:ContractPerformanceCheckListEngine,closable:!1}]}},methods:{firstTabActive(){this.$nextTick(()=>{bus.$emit("PerAcceptance",{reCalcContainerHeight:!0})})},handleTabRemove(data){data.activeTab===activeTab&&this.firstTabActive()}}};var _sfc_render=function(){var _vm=this,_c=_vm._self._c;return _c("NavTabs",{ref:"tabs",attrs:{"tabs-list":_vm.tabs,"cur-tab":_vm.activeTab},on:{"first-tab-active":_vm.firstTabActive,"tab-remove":_vm.handleTabRemove}})},_sfc_staticRenderFns=[],__component__=normalizeComponent(_sfc_main,_sfc_render,_sfc_staticRenderFns,!1,null,null,null,null);const index=__component__.exports;export{index as default};
