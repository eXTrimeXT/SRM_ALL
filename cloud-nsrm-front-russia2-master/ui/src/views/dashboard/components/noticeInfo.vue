...
export default {
  ...
  data () {
    return {
      ...
      applyArr: [
        ...
        { value: '120', label: 'purchase', text: this.$t('dashboard.purchase') },
  ...
  methods: {
    ...
    goToNotice (row) {
      this.$router.push({ name: 'checkAnnouncements', params: { id: row.noticeId } })
    }
  }
}
</script>
