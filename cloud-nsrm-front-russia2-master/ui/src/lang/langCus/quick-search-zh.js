export default {
  scc_npm_inspect_vendor_history: {
    scc_npm_inspect_vendor_history_title: '考察历史',
    inspectTime: '考察时间',
    inspectNum: '考察单号',
    bidingName: '项目名称',
    comprehensiveEvaluation: '综合评估意见'
  },
  scc_base_organization_dep: {
    scc_base_organization_dep_title: '部门',
    organizationCode: '部门编码',
    organizationName: '部门名称'
  },
  scc_base_organization_dept: {
    scc_base_organization_dept_title: '部门',
    organizationCode: '部门编码',
    organizationName: '部门名称'
  },
  scc_base_organization_sector: {
    scc_base_organization_sector_title: '板块',
    organizationCode: '板块编码',
    organizationName: '板块名称'
  },
  scc_base_organization_ou: {
    scc_base_organization_ou_title: '公司组织',
  ...
  ca_scc_npm_sou_bid_price: {
    ...
    brand: '品牌',
    priceTax: '含税单价（卢布）',
    fixedPriceTax: '固定含税单价（卢布）',
    priceNoTax: '未税单价（卢布）',
    priceSumNoTax: '未税总价（卢布）'
  },
  // 开票管理-SAP成本中心
  ...
  scc_npm_sou_expert_senior: {
    scc_npm_sou_expert_senior_title: '专家选择',
    expertFullName: '专家名称',
    email: '邮箱',
    ceeajobcodedescr: '岗位'
  },
