      ...
      >
        <template slot="left">
          <ExportExcel
            ...
            page-url="/api-pef/pj/scoring/perfOverallScore/listPerfOverallScorePage"
            export-mode="front"
          />
          <el-button
            v-if="curRole === 'VENDOR'"
...
export default {
  ...
  created () {
    ...
    let queryFormCom = [
      ...
      { prop: 'levelName', label: () => this.$t('perfMod.levelName'), type: 'select' }
    ]
    let queryFormBuyer = [
      {
        prop: 'scoreItemsId',
    ...
    this.tableHeader = [
      ...
      },
      {
        ...
        label: () => this.$t('cusEntry.perfMod.fullPathId'),
        width: '120'
      },
      {
        prop: 'companyName',
