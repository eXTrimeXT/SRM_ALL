...
export const organizationSetting = {
  ...
  listAllOrganizationNew: async data =>
    http({
      url: getUrl('/api-base/organization/organization/ch/listAllOrganization'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  getOrganization: async params =>
    http({
      url: getUrl('/api-base/organization/organization/pj/getOrganization'),
      method: 'GET',
      params,
      loading: true
    }),
  ...
  orgSaveOrUpdate: async data =>
    http({
      url: getUrl('/api-pj/organization/organization/saveOrUpdate'),
      method: 'POST',
      data,
      loading: true
    }),
