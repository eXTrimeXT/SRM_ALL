<template>
  <el-container class="box">
    ...
    <el-aside class="left">
      ...
      <div class="resize" :title="$t('dataConfMod.shrinkSidebar')">⋮</div>
    </el-aside>
    <el-main
      class="mid"
      style="
    ...
    >
        ...
        <template #parentOrganizationNames="{ scope }">
          <div class="parent-search">
            <el-input
              ...
              :disabled="true"
            />
            <el-button icon="iconfont iconselect" class="selectBtn" @click="searchParentOrgList" />
          </div>
        </template>
      </FormWrapper>
      ...
      <MainHeader :l-span="22" :r-span="2">
        <template slot="left">
          ...
          /> -->
          <ExportExcel
            page-url="/api-base/organization/organization/ch/listAllOrganization"
      ...
      <TableView
        ...
        :source="organizationSetting.listAllOrganizationNew"
      />
...
export default {
  ...
  created() {
    this.queryForm = [
      ...
      // '区域'
      {
        ...
        label: () => this.$t('cusEntry.dataConfMod.organizationRegion'),
        type: 'dict',
        code: 'REGION',
      },
      {
  ...
  methods: {
    ...
    loasFirstNode() {
      ...
      organizationSetting
        .getListChildrenData(queryParma, false)
        .then(response => {
          if (response && response.data) {
