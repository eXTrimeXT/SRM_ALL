<template>
  ...
  > -->
  <SrmDialog
    :title="$t('cusEntry.supplement20250121.viewPublicAnnouncementModificationHistory')"
    size="middle"
    :visible.sync="dialogVisible"
    :close-on-click-modal="false"
    append-to-body
  >
    ...
    >
      ...
      > -->
      <el-table-column
        :label="$t('cusEntry.supplement20250121.modifyDetails')"
        minWidth="150"
        show-overflow-tooltip
      >
      ...
      <el-table-column
        prop="createdFullName"
        :label="$t('cusEntry.supplement20250121.modifiedBy')"
        minWidth="150"
        show-overflow-tooltip
      />
    </el-table>
