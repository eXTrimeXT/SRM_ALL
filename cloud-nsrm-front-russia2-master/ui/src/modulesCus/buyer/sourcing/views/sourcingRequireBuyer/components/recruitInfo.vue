<template>
  <SrmRow>
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('bidMod.businessNo')" prop="reqHeadNo">
    ...
    <SrmCol :init-col="4">
      <!-- <el-form-item label="预算（卢布）" prop="totalAmountByTenKilo"> -->
      <el-form-item :label="$t('cusEntry.bidMod.budget')" prop="totalAmountByTenKilo">
        <el-input v-model="baseForm.totalAmountByTenKilo" disabled />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- <el-form-item label="品类" prop="categoryName"> -->
      <el-form-item :label="$t('common.category')" prop="categoryName">
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('cusEntry.supplement20250121.sourceFrom')" prop="requireFrom">
    ...
    <SrmCol :init-col="1">
      ...
      <el-form-item :label="$t('cusEntry.bidMod.bidScope')" prop="projectScope">
        <el-input
