      ...
      >
        <el-form ref="form" :model="form" :rules="formRules">
          <el-collapse v-model="colValue">
            ...
            <!-- 寻源内容 -->
            <el-collapse-item :title="$t('cusEntry.bidMod.searchContent')" name="2">
              <RecruitInfo
                ref="recruitInfo"
                :form.sync="form"
                :readonly="disabledFlag"
            ...
            <!-- 对供应商要求 -->
            <el-collapse-item :title="$t('sourcingBuyer.applyInfo')" name="3">
              <VendorRequire
                ref="vendorRequire"
                :form.sync="form"
                :readonly="disabledFlag"
            ...
            <!-- 报名联系方式 -->
            <el-collapse-item :title="$t('cusEntry.supplement20250121.registrationContactInformation')" name="4">
              <LinkInfo
                ref="linkInfo"
                :form.sync="form"
                :readonly="disabledFlag"
            ...
            <el-collapse-item :title="$t('components.workedProcess.headers.attachment')" name="6">
              <FileDynamic
                ref="sceneAttachment"
...
export default {
  ...
  methods: {
    ...
    async getWorkflowBusinessVariables () {
     const procTitleObj = { requirementHeadNo: this.form.requirementHeadNo }
      return {
        procTitleObj
      }
    },
