...
export const vendorGreenApi = {
  ...
  getCompanyInfo: async data =>
    http({
      url: getUrl('/api-sup/api-ql/CompanyInfo/query'),
      method: 'POST',
      data,
      loading: true
    })
...
export const quaApi = {
  ...
  batchSaveOrUpdate: async data =>
    http({
      url: getUrl('/api-pj/pj/sup/entryConfig/batchSaveOrUpdate'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  getCategoryInfoById: async categoryId =>
    http({
      url: getUrl('/api-sup/review/reviewForm/listCategoryInfoById'),
      method: 'POST',
      data: categoryId
    }),
  ...
  getAllOrg: async id =>
    http({
      url: getUrl(`/api-base/orgQuery/listAllForReviewForm?companyId=${id}`),
      method: 'GET',
      loading: true
    })
}
