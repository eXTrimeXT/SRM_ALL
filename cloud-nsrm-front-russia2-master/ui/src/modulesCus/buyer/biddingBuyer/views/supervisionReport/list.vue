  ...
  data () {
    return {
      ...
      preArr: [
        ...
        {
          prop: 'techSocreFrom',
          label: this.$t('cusEntry.supplement20250205.techSocreFrom')
        },
        // 技术得分（≤N）
        {
          prop: 'techSocreTo',
          label: this.$t('cusEntry.supplement20250205.techSocreTo')
        },
        // 综合得分（≥N）
        // {
        //   prop: 'comprehensiveScoreFrom',
        //   label: this.$t('cusEntry.supplement20250205.comprehensiveScoreFrom')
        // },
        // 综合得分（≤N）
        // {
        //   prop: 'comprehensiveScoreTo',
        //   label: this.$t('cusEntry.supplement20250205.comprehensiveScoreTo')
        // },
        {
          prop: 'isWin',
      ...
      tableHeader: [
        ...
        {
          prop: 'completeMonth',
          label: this.$t('cusEntry.supplement20250205.completeMonth'),
          minWidth: 150
        },
        {
          prop: 'souName',
        ...
        {
          prop: 'totalBudget',
          label: this.$t('cusEntry.supplement20250314.budgetAmountInRubles'),
          minWidth: 150
        },
        {
          prop: 'vendorName',
        ...
        // 第一轮供应商报价总价（未税）
        {
          ...
          label: this.$t('cusEntry.supplement20250314.firstRoundSupplierQuoteTotalExcludingTax'),
          minWidth: 160
        },
        {
        ...
        // 第八轮供应商报价总价（未税）
        {
          ...
          label: this.$t('cusEntry.supplement20250314.eighthRoundSupplierQuoteTotalPriceExcludingTax'),
          minWidth: 160
        },
        {
          prop: 'techSocre',
        ...
        {
          prop: 'caPrice',
          label: this.$t('cusEntry.supplement20250314.cusEntryBidSuperviseReportCaPrice'),
          minWidth: 160
        },
        // {
        //   prop: 'noticePrice',
