    ...
    <el-main>
      <div v-if="showTitle">
        <p style="font-weight:bold;font-size: 14px;">
          <!-- 供应商历史合作信息 -->
          {{ $t('cusEntry.supplement20250205.vendorHistory') }}
        </p>
      </div>
      <el-table
        border
      ...
      >
        ...
        <el-table-column
          align="center"
          prop="cyRate"
          :label="$t('cusEntry.supplement20250205.cyRate')"
          min-width="120"
          show-overflow-tooltip
        >
          <div slot="header">
            <span>{{ $t('cusEntry.supplement20250205.cyRate') }}</span>
            <!-- 参与率=参与投标审核有效性次数/被邀请投标次数*100% -->
            <el-tooltip
              effect="dark"
              :content="$t('cusEntry.supplement20250205.cyRateTip')"
              placement="top"
        ...
        <el-table-column
          align="center"
          prop="zbRate"
          :label="$t('cusEntry.supplement20250205.zbRate')"
          min-width="80"
          show-overflow-tooltip
        >
          <div slot="header">
            <span>{{ $t('cusEntry.supplement20250205.zbRate') }}</span>
            <!-- 中标率=中标次数/参与投标审核有效性次数*100% -->
            <el-tooltip
              effect="dark"
              :content="$t('cusEntry.supplement20250205.zbRateTip')"
              placement="top"
              class="table-column-tooltip"
            >
              <em class="el-icon-warning tip-icon" />
        ...
        <el-table-column
          align="center"
          prop="tj1Rate"
          :label="$t('cusEntry.supplement20250205.tj1Rate')"
          min-width="100"
          show-overflow-tooltip
        >
          <div slot="header">
            <span>{{ $t('cusEntry.supplement20250205.tj1Rate') }}</span>
            <!-- 被推荐率=申请部门推荐次数/推荐表总次数*100% -->
            <el-tooltip
              effect="dark"
              :content="$t('cusEntry.supplement20250205.tj1RateTip')"
              placement="top"
              class="table-column-tooltip"
            >
              <em class="el-icon-warning tip-icon" />
      ...
      <div style="margin-top: 20px;">
        ...
        >
          ...
          <el-table-column
            align="center"
            prop="isWin"
            :label="$t('cusEntry.bidSuperviseReport.isWin')"
            min-width="100"
            show-overflow-tooltip
          />
        </el-table>
