      ...
      <MainHeader :l-span="22" :r-span="2">
        <template slot="left">
          ...
          <QuickSearch
            ...
            showButton
            class="quickBtn"
            :btnTitle="$t('cusEntry.supplement20250121.createBid')"
...
export default {
    ...
    return {
      searchFormConfig: [
        ...
        // 部门
        {
          ...
          label: this.$t('components.approvalHead.headers.division'),
          type: 'quicksearch',
          showKey: 'organizationName',
          propKey: 'organizationId',
          name: 'scc_base_organization_dep'
        }
      ],
      tableHeader: [
        // 招标单号
  ...
  watch: {
    '$route.params': {
      ...
      handler (nVal) {
        ...
        if (['demandPoolManagementZhaobiao', 'bidNotice'].includes(from)) {
  ...
  methods: {
    ...
    createProjectSou (data) {
      let params = {
        souType: 'bid',
        reqHeadList: [{ requirementHeadId: data.requirementHeadId }]
      }
