    ...
    >
      ...
      >
        <template slot-scope="scope">
          {{$parseTime(scope.row.bidCreationDate)}}
        </template>
      </el-table-column>
      <el-table-column
        align="center"
      ...
      >
        <template slot-scope="scope">
          ...
          />
          <span v-else>{{ $parseTime(scope.row.publishTime) }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          ...
          />
          <span v-else>{{ $parseTime(scope.row.techEndTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column
        v-if="!techTimeHideFlag"
      ...
      >
        <template slot-scope="scope">
          <el-date-picker
            ...
            :picker-options="timePickerOptions"
          />
          <span v-else>{{ $parseTime(scope.row.techOpenTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column
        v-if="!techTimeHideFlag"
      ...
      >
        <template slot-scope="scope">
          <el-date-picker
            ...
            :picker-options="timePickerOptions"
          />
          <span v-else>{{ $parseTime(scope.row.techEvaluationTime) }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-date-picker
            ...
            :picker-options="timePickerOptions"
          />
          <span v-else>{{ $parseTime(scope.row.busEndTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column
        align="center"
      ...
      >
        <template slot-scope="scope">
          <el-date-picker
            ...
            :picker-options="timePickerOptions"
          />
          <span v-else>{{ $parseTime(scope.row.priceOpenTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column
        align="center"
      ...
      >
        <template slot-scope="scope">
          <el-date-picker
            ...
            :picker-options="timePickerOptions"
          />
          <span v-else>{{ $parseTime(scope.row.sumReportTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column
        align="center"
      ...
      >
        <template slot-scope="scope">
          <el-date-picker
            ...
            :picker-options="timePickerOptions"
          />
          <span v-else>{{ $parseTime(scope.row.picketageTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column
        align="center"
      ...
      >
        <template slot-scope="scope">
          <el-date-picker
            ...
            :picker-options="timePickerOptions"
          />
          <span v-else>{{ $parseTime(scope.row.publishWinLossTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column
        align="center"
      ...
      >
        <template slot-scope="scope">
          <el-date-picker
            ...
            :picker-options="timePickerOptions"
          />
          <span v-else>{{ $parseTime(scope.row.completeTime) }}</span>
        </template>
      </el-table-column>
    </el-table>
  </div>
