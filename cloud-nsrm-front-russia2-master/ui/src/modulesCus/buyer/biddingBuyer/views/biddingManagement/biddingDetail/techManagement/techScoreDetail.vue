  ...
  <el-container direction="vertical">
    <el-main>
      <el-collapse v-model="activeNames">
        <!-- 评分分析 -->
        <el-collapse-item :title="$t('cusEntry.supplement20250205.scoreAnalysis')" name="1">
          <el-table
            v-if="mergeFlag"
            border
            :data="vendorList"
          ...
          >
            ...
            >
              ...
              <el-table-column
                align="center"
                prop="totalScore "
                :label="$t('cusEntry.supplement20250205.totalScore')"
                min-width="150"
                show-overflow-tooltip
              >
              ...
              <el-table-column
                align="center"
                prop="averageScore "
                :label="$t('cusEntry.supplement20250205.averageScore')"
                min-width="150"
                show-overflow-tooltip
              >
                <template slot-scope="scope">
              ...
              <el-table-column
                ...
                :label="$t('cusEntry.supplement20250205.differenceRatio')"
                min-width="150"
                show-overflow-tooltip
              >
                <template slot-scope="scope">
        ...
        <!-- 评分详情 -->
        <el-collapse-item :title="$t('cusEntry.bidMod.techScoreDetail')" name="2">
          <el-button
            type="primary"
          ...
          >
            <!-- 查看评标历史 -->
            {{  $t('cusEntry.supplement20250205.viewBidHistory') }}
          </el-button>
          <!-- 技术评标结果_导出文件.xlsx -->
          <ExportDirect
            ...
            :filename="$t('cusEntry.supplement20250205.techFileExport')"
          />
          <!-- 导出汇总 -->
          <ExportDirect
            exprotUrl="/api-sou/ext/buyer/bid/init/exportScoreExcelBatch"
            requstType="POST"
            :btnText="$t('cusEntry.supplement20250205.exportSum')"
            :filterParams="{
              projectId: editRow.projectId
            }"
            :filename="$t('cusEntry.supplement20250205.exportSum1')"
          />
    ...
    techScoreHistory () {
      if (this.$attrs.params.editRow.from === 'fromFun') {
        ...
        this.$router.push({
          ...
          query: {
            from: 'fromFun',
            funName: 'bidTechScoreHistory',
            formId: this.editRow.projectId,
            row: this.editRow,
            groupRoleList: this.groupRoleList,
            extProjectNo: this.editRow.extProjectNo,
            souName: this.editRow.souName,
        ...
        let tab = {
          ...
          title: this.editRow.extProjectNo || this.editRow.souName + '-' + this.$t('cusEntry.supplement20250205.scoreHistory'),
