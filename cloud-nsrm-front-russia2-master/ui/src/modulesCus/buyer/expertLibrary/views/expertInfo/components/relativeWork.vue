<template>
  <div class="wrapper">
    <div class="header">
      <span class="red">*</span>
      <!-- 亲属工作单位全称 -->
      {{ $t("cusEntry.supplement20250205.relativeWorkUnitFullName") }}
      <!-- <span class="red">（请各专家如实填写工作履历及亲属工作信息，后期如有因隐瞒信息导致的评标审计问题，涉及专家需承担追溯后果。亲属为第一关联关系人，包含父母、配偶、子女、兄弟姐妹。）</span> -->
      <span class="red">{{ $t("cusEntry.supplement20250205.fillInTruthfullyTips") }}</span>
    </div>
    ...
    >
      ...
      <el-table-column
        prop="relativeType"
        :label="$t('cusEntry.supplement20250205.relationshipWithApplicant')"
      >
