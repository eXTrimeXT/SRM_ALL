<template>
  <div class="wrapper">
    <div class="header">
      <span class="red">*</span>
      <!-- 适用评分组织 -->
      {{ $t("cusEntry.supplement20250205.applicableScoringOrganization") }}
    </div>
    ...
    >
      ...
      <el-table-column
        prop="fullPathName"
        :label="$t('components.organization.organizationName')"
      />
...
export default {
  ...
  methods: {
    ...
    newOrganaztionTreehttp (data) {
      return this.$http({
        url: '/api-base/pj/organization/relation/treeNewAllGroupBuOu',
        method: 'POST',
        data
      })
    },
