<template>
  <div class="wrapper">
    <div class="header">
      ...
      <span class="title">{{ $t("cusEntry.supplement20250205.supplierBiddingStatus") }}</span>
      ...
      tableColumns: [
        ...
        },
        {
          attrs: {
            ...
            // label: '投标包名'
            label: () => this.$t('cusEntry.supplement20250205.bidPackageName')
          },
