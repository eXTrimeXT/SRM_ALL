        ...
        <el-form ref="form" :model="form" :rules="formRules">
          <el-collapse v-model="colValue">
            ...
            <el-collapse-item :title="$t('cusEntry.supplement20250205.tenderSummary')" name="2">
              <BidSum
                ref="bidSum"
                :value.sync="bidSumData"
                :readonly="true"
              />
              <BidVendor
                ref="bidVendor"
                :value.sync="form.caOrders"
            ...
            <!-- 原定标申请附件 -->
            <el-collapse-item :title="$t('cusEntry.supplement20250218.originalBidApplicationAttachment')" name="3">
              <FileDynamic
...
import BidSum from './components/businessInfo/bidSum'
import BidVendor from './components/businessInfo/bidVendor'
  ...
  methods: {
    ...
    async getFormDetail () {
      ...
      if (response.data.length) {
        ...
        this.originalCaId = rest.originalCaId
