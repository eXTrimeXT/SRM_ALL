<template>
  <SrmRow>
    ...
    <SrmCol :init-col="3">
      <el-form-item :label="$t('cusEntry.bidMod.applyDepartment')">
        <el-input v-model="headerData.orgDeptName" disabled />
      </el-form-item>
    </SrmCol>
    <!-- 价格有效截止日期 -->
    <SrmCol :init-col="3">
      <el-form-item :label="$t('cusEntry.centralizedPurchase.priceDeadline')">
        <el-date-picker
          v-model="headerData.priceDeadline"
          type="date"
          :format="$formatDatePicker"
        />
      </el-form-item>
