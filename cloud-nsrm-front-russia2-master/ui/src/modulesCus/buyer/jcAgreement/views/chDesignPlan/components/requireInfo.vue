  ...
  <div class="wrapper">
    <el-form ref="requireForm" :model="requireInfo" :rules="requireRules">
      <SrmRow>
        <SrmCol :init-col="4">
          <!-- 一级分类 -->
          <el-form-item :label="$t('cusEntry.supplement20250121.level1')" prop="oneCategoryName">
            <QuickSearch
              :disabled="readonly"
        ...
        <SrmCol :init-col="4">
          <!-- 二级分类 -->
          <el-form-item :label="$t('cusEntry.supplement20250121.level2')" prop="twoCategoryName">
            <QuickSearch
              :disabled="readonly"
        ...
        <SrmCol :init-col="4">
          <!-- supList -->
          <!-- 供应商名称 -->
          <el-form-item :label="$t('common.vendorName')" prop="supName">
            <QuickSearch
              :disabled="readonly"
        ...
        <SrmCol :init-col="4">
          <!-- orgList -->
          <!-- 申请单位 -->
          <el-form-item :label="$t('cusEntry.common.applicantUnit')" prop="orgName">
        ...
        <SrmCol :init-col="4">
          <!-- personList -->
          <!-- 采购员 -->
          <el-form-item :label="$t('bidMod.quotePurchasor')" prop="personName">
            <QuickSearch
              :disabled="readonly"
        ...
        <SrmCol :init-col="4">
          <!-- 品牌 -->
          <el-form-item :label="$t('dataConfMod.band')" prop="brand">
        ...
        <SrmCol :init-col="4">
          <!-- orderStatusList -->
          <!-- 订单状态 -->
          <el-form-item :label="$t('orderMod.orderStatus')" prop="orderStatusList">
            <DictSelect
        ...
        <SrmCol :init-col="4">
          <!-- 单项物资订单数 -->
          <el-form-item :label="$t('cusEntry.supplement20250121.orderNum')" prop="orderNum">
        ...
        <SrmCol :init-col="4">
          <!-- 单项物资采购金额（未税） -->
          <el-form-item :label="$t('cusEntry.supplement20250121.buyMoney')" prop="buyMoney">
        ...
        <SrmCol :init-col="4">
          <!-- 上年订单日期从 -->
          <el-form-item :label="$t('cusEntry.supplement20250121.lastYearOrderDateStart')" prop="lastYearOrderDateStart">
            <el-date-picker
        ...
        <SrmCol :init-col="4">
          <!-- 上年订单日期到 -->
          <el-form-item :label="$t('cusEntry.supplement20250121.lastYearOrderDateEnd')" prop="lastYearOrderDateEnd">
            <el-date-picker
        ...
        <SrmCol :init-col="4">
          <!-- 上上年订单日期从 -->
          <el-form-item :label="$t('cusEntry.supplement20250121.lastLastYearOrderDateStart')" prop="lastLastYearOrderDateStart">
            <el-date-picker
        ...
        <SrmCol :init-col="4">
          <!-- 上上年订单日期到 -->
          <el-form-item :label="$t('cusEntry.supplement20250121.lastLastYearOrderDateEnd')" prop="lastLastYearOrderDateEnd">
            <el-date-picker
    ...
    <div v-if="!readonly" class="btns">
      <el-button type="primary" @click="pullOrderData(1)">
        {{ $t('cusEntry.supplement20250121.pull') }}1
      </el-button>
      <el-button style="margin-left:10px;" type="primary" @click="pullOrderData(2)">
        {{ $t('cusEntry.supplement20250121.pull') }}2
      </el-button>
    </div>
  </div>
</template>
