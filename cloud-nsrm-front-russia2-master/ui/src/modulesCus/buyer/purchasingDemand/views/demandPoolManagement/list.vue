<template>
  ...
  >
    <el-main>
      ...
      >
        <template slot="left">
          ...
          <AuthorityButton
            @click="lishi"
          >
            {{ $t('cusEntry.supplement20250121.historyVendor') }}
          </AuthorityButton>
          <AuthorityButton
            @click="rejectOne"
          >
          ...
          <AuthorityButton
            @click="changeBuyType"
          >
            {{ $t('cusEntry.supplement20250121.changeBuyType') }}
          </AuthorityButton>
          <!-- 导出 -->
          <ExportExcel
            type="default"
      ...
      >
        ...
        >
          <el-row type="flex">
            <el-col>
              <el-form-item
                :label="$t('vendorMod.purchaseAgent')"
      ...
      >
        ...
        >
          ...
          <el-table-column
            ...
            width="100"
            prop="extReceiver"
            :label="$t('cusEntry.orderMod.extReceiveContact')"
            show-overflow-tooltip
          />
          <!-- 供应商编码 -->
          <el-table-column
      ...
      <!-- 退回原因 -->
      <srm-dialog
        :title="$t('qualitySynergy.pleaseFillInTheReasonForClosing')"
      ...
      >
        <el-main class="reject-reason-container">
          ...
          >
            <el-form-item
              :label="$t('qualitySynergy.closeReason')"
              label-width="70px"
              prop="extClosedCause"
            >
            ...
            <!-- 关闭附件 -->
            <el-form-item
              :label="$t('cusEntry.supplement20250121.extClosedFileId')"
      ...
      <!-- 变更购买类型 -->
      <srm-dialog
        :title="$t('cusEntry.supplement20250121.changeBuyType')"
...
export default {
  ...
  data () {
    return {
      ...
      rejectResonRules: {
        ...
        extBuyType: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        extBuyTypeComment: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }]
      },
      rules: {
  ...
  created () {
    this.tableHeader = [
      ...
      {
        prop: 'ceeaPrType',
        label: this.$t('cusEntry.inq.applyType'),
        width: 130,
      ...
      // 分单人
      {
        ...
        label: this.$t('cusEntry.supplement20250121.extPushUserName'),
        width: 110,
        showType: 'slot',
      ...
      {
        prop: 'extPushTime',
        label: this.$t('cusEntry.supplement20250121.extPushTime'),
        width: 100
      },
      // 需求状态
      {
      ...
      // 物资名称
      {
        ...
        label: this.$t('cusEntry.inq.materialName'),
        width: 110
      },
      {
        prop: 'categoryName',
        label: this.$t('vendorMod.category'),
        width: 100
      },
      {
      ...
      // 使用部门
      {
        ...
        label: this.$t('cusEntry.sup.extDepartment'),
        width: 120
      },
      // 使用人信息
      {
        prop: 'extUserName',
        label: this.$t('cusEntry.supplement20250121.extUserName'),
        width: 150,
        showType: 'slot',
        slot: 'extUserName'
      },
      ...
      {
        prop: 'extUserPhone',
        label: this.$t('cusEntry.sup.extUserPhone'),
        width: 150
      },
      // 计量单位
      {
      ...
      {
        prop: 'ifCreateInq',
        label: this.$t('cusEntry.supplement20250121.ifCreateInq'),
        width: 100,
        formattor: val => this.$getDictLabel('YES_OR_NO', val)
      },
      {
      ...
      {
        prop: 'extBuyType',
        label: this.$t('cusEntry.inq.extBuyType'),
        width: 100,
      ...
      {
        prop: 'orderQuantity',
        label: this.$t('cusEntry.supplement20250121.orderQuantity'),
        width: 90
      },
      {
        prop: 'receiveAddress',
      ...
      {
        prop: 'extUseTo',
        label: this.$t('cusEntry.inq.useTo'),
        width: 100
      },
      // 是否国内
      {
        prop: 'extIsHome',
        label: this.$t('cusEntry.supplement20250121.extIsHome'),
        width: 100,
        formattor: val => this.$getDictLabel('YES_OR_NO', val)
      },
      {
        prop: 'fileInfos',
        label: this.$t('bidMod.accessory'),
        width: 110,
        showType: 'slot',
        slot: 'fileInfos'
      },
      ...
      // 采购申请说明
      {
        ...
        label: this.$t('cusEntry.supplement20250121.ceeaAppointReasonTip'),
        width: 100
      },
      // 是否引出历史供应商
      {
        prop: 'extHistoryVendorFlag',
        label: this.$t('cusEntry.supplement20250121.extHistoryVendorFlag'),
        width: 100,
        formattor: val => this.$getDictLabel('YES_OR_NO', val)
      },
      // 供应商一
      {
        ...
        label: this.$t('cusEntry.supplement20250121.extHistoryVendorName1'),
        width: 100
      },
      {
        prop: 'extHistoryVendorPrice1',
        label: this.$t('basicPrice.price'),
        width: 100
      },
      // 供应商二
      {
        prop: 'extHistoryVendorName2',
        label: this.$t('cusEntry.supplement20250121.extHistoryVendorName2'),
        width: 100
      },
      {
      ...
      // 供应商三
      {
        ...
        label: this.$t('cusEntry.supplement20250121.extHistoryVendorName3'),
        width: 100
      },
      {
      ...
      {
        prop: 'extBuyTypeComment',
        label: this.$t('cusEntry.supplement20250121.extBuyTypeComment'),
        width: 100
      },
      {
        prop: 'extClosedCause',
      ...
      {
        prop: 'closeFile',
        label: this.$t('cusEntry.supplement20250121.extClosedFileId'),
        width: 110,
        showType: 'slot',
        slot: 'closeFile'
      }
  ...
  methods: {
    ...
    lishi () {
      ...
      this.$http({
        ...
        .then(res => {
          this.$message({ type: 'success', message: this.$t('components.approvalHead.tips.approvalCompletion') })
    ...
    afterQuery (data) {
      this.$refs[this.gridId].setTableData(async tableData => {
        let response = []
        let materialIds = tableData.map(item => item.materialId)
        ...
        tableData.forEach((item, index) => {
          ...
          res.materialNameShow = data?.materialName
          res.extMaterialModelShow = data?.extMaterialModel
    ...
    getQuerydata (obj) {
      ...
      const { dateList, extPoolStatus, ceeaPrType, ...rest } = obj || this.queryParam
      const params = {}
      if (dateList) {
    ...
    createInquiry () {
      ...
      if (bol4) {
        // 请选择需求状态为有效的单据
        this.$message.warning(this.$t('cusEntry.supplement20250121.promptTips30'))
        return false
      }
      if (bol1) {
        // 请选择已分配单据
        this.$message.warning(this.$t('cusEntry.supplement20250121.promptTips31'))
        return false
      }
      if (bol2) {
        // 所勾选的数据存在购买类型为协议类的，不允许创建询比价
        this.$message.warning(this.$t('cusEntry.supplement20250121.promptTips32'))
        return false
      }
      if (bol3) {
        // 请引出历史供应商
        this.$message.warning(this.$t('cusEntry.supplement20250121.promptTips33'))
        return false
      }
      const obj = {
        souType: 'inq',
    ...
    buyTypeFun () {
      ...
      if (!extBuyTypeComment) {
        // 请填写原因
        this.$message.error(this.$t('cusEntry.supplement20250121.promptTips34'))
        return false
      }
      let attr = []
    ...
    //   if (extPoolStatus == 'Y') {
    //     if (orderQuantity == 0) {
    //       status = this.$t('vendorMod.completed')
    //     } else {
    //       status = this.$t('bid_mod.effective')
    //     }
    //   } else if (extPoolStatus == 'N') {
    //     status = this.$t('sourcingBuyer.closed')
    //   }
    //   return status
    // },
    createOrder () {
    ...
    rejectReasonConfirm () {
      ...
      if (!this.rejectReason.extClosedCause || this.rejectReason.extClosedCause == '') {
        this.$message.error(this.$t('qualitySynergy.pleaseFillInTheReasonForClosing'))
        return false
      }
      // if (!this.rejectReason.extClosedFileId) {
      //   // 请上传关闭附件
      //   this.$message.error(this.$t('cusEntry.supplement20250121.promptTips35'))
      //   return false
      // }
