    ...
    return {
      ...
      tableHeader: [
        ...
        },
        {
          prop: 'extAttachId',
          // label: '订单附件',
          label: () => this.$t('cusEntry.supplement20250121.orderAttachment'),
          showType: 'slot',
          slot: 'extAttachId',
          minWidth: 200
        }
  ...
  methods: {
    ...
    addCheckOrder () {
      if (!this.form.orgId || !this.form.vendorId) {
        ...
        this.$message.warning(this.$t("cusEntry.supplement20250121.pleaseSelectBusinessEntityAndSupplierFirst"))
        return
      }
    ...
    comfirmAddDetail () {
      if (this.selection.length == 0) {
        ...
        this.$message.warning(this.$t("cusEntry.supplement20250121.pleaseSelectDataFirst"))
        return
      }
      ...
      if (repeatFlag) {
        ...
        this.$message.warning(this.$t("cusEntry.supplement20250121.pleaseDoNotAddDuplicateOrders"))
        return
      }
        ...
        if (valid) {
          ...
          this.detailTableData.some((item, index) => {
            if (!item.checkQty) {
              ...
              errMsg = `${this.$t("cusEntry.supplement20250121.acceptanceOrderDetailMissingPrompt1")}${index + 1}${this.$t("cusEntry.supplement20250121.acceptanceOrderDetailMissingPrompt1")}`
              return true // 跳出循环
            }
          })
          if (errFlag) {
