      ...
      table: {
        ...
        properties: generateXindexInOrder({
          ...
          includeTaxAmount: {
            type: 'string',
            // title: "合同含税金额",
            title: "{{ $t('contract_mod.contractTaxAmount') }}",
            'x-component-props': {
              style: "float:right"
            },
            'x-render-table-column': {
          ...
          currentMilestoneType: {
            type: 'string',
            // title: "当前里程碑节点",
            title: "{{ $t('contract_mod.currentMilestoneNode') }}",
            'x-component': 'DictSelect',
            'x-component-props': {
          ...
          currentNodePersonName: {
            type: 'string',
            // title: "节点责任人",
            title: "{{ $t('contract_mod.nodePerson') }}",
            'x-render-table-column': {
              width: 120
            }
          },
          currentPlanEndDate: {
            // title: "里程碑计划结束日期",
            title: "{{ $t('contract_mod.milestonePlanEndDate') }}",
            ...yearMonthDaySelectorSegment,
            'x-component-props': {
              ...yearMonthDaySelectorSegment['x-component-props'],
              formatter: expression(`({ cellValue, row, column }) => {
