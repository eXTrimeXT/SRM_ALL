...
export default {
  ...
  created () {
    ...
    this.tableHeader = [
      ...
      {
        prop: 'lastUpdateDate',
        label: this.$t('bidMod.quotedTime'),
        minWidth: 140,
        dataType: 'dateTime'
      },
      {
      ...
      {
        prop: 'extIsPrepaid',
        label: this.$t('cusEntry.bidMod.extIsPrepaid'),
        minWidth: 120,
        dataType: 'dict',
        code: 'YES_OR_NO'
      },
      {
        ...
        label: this.$t('cusEntry.bidMod.extPrepaidRatio'),
        minWidth: 120
      },
      {
        prop: 'extLogisticsCost',
        label: this.$t('cusEntry.bidMod.extLogisticsCost'),
        minWidth: 120
      },
      {
