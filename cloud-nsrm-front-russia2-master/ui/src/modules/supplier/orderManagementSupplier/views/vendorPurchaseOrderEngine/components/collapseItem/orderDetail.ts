        ...
        importUpdate: {
          ...
          properties: {
            importExcel: {
              ...
              'x-component-props': {
                title: i18nExpression('orderMod.batchUpdate'), // 批量更新
                showTemplate: false,
                type: 'default',
                extraData: {
                  ...
                  sourceType: 'WEB_APP',
                  fileModular: 'sup-ce',
                  fileFunction: '{{ $t(\'purchaseOrder.downloadName1\') }}', // 采购订单明细维护
                  fileType: 'excel'
                },
      ...
      properties: generateXindexInOrder({
        ...
        confirmNum: {
          ...
          'x-render-table-column': {
            ...
            customRender: true,
            // 供方确认数量填0则是拒绝该订单行
            titlePrefix: '{{$form.query(\'OrderVendor\').get(\'data\').configValue?.vendorRefuse ? { content: $t(\'cusEntry.supplement20250211.confirmNumTip\') } : null}}'
          },
          'x-component-props': {
