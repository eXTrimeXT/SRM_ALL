  ...
  return [
    {
      slot: 'priceLibraryNo',
      itemAttrs: {
        label: _this.$t('bidMod.priceLibraryNo'), // 价格库编号
        rules: [
          {
            required: true,
            message: _this.$t('bidMod.selectPriceLibraryNo')
          }
        ]
      },
      computedUIAttrs: _ => {
    ...
    },
    {
      tag: 'input',
      itemAttrs: {
        label: _this.$t('dataConfMod.settingGuide.step3.3') // 单位
      },
      computedUIAttrs: _ => {
        return {
          key: 'unit',
...
let priceInfor = _this => {
  return [
    ...
    },
    {
      tag: 'date',
      itemAttrs: {
        label: _this.$t('bid_mod.defaultPriceValidFrom')
      },
      computedUIAttrs: _ => {
        return {
          key: 'effectiveDate',
    ...
    },
    {
      tag: 'date',
      itemAttrs: {
        label: _this.$t('dataConfMod.priceExpirationDate')
      },
      computedUIAttrs: _ => {
        return {
          key: 'expirationDate',
  ...
  return [
    {
      tag: 'input',
      itemAttrs: {
        label: _this.$t('dataConfMod.deliveryCycle') // 送货周期
      },
      computedUIAttrs: _ => {
        return {
          key: 'deliveryCycle',
    ...
    },
    {
      tag: 'input',
      itemAttrs: {
        label: _this.$t('common.weight') // 重量
      },
      computedUIAttrs: _ => {
        return {
          key: 'weight',
    ...
    },
    {
      tag: 'input',
      itemAttrs: {
        label: _this.$t('dataConfMod.ceeaColor') // 颜色
      },
      computedUIAttrs: _ => {
        return {
          key: 'color',
