    ...
    <el-main>
      <div class="form-container">
        <el-collapse v-model="activeDims" class="tab-form-style">
          <el-form :disabled="isReadOnly" ref="form" :model="form" :rules="rules">
            <!-- 内箱条码基本信息 -->
            <el-collapse-item :title="$t('orderMod.innerBoxBarcodeBasicInformation')" name="1">
              <srm-row :gutter="32">
                ...
                <!-- <srm-col :span="6">
                  <el-form-item prop="materialNorms" :label="$t('vendorMod.specification')">
                ...
                <!-- <srm-col :span="6">
                  <el-form-item prop="productionWeek" :label="$t('cusEntry.supplement20250211.productionWeek')">
                    <el-input v-model="form.productionWeek" disabled />
                  </el-form-item>
                </srm-col>

                <srm-col :span="6">
                  <el-form-item prop="batchNo" :label="$t('qualitySynergy.batchNum')">
      ...
      <CToolbar>
        <template #right>
          ...
          <el-button type="primary" v-show="$attrs.params.flag === 'add'" @click="save">
            {{ $t('common.save') }}
          </el-button>
          <el-button
            v-show="!editMode"
...
import { boxtagconfigApi, innerBoxCodeApi } from 'mods@/barcodeSupplier/api'
