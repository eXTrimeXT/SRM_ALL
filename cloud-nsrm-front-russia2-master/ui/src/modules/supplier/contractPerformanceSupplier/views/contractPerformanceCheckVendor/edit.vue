        ...
        <el-collapse-item ref="perPlanMilestone" :title="$t('bid_mod.milestoneType')" name="2">
          <el-table border stripe :data="perPlanMilestoneList">
            ...
            <el-table-column prop="practicallyEndDate" min-width="150">
              ...
              <template slot-scope="scope">
                <el-date-picker v-model="scope.row.practicallyEndDate" :disabled="disabledFlag || form.dataCreationType === 'BUYER'" :placeholder="$t('vendorMod.relegation.optionDate')" :format="$formatDatePicker" value-format="yyyy-MM-dd" />
              </template>
            </el-table-column>
