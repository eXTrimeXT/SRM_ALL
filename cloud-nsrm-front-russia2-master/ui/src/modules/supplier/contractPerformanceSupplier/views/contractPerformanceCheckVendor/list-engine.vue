...
import { changeFieldVisibleByDeps, defineSchemas, generateXindexInOrder, i18nExpression, expression } from '@meicloud/render-engine'
import {
    ...
    properties: {
      ...
      table: {
        ...
        properties: generateXindexInOrder({
          ...
          'perPlanNo': {
            type: 'string',
            title: i18nExpression('bid_mod.perPlanNo'), // 合同履约计划单号
            'x-query-engine-relation': 'perPlanId',
            'x-render-table-column': {
              minWidth: 150
            }
          ...
          operation: {
            ...
            'x-component': 'RenderTableButtonList',
              properties: {
                deliver: {
                  type: 'void',
                  title: i18nExpression('supRisk.deliver'), // 交付
...
const $editTab = (type: string, row: any) => {
  ...
  emitTabAdd({
    ...
    params: {
      ...
      tabName: $t('contractMod.contractAcceptance') + name,
