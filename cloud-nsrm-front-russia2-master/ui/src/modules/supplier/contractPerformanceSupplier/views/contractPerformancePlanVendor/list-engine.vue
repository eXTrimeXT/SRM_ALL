    ...
    properties: {
      ...
      table: {
        ...
        properties: generateXindexInOrder({
          ...
          includeTaxAmount: {
            type: 'string',
            title: i18nExpression('contract_mod.contractTaxAmount'),
            'x-component-props': {
              style: "float:right"
            },
            'x-render-table-column': {
          ...
          currentMilestoneType: {
            type: 'string',
            title: i18nExpression('contract_mod.currentMilestoneNode'),
            'x-component': 'DictSelect',
            'x-component-props': {
          ...
          currentNodePersonName: {
            type: 'string',
            title: i18nExpression('contract_mod.nodePerson'),
            'x-render-table-column': {
              width: 120
            }
          },
          // 里程碑计划结束日期
          currentPlanEndDate: {
            title: i18nExpression('contract_mod.milestonePlanEndDate'),
            ...yearMonthDaySelectorSegment,
            'x-render-table-column': {
              width: 150
            }
