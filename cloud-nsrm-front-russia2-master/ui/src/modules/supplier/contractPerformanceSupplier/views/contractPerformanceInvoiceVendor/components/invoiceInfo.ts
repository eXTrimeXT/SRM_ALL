  ...
  properties: {
    toolbar: {
      ...
      properties: {
        ...
        uploadTip: {
          ...
          'x-content': i18nExpression('agentOnlineInvoice.prompt4'),
          'x-component-props': {
    ...
    perInvoiceInformationList: {
      ...
      properties: generateXindexInOrder({
        ...
        invoiceName: {
          type: 'string',
          title: i18nExpression('components.ocr.invoiceName'), // 发票名称
        ...
        sellerRegisterNum: {
          type: 'string',
          title: i18nExpression('components.ocr.sellerRegisterNum'), // 销售方纳税人识别号
          'x-render-table-column': {
            minWidth: 120
          }
        },
        ...
        amountInFigures: {
          type: 'string',
          title: i18nExpression('components.ocr.amountInFigures'), // 价税合计(小写)
          'x-render-table-column': {
            minWidth: 120
          }
        },
        amountInWords: {
          type: 'string',
          title: i18nExpression('components.ocr.amountInWords'), // 价税合计(大写)
          'x-render-table-column': {
            minWidth: 120
          }
        },
