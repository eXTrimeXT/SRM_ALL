          ...
          <el-collapse v-model="activeDims" class="tab-form-style">
            ...
            <el-collapse-item :title="$t('dataConfMod.materialParams')" name="2">
              <srm-row>
                ...
                <srm-col>
                  <!-- 最小起订量 -->
                  <el-form-item :label="$t('dataConfMod.orderQuantityMinimum')" prop="ceeaOrderQuantityMinimum">
                ...
                <srm-col>
                  <!-- 内箱最小包装量 -->
                  <el-form-item :label="$t('dataConfMod.minimumPackingQuantity')" prop="minimumPackagingQuantity">
                ...
                <srm-col>
                  <!-- 外箱最小包装量 -->
                  <el-form-item :label="$t('dataConfMod.outboxMinPackagingQuantity')" prop="outboxMinPackagingQuantity">
