            ...
            <srm-row>
              ...
              <srm-col :initCol="4">
                ...
                <!-- <el-form-item label="供应商名称" prop="vendorName">
                  <quick-search
                    :showInput="improveForm.vendorName"
                    show-key="companyName"
                    :scope-data="improveForm"
...
export default {
  ...
  methods: {
    ...
    performance (companyName) {
      ...
      performanceManagement.listPerfOverallScorePage(obj).then(res => {
        if (res.code == '0') {
    ...
    queryCompanyList ({ keyWord = '', orgId }) {
      performanceManagement.listPageByOrgIdAndKeyWord({
        keyWord,
        orgId
      }).then(res => {
    ...
    getOrderFormDetail () {
      ...
      performanceManagement.vendorImproveQueryById({ vendorImproveId }).then(res => {
    ...
    notifySupplier () {
      ...
      performanceManagement.vendorImproveNotifySupplier([submitData]).then(res => {
        this.$message({
          message: res.message,
          type: 'success'
        })
    ...
    vendorFeedback () {
      ...
      performanceManagement.vendorImproveVendorFeedback(submitData).then(res => {
        this.$message({
          message: res.message,
          type: 'success'
        })
    ...
    submitProcessRes () {
      ...
      performanceManagement.vendorImproveBuyersProcess(submitData).then(res => {
        this.$message({
          message: res.message,
          type: 'success'
        })
    ...
    dataHandle () {
      ...
      if (this.curOpt === 'add' || this.curOpt == 'adds') {
        // 新增
        performanceManagement.vendorImproveAdd(submitData).then(res => {
          this.$message({
            message: res.message,
            type: 'success'
          })
        ...
        performanceManagement.vendorImproveModify(submitData).then(res => {
          this.$message({
            message: res.message,
            type: 'success'
          })
