      ...
      properties: {
        ...
        orgId: {
          ...
          'x-component-props': {
            ...
            disabled: expression('$form.readPretty ? undefined : !!$form.values.detailList?.length || !!$form.values.advanceApplyList?.length || !!$form.values.punishList?.length || $form.query(\'OnlineInvoice\').get(\'data\').isFirstApproveShow'),
        ...
        organizationId: {
          ...
          'x-component-props': {
            ...
            'select-type': 'input',
            placeholder: i18nExpression('common.pleaseSelect'),
            'parent-id': expression('$form.values.orgId'),
            disabled: expression('$form.readPretty ? undefined : !!$form.values.detailList?.length || !!$form.values.advanceApplyList?.length || !!$form.values.punishList?.length || $form.query(\'OnlineInvoice\').get(\'data\').isFirstApproveShow'),
            '@select': expression(`(node) => {
        ...
        vendorName: {
          ...
          'x-component-props': {
            ...
            '@close-quicksearch': expression(`(value) => {
                $form.values.vendorId = value ? value.companyId : null
                $form.values.vendorCode = value ? value.companyCode : null
                $form.values.vendorName = value ? value.companyName : null
              }`)
          },
          ...requiredValidatorSegment
        },
        payMethod: {
          ...
          'x-component-props': {
            code: 'PAYMENT_MODE',
            disabled: expression('$form.readPretty ? undefined :  $form.query(\'OnlineInvoice\').get(\'data\').isFirstApproveShow')
          },
          ...requiredValidatorSegment
        },
        currencyName: {
          ...
          'x-component-props': {
            readPretty: '{{$form.readPretty}}',
            disabled: expression('$form.readPretty ? undefined : !!$form.values.detailList?.length || !!$form.values.advanceApplyList?.length || $form.query(\'OnlineInvoice\').get(\'data\').isFirstApproveShow'),
