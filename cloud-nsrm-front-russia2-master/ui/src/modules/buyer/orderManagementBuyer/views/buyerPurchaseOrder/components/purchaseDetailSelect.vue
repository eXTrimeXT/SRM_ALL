        ...
        <srm-row>
          ...
          <srm-col :initCol="3">
            <el-form-item
              ...
              :label-width="formLabelWidth"
            >
              <el-date-picker v-model="filterForm.startDate" value-format="yyyy-MM-dd" :format="$formatDatePicker" />
            </el-form-item>
          </srm-col>
          <srm-col :initCol="3">
            <el-form-item :label="$t('purchaseDemand.requestDateTo')" :label-width="formLabelWidth">
              <el-date-picker v-model="filterForm.endDate" value-format="yyyy-MM-dd" :format="$formatDatePicker" />
            </el-form-item>
          </srm-col>
        </srm-row>
      </el-form>
