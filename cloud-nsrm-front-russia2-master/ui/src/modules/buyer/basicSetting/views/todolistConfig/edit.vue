    ...
    <el-main>
      ...
      >
        <SrmRow>
          ...
          <!-- 俄文配置名称 -->
          <SrmCol>
            <el-form-item prop="configName" :label="$t('cusEntry.supplement20250218.russianConfigName')">
          ...
          <!-- 中文配置名称 -->
          <SrmCol>
            <el-form-item prop="extConfigNameChn" :label="$t('cusEntry.supplement20250218.chineseConfigName')">
              <el-input v-model="form.extConfigNameChn" />
            </el-form-item>
          </SrmCol>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        extConfigNameChn: [{ required: true, message: this.$t('common.requiredField') }],
