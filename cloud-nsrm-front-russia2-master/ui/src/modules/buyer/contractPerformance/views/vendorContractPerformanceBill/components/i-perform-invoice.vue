  ...
  data () {
    return {
      ...
      columns: [
        ...
        { prop: 'planInvoiceAmount', label: this.$t('contract_mod.planInvoiceAmount'), width: 150 },  // 计划开票金额
        {
        ...
        // 罚款金额
        { prop: 'fineAmount', label: this.$t('cusEntry.supplement20250205.penaltyAmount') },
        {
          prop: 'operation',
