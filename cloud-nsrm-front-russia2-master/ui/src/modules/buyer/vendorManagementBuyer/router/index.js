...
export default {
  ...
  children: [
    ...
    {
      path: 'blackSecure',
      component: () => import('modb@/vendorManagementBuyer/views/blackSecure'),
      name: 'blackSecure',
      meta: {
    ...
    // 供方生效
    {
      ...
      component: () => import('modb@/vendorManagementBuyer/views/supplierEffective'),
      name: 'supplierEffective',
      meta: {
        title: 'route.supplierEffective',
        requiresAuth: true
      }
    },
    {
      ...
      component: meiqlCtrl.quaOfReview === 'Y'
        ? () => import('modb@/vendorManagementBuyer/views/quaOfReviewEngine')
    ...
    },
    {
      ...
      component: meiqlCtrl.vendorProfile === 'Y'
        ? () => import('modb@/vendorManagementBuyer/views/vendorProfileEngine')
    ...
    },
    {
      ...
      component: meiqlCtrl.vendorGreenChannel === 'Y'
        ? () => import('modb@/vendorManagementBuyer/views/vendorGreenChannelEngine')
    ...
    },
    {
      ...
      component: meiqlCtrl.vendorInfoChange === 'Y'
        ? () => import('modb@/vendorManagementBuyer/views/vendorInfoChangeEngine')
    ...
    },
    {
      ...
      component: meiqlCtrl.cooperationEnded === 'Y'
        ? () => import('modb@/vendorManagementBuyer/views/cooperationEndedEngine')
        : () => import('modb@/vendorManagementBuyer/views/cooperationEnded'),
      name: 'cooperationEnded',
      meta: {
        title: 'route.cooperationEnded', // 合作终止
        requiresAuth: true
      }
    },
    {
      ...
      component: meiqlCtrl.categoryRelationship === 'Y'
        ? () => import('modb@/vendorManagementBuyer/views/categoryRelationshipEngine')
    ...
    },
    {
      ...
      component: () => import('modb@/vendorManagementBuyer/views/expirationReminder'),
    ...
    },
    {
      ...
      component: meiqlCtrl.inviteSupplier === 'Y'
        ? () => import('modb@/vendorManagementBuyer/views/inviteSupplierEngine')
    ...
    // 黑名单
    {
      ...
      component: meiqlCtrl.black === 'Y'
        ? () => import('modb@/vendorManagementBuyer/views/blackEngine')
