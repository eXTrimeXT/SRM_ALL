...
export default {
  ...
  created () {
      ...
      },
      {
        ...
        buttons: [
          ...
          },
          {
            ...
            code: 'sup:quaOfReviewList:Approval',
            show: function (row) {
          ...
          },
          {
            ...
            code: 'sup:quaOfReviewList:delete',
            show: function (row) {
          ...
          },
          {
            ...
            code: 'sup:quaOfReviewList:abandon',
    ...
    if (
      ...
      this.$route.params.funName === 'quaOfReview'
    ) {
      let row = {
  ...
  methods: {
    ...
    delRowData (row) {
      ...
      this.$confirm(this.$t('common.confirmDelete'), {
        ...
        .then(() => {
          quaApi.reviewFormhDel({ reviewFormId }).then(res => {
            this.$message({
              message: res.message,
              type: 'success'
            })
