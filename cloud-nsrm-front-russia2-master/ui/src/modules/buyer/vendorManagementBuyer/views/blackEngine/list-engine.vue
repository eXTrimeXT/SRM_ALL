...
const $detailOne = (type: string, row: any) => {
  ...
  emitTabAdd({
    ...
    // '新增单据'
    title: type == 'add' ? $t('common.newDocument') : row.companyName,
    name: tabName
  })
}
      ...
      toolbar: {
        ...
        properties: {
          ...
          tips: {
            ...
            // '本功能用于供应商黑名单管理，若提交审批后，未审批完成，该供应商状态为“清算中”；审批通过后，该供应商状态为“退出”，并且变成黑名单供应商'
            "x-content": $t('vendorMod.blackListTips1')
          }
        }
      },
      table: {
          ...
          companyCreationDate: {
            ...
            'x-component-props': {
              ...
              formatter: expression(`({ cellValue, row, column }) => {
                parseTime(row.companyCreationDate, '{y}-{m}-{d}')
              }`)
            }
          },
          registeredCapital: {
