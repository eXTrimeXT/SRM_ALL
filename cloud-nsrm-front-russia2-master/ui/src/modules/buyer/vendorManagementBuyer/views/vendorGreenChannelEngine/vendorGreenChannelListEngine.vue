      ...
      toolbar: {
        ...
        properties: {
          ...
          importExcel: {
            ...
            'x-component-props': {
              title: i18nExpression('vendorMod.importVendor'),
              type: 'default',
              extraData: {
                fileModular: 'sup',
              ...
              upLoadUrl: '/api-sup/info/companyInfo/importExcel',
              downloadTemplateOptions: {
                downloadUrl: '/api-sup/info/companyInfo/importExcelTemplate',
...
<template>
  <RenderEngine schemaKey="vendorGreenChannelList" class="contractPaymentType" :schema="schema" :scope="scope" :components="components" />
</template>
