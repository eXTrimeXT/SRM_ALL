        ...
        buttons: [
          {
            ...
            formattor (val) {
              return this.$t('common.inactive') // '失效'
            },
            show: function (row) {
              return row.catalogStatus === 'VALID' && this.curRole === 'BUYER'
            }.bind(this)
          },
          {
            callback: function (row) {
            ...
            show: row => {
              return row.catalogStatus === 'DRAFT' && this.curRole === 'BUYER'
            }
          },
          {
            callback: function (row) {
          ...
          },
          {
            ...
            formattor (val) {
              return this.$t('common.modify')  // '更新'
            },
            show: row => {
    ...
    editTab (type, row = {}) {
      ...
      let tab = {
        ...
        params: {
          flag: type,
          row,
          tabName: $t('vendor.purchaseList', {name: name})
        },
        title: name ? '货源清单' + name : '新增货源清单',
        name: this.$t('vendorMod.supplyList') + name  // '货源清单'
      }
