          ...
          <el-collapse v-model="activeDims">
            ...
            >
              ...
              >
                ...
                <!-- 拓展字段 [[-->
                <template v-if="orgDimFieldContexts.length > 0">
                  <el-table-column
            ...
            <!--经营业绩-->
            <el-collapse-item
              ref="operatingResult2"
              :title="$t('vendorMod.operatingResult2')"
              name="7"
            >
              <!--经营业绩-->
              <Configurationization
                ref="test7"
                pageCode="companyInfoMaintain"
                dimensionCode="operatingPerformance"
            ...
            <el-collapse-item
              v-if="testBol8"
              ref="overallStrength"
              :title="$t('vendorMod.overallStrength')"
              name="8"
            >
              <!--整体实力-->
              <Configurationization
                ref="test8"
                pageCode="companyInfoMaintain"
                dimensionCode="overallStrength"
                :businessId="companyId"
                :disabled="allParam.companyInfo.status ==='APPROVED' || allParam.companyInfo.status ==='SUBMITTED'"
                @showType="showType($event,'this.testBol8 = type == \'\' ? false : true')"
              />
            </el-collapse-item>
            <!--公司规模-->
            <el-collapse-item
            ...
            >
              ...
              <Configurationization
                ref="test9"
                pageCode="companyInfoMaintain"
                dimensionCode="companySize"
                :businessId="companyId"
                :disabled="allParam.companyInfo.status ==='APPROVED' || allParam.companyInfo.status ==='SUBMITTED'"
                @showType="showType($event,'this.testBol9 = type == \'\' ? false : true')"
              />
            </el-collapse-item>
            <!--研发能力-->
            <el-collapse-item
              v-if="testBol10"
              ref="RandDCapable5"
              :title="$t('vendorMod.RandDCapable5')"
              name="14"
            >
              <!--研发能力-->
              <Configurationization
                ref="test10"
                pageCode="companyInfoMaintain"
                dimensionCode="randDCapable"
                :businessId="companyId"
                :disabled="true"
                @showType="showType($event,'this.testBol10 = type == \'\' ? false : true')"
              />
              <Configurationization
                ref="test101"
                pageCode="companyInfoMaintain"
                dimensionCode="randDCapable2"
            ...
            <el-collapse-item
              v-if="testBol11"
              ref="qualityControl"
              :title="$t('vendorMod.qualityControl')"
              name="11"
            >
              <!--质量管控-->
              <Configurationization
                ref="test11"
                pageCode="companyInfoMaintain"
                dimensionCode="qualityControl"
                :businessId="companyId"
                :disabled="allParam.companyInfo.status ==='APPROVED' || allParam.companyInfo.status ==='SUBMITTED'"
                @showType="showType($event,'this.testBol11 = type == \'\' ? false : true')"
              />
            </el-collapse-item>
            <!--设备信息-->
            <el-collapse-item
            ...
            >
              ...
              <Configurationization
                ref="test12"
                pageCode="companyInfoMaintain"
                dimensionCode="equipmentInformation"
                :businessId="companyId"
                :disabled="allParam.companyInfo.status ==='APPROVED' || allParam.companyInfo.status ==='SUBMITTED'"
                @showType="showType($event,'this.testBol12 = type == \'\' ? false : true')"
              />
            </el-collapse-item>
            <!--产品能力信息-->
            <el-collapse-item
              v-if="testBol13"
              ref="productCapableInfo"
              :title="$t('vendorMod.productCapableInfo')"
              name="13"
            >
              <!--产品能力信息-->
              <Configurationization
                ref="test13"
                pageCode="companyInfoMaintain"
                dimensionCode="productCapableInfo"
                :businessId="companyId"
                :disabled="allParam.companyInfo.status ==='APPROVED' || allParam.companyInfo.status ==='SUBMITTED'"
                @showType="showType($event,'this.testBol13 = type == \'\' ? false : true')"
              />
            </el-collapse-item>
            <!--售后服务-->
            <el-collapse-item
              ...
              :title="$t('vendorMod.afterSalesService')"
              name="14"
            >
              <!--售后服务-->
              <Configurationization
                ref="test14"
                pageCode="companyInfoMaintain"
                dimensionCode="shouhou"
                :businessId="companyId"
                :disabled="allParam.companyInfo.status ==='APPROVED' || allParam.companyInfo.status ==='SUBMITTED'"
                @showType="showType($event,'this.testBol14 = type == \'\' ? false : true')"
              />
            </el-collapse-item>
            <!--客户情况-->
            <el-collapse-item
              v-if="testBol15"
              ref="clientStatus"
              :title="$t('vendorMod.clientStatus')"
              name="15"
            >
              <!--客户情况-->
              <Configurationization
                ref="test15"
                pageCode="companyInfoMaintain"
                dimensionCode="clientStatus"
                :businessId="companyId"
                :disabled="allParam.companyInfo.status ==='APPROVED' || allParam.companyInfo.status ==='SUBMITTED'"
                @showType="showType($event,'this.testBol15 = type == \'\' ? false : true')"
              />
            </el-collapse-item>
            <!-- 管理体系信息 -->
            <el-collapse-item
            ...
            >
              <div class="left_div">
                ...
                >
                  ...
                  >
                    <template slot-scope="scope">
                      <el-button type="text" @click="questionnaireClick(scope)">
                        {{ scope.row.questNo }}
                      </el-button>
                    </template>
                  </el-table-column>
            ...
            >
              <div class="left_div">
                ...
                >
                  ...
                  >
                    <template slot-scope="scope">
                      <el-button type="text" @click="infoChangeF(scope.row)">
  ...
  data () {
    return {
      ...
      nodeData: [
        ...
        {
          code: 'operatingResult2',
          name: this.$t('vendorMod.operatingResult'),
          percentage: 0
        }, // 经营业绩
        {
          code: 'overallStrength',
          name: this.$t('vendorMod.overallStrength'),
          percentage: 0
        }, // 整体实力
        {
          code: 'companySize',
          name: this.$t('vendorMod.companySize'), // 公司规模
          percentage: 0
        },
        {
          code: 'RandDCapable5',
          name: this.$t('vendorMod.RandDCapable5'), // 研发能力
          percentage: 0
        },
        {
          code: 'qualityControl',
          name: this.$t('vendorMod.qualityControl'), // 质量管控
          percentage: 0
        },
        {
          code: 'deviceInfo',
          name: this.$t('vendorMod.deviceInfo'), // 设备信息
          percentage: 0
        },
        {
          code: 'productCapableInfo',
          name: this.$t('vendorMod.productCapableInfo'), // 产品能力信息
          percentage: 0
        },
        {
          code: 'afterSalesService',
          name: this.$t('vendorMod.afterSalesService'), // 售后服务
          percentage: 0
        },
        {
          code: 'clientStatus',
          name: this.$t('vendorMod.clientStatus'), // 客户情况
          percentage: 0
        },
        {
          code: 'manageSystem',
