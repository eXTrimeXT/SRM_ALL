      ...
      <div class="form-container">
        ...
        >
          <el-row>
            <el-col :span="8">
              <!-- 角色编码 -->
              <el-form-item :label="$t('dataConfMod.roleCode')" prop="roleCode" label-width="150px">
                <el-input v-model="form.roleCode" :disabled="curOpt === 'edit'" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <!-- 生效日期 -->
              <el-form-item :label="$t('dataConfMod.startDate')" prop="startDate" label-width="150px">
                <el-date-picker
            ...
            <el-col :span="8">
              <!-- 失效日期 -->
              <el-form-item :label="$t('dataConfMod.endDate')" prop="endDate" label-width="200px">
                <el-date-picker
          ...
          <el-row :gutter="20">
            <el-col :span="20">
              <!-- 角色类型 -->
              <el-form-item :label="$t('dataConfMod.roleType')" prop="roleType" label-width="150px">
                <DictSelect
          ...
          <el-row :gutter="20" class-name="roleLanguages">
            <el-col :span="20">
              <!-- 角色名称 -->
              <el-form-item :label="$t('dataConfMod.roleName')" prop="roleLanguages" label-width="150px">
                <el-input
