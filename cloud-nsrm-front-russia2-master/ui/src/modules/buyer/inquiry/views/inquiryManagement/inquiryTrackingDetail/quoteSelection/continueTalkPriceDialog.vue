...
import InviteSuppliers from 'lib@/composition/origin/inviteSuppliers/index.vue'
  ...
  methods: {
    ...
    saveContinuePriTalkFormData () {
      this.$refs.continuePriTalkForm.validate(async valid => {
        ...
        if (this.isInviteTender) {
          paramsData.newVendors = this.$refs.inviteSuppliers.getSuppliersPermissionData()
        }
