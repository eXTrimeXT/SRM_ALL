    ...
    infoList () {
      ...
      return [
        ...
        },
        {
          ...
          value: projectInfo.auctSouProject.extendMinute ? `${projectInfo.auctSouProject.extendMinute}${this.$t('bidMod.minute')}` : '-',
          enable: true
        },
        {
