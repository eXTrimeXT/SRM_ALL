<template>
  ...
  >
    <el-main>
      ...
      >
        ...
        <template #demoOrderId="{ scope }">
          ...
          <el-input
            ...
            :placeholder="$t('cusEntry.supplement20250211.slotPopupQuery')"
            clearable
        ...
        <template #city="{ scope }">
          ...
          <DictSelect
            ...
            filterable
            clearable
            :placeholder="$t('cusEntry.supplement20250211.firstLevelCascadeSelection')"
      ...
      <!-- 自定义查询弹框 -->
      <srm-dialog
        :title="$t('cusEntry.supplement20250211.customQueryDialog')"
        size="large"
  ...
  data () {
    return {
      ...
      filterConfig: [
        {
          prop: 'orderStatus',
          label: this.$t('cusEntry.supplement20250211.slotDropdown'),  // '插槽下拉'
          type: 'slot',
          slot: 'orderStatus'
        },
        {
          prop: 'paymentMethod',
          label:this.$t('cusEntry.supplement20250211.dictionaryDropdown'),  //  '字典下拉'
          width: 180,
          type: 'dict',
          code: 'PAYMENT_WAY'
        },
        {
          prop: 'date',
          label: this.$t('cusEntry.supplement20250211.singleDate'),  // '单个日期'
          type: 'date'
        }, // 【单个日期时间】type值为datetime即可
        {
          prop: 'daterange',
          label: this.$t('cusEntry.supplement20250211.dateCycle'),  // '日期周期'
          type: 'daterange'
        },
        {
          prop: 'companyName',
          label: this.$t('reportSetting.quickSearch'),  // '快查'
          type: 'quicksearch',
          showKey: 'companyName',
        ...
        },
        {
          type: 'switch',
          prop: 'isNew',
          label: this.$t('cusEntry.supplement20250211.isSingleChoice')  // '是否单选'
        },
        {
          prop: 'organizationId',
        ...
        {
          prop: 'demoOrderId',
          label: this.$t('cusEntry.supplement20250211.popupQuery'),  // '弹窗查询'
          type: 'slot',
          slot: 'demoOrderId'
        },
        { prop: 'orderNumber', label: this.$t('cusEntry.supplement20250211.inputBox') },  // '纯输入框'
        {
          prop: 'province',
          label: this.$t('cusEntry.supplement20250211.oneLevelLinkage'),  // '一级联动'
          type: 'slot',
          slot: 'province'
        },
        {
          prop: 'city',
          label: this.$t('cusEntry.supplement20250211.twoLevelLinkage'),  //'二级联动'
          type: 'slot',
          slot: 'city'
        },
        {
  ...
  methods: {
    ...
    addHandle (row) {
      ...
      const tab = {
        ...
        title: this.$t('cusEntry.supplement20250211.orderHeaderRowStructureAddition'),  // '订单头行结构新增'
        name: 'demoorderEdit'
      }
