<template>
  ...
  >
    <el-main>
      ...
      />
      <el-button :v-text="$t('cusEntry.supplement20250211.testButton')" />
      ...
      <div style="width:300px;margin:20px 50px;">
        <uploadFile
          ...
          :file-name="fileName"
          :file-id="fileId"
          @upload-success="uploadSuccessHandel($event)"
      ...
      <!-- 附件预览:{{ PFileName }} -->
      {{ $t("cusEntry.supplement20250211.filePreview") }}{{ PFileName }}
      <div style="width:300px;margin:20px 50px;">
        <filePreview
          :file-id="PFileId"
          :file-name="PFileName"
