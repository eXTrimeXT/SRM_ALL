    ...
    attachList: {
      ...
      properties: generateXindexInOrder({
        ...
        attachName: {
          ...
          'x-component-props': {
            readonly: expression('$table.getRowByIndex($self.index).attachId && ![undefined, "", "DRAFT"].includes($form.values.status)'),
            'extra-data': {
              fileModular: 'sup',
        ...
        operation: {
          ...
          properties: {
            delete: {
              ...
              'x-component-props': {
                type: 'text',
                disabled: expression('$table.getRowByIndex($self.index).attachId && ![undefined, "", "DRAFT"].includes($form.values.status)'),
                '@click': expression(`() => {
