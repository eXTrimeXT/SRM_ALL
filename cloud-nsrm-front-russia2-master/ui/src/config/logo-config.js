...
export const getLogoInfo = () => {
  ...
  const sysConfInfo = {
    ...
    webName: { // 系统名称，登录框大文字
      zh_CN: '长城慧采云管理平台',
      ru_RU: 'Платформа управления облаками Great Wall',
    },
    webDes: { // 登录页logo旁边的文字描述
      zh_CN: '汇聚全球商机，缔造供需共赢',
      ru_RU: 'Объединение глобальных деловых возможностей для достижения взаимовыгодного спроса и предложения',
    },
    webTitle: { // 浏览器tab title 后缀
      zh_CN: '长城慧采云',
      ru_RU: 'Великая китайская стена',
    }
  }
  // 默认场景 适配多语言切换
  if (logoType == 'style1') {
    ...
    return {
      ...
      webName: {
        zh_CN: 'SRM管理平台',
        ru_RU: 'Платформа управления SRM'
      },
      webDes: { // 登录页logo旁边的文字描述
        zh_CN: '汇聚全球商机，缔造供需共赢',
        ru_RU: 'Объединение глобальных деловых возможностей для достижения взаимовыгодного спроса и предложения'
...
export const systemThemeFormat = (theme) => {
  ...
  let themeObj = {
    ...
    webName: {
      ...
      ru_RU: getLangItem(webName, 'ru_RU') || logoInfo.webName['ru_RU']
    },
    webDes: {
      zh_CN: getLangItem(webDes, 'zh_CN') || logoInfo.webDes['zh_CN'],
      ru_RU: getLangItem(webDes, 'ru_RU') || logoInfo.webDes['ru_RU']
    },
    webTitle: {
      zh_CN: getLangItem(webTitle, 'zh_CN') || logoInfo.webTitle['zh_CN'],
      ru_RU: getLangItem(webTitle, 'ru_RU') || logoInfo.webTitle['ru_RU']
    },
    copyright: lang.t('vendorMod.copyright') // 版权信息
  }
  return themeObj
