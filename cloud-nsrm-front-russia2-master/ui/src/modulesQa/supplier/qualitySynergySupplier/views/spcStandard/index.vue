    ...
    <el-main>
      ...
      <MainHeader>
        <template slot="left">
          ...
          <!-- spc暂时屏蔽功能 -->
          <ExportExcel
            page-url="/api-qc/api-ql/spcRuleStandard/getMonitorSpcStandards"
...
import { qualityProject, spcStandard } from '@/modulesQa/supplier/qualitySynergySupplier/api'
  ...
  data () {
    return {
      ...
      preArr: [
        ...
        {
          prop: 'workCenter',
          label: () => this.$t('quality.project.workCenter'),
          type: 'select',
          options: []
        },
        {
