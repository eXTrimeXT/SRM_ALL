...
<script>
  ...
  import materialSourceOrdersDetail from './materialSourceOrdersDetail'
  import { parseTime } from '@/utils'

  export default {
    name: 'MaterialSourceOrdersList',
    components: {
...
width: 100
    ...
    methods: {
      ...
      editTab () {
        // 编辑tab
        let tab = {
          component: materialSourceOrdersDetail,
          params: {
            flag: 'edit',
            row: this.currentRow
          },
          title: this.currentRow.biddingNum,
          name: 'materialSourceOrdersDetail' + this.currentRow.biddingNum
        }
