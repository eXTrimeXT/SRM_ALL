...
export default {
  ...
  data () {
    return {
      activeTab: 'biddingProjectList',
      tabs: [
        {
          title: this.$t('bidMod.biddingProject'),
          name: 'biddingProjectList',
          component: biddingProjectList,
          closable: false
        }
      ]
    }
  ...
  methods: {
    ...
    tabChangeTodo () {
      ...
      if (this.activeTab && this.activeTab.indexOf('priceComparison-PRJ') === 0) {
