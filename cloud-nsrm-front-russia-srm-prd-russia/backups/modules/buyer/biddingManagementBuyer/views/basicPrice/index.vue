      ...
      >
        ...
        <template #taxRate>
          <DictSelect
            ...
            code="tax"
            @change-value="(value,dictItem) => taxRateChangeHandel(value,dictItem,mergeForm)"
          />
        </template>
    ...
    return {
      ...
      tableHeader: [
        ...
        },
        {
          ...
          prop: 'activeDateFrom',
          width: 150,
          formattor: val => this.$dayjs(val).format('YYYY-MM-DD')
        },
        {
        ...
        },
        {
          ...
          buttons: [
            ...
            },
            {
              ...
              show: row => ['DRAFT', 'INVAILD'].includes(row.baseMaterialPriceStatus),
