    ...
    <el-main>
      ...
      <MainHeader :l-span="22" :r-span="2">
        <template slot="left">
          <MImport
            title="导入"
            up-load-url="/api-cost/singleMaterial/weight/importExcel"
          ...
          <ExportExcel
            page-url="/api-cost/singleMaterial/weight/listPage"
      ...
      <TableView
        ...
        url="/api-cost/singleMaterial/weight/listPage"
...
type: 'dict',
  ...
  methods: {
    ...
    downloadTemplate () {
      downloadFileLink(
        '/api-cost/singleMaterial/weight/template',
        '导入模板.xlsx'
      ).catch(() => {
    ...
    handleValid () {
      ...
      this.$confirm(this.$t('marketBudget.enableCurrent'), {
        ...
        this.$http({
          url: '/api-cost/singleMaterial/weight/valid',
          method: 'POST',
          data: { ids: list },
          loading: true
        }).then(res => {
    ...
    handleInvalid () {
      ...
      this.$confirm(this.$t('marketBudget.disableCurrent'), {
        ...
        this.$http({
          url: '/api-cost/singleMaterial/weight/invalid',
          method: 'POST',
          data: { ids: list },
          loading: true
        }).then(res => {
    ...
    handleDelete (row) {
      ...
      this.$confirm(this.$t('common.confirmDelete'), {
        ...
        this.$http({
          url: '/api-cost/singleMaterial/weight/delete',
          method: 'DELETE',
          data: { ids: list },
          loading: true
        }).then(res => {
