(function() {
  ...
  if (typeof postMessage === "function") {
    onmessage = function(evt) {
      ...
      var { orgList, fullPathNameMap } = getOrgList(
        data.organizationUsers,
        data.tree,
        data.fullPathNameMap
      );
      postMessage({ orgList, fullPathNameMap });
    };
  }
})();
