import{ai as generateXindexInOrder,cc as formGridSegment,ae as expression,af as i18nExpression,ag as yearMonthDaySelectorSegment,al as defineComponent,am as usePageHelper,an as useAttrs,ao as ref$1,bS as computed,as as RenderEngine,ar as defineSchemas,n as normalizeComponent}from"./index-17d0ccd5.js";import{s as supCommonApi}from"./supApi-e5726083.js";const DialogMainCategory={type:"void",title:"{{$t('dataConfMod.categoryDetails')}}","x-decorator":"QueryEngine","x-component":"RDialog","x-component-props":{class:"dialogMain",size:"middle",footer:!1},properties:{categoryList:{type:"array","x-component":"RenderTable","x-component-props":{style:"height:250px",preColumns:"seq",pagination:!1},"x-query-engine-skip":!0,properties:generateXindexInOrder({categoryCode:{type:"string",title:"{{$t('common.categoryCode')}}","x-component":"QuickSearchWrapper","x-component-props":{disabled:!0,showKey:"companyName",propKey:"companyName",name:"scc_base_purchase_category2"},"x-render-table-column":{minWidth:150,skipEditable:!0}},categoryName:{type:"string",title:"{{$t('common.categoryName')}}","x-render-table-column":{minWidth:120,skipEditable:!0}}})}}},formMain={type:"void",...formGridSegment,"x-reactions":expression(`() => {
    setTimeout(() => {
