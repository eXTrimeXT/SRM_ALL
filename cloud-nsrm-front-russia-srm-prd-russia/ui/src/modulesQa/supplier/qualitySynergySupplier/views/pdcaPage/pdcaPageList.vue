  ...
  <el-container class="flex-container the_quick_list__outter_wrapper" direction="vertical">
    <el-main>
      ...
      <TableView
        ...
        url="/api-qc/api-ql/spcPdcaRecord/findDatasByConditions"
      />
    </el-main>
  </el-container>
</template>
...
export default {
        ...
        buttons: [
          {
            ...
            formattor: (val) => {
              return this.$t('quality.detailView')
            }
          },
          {
            btnStyle: 'text',
            ...
            formattor: (val) => {
              return this.$t('components.condition.null')
            }
          },
          {
            btnStyle: 'text',
            ...
            formattor: (val) => {
              return this.$t('quality.tianxiezhong')
            }
          },
          {
            btnStyle: 'text',
  ...
  methods: {
    // 初始化条件查询
    getPageCondition () {
      let transformParams = transformMQL.save('spcPdcaRecord', {}, 'pageCondition')
    ...
    getQuerydata (params = {}) {
      this.queryParam = transformMQL.listGetData('spcPdcaRecord', params, 'lastUpdateDate', undefined, 'findDatasByConditions', null, { startDate: 'ge', endDate: 'le' })
      this.$nextTick(() => {
    ...
    editTab (type, param) {
      ...
      if (type == 'detail') {
        ...
        tab = {
          component: PdcaEnter,
          params: { flag: 'detail', params: param },
          title: () => this.$t('quality.pdcaEnterView'),
          name: 'PCDAEnter'
        }
      }
