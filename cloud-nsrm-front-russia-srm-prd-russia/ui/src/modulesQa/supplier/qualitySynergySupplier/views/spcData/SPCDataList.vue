  ...
  <el-container class="flex-container the_quick_list__outter_wrapper" direction="vertical">
    <el-main>
      ...
      <TableView
        ...
        url="/api-qc/api-ql/spcRuleStandard/getMonitorSpcStandards"
      />
    </el-main>
  </el-container>
</template>
...
export default {
    ...
    this.tableHeader = [
      ...
      { prop: 'operation',
        ...
        buttons: [
          {
            btnStyle: 'text',
            show: row => row.state === 'A',
            callback: function (row) {
              this.editTab('enter', row)
            }.bind(this),
            formattor: (val) => {
              return this.$t('quality.project.enterData')
            }
          },
          {
            btnStyle: 'text',
            ...
            formattor: (val) => {
              return this.$t('quality.project.historyAnalize')
            }
          }
        ]
      }
  ...
  methods: {
    ...
    // 查询列表
    getQuerydata (params = {}) {
      this.queryParam = transformMQL.listGetData('spcRuleStandard', params, 'lastUpdateDate', undefined, 'getMonitorSpcStandards')
      this.$nextTick(() => {
    ...
    editTab (type, param) {
      ...
      if (type === 'enter') {
        ...
        tab = {
          ...
          params: { flag: 'enter', param: param, tabName: 'SPCDataEnter' + param.id },
          title: this.$t('quality.spcDataEnter') + param.id,
          name: 'SPCDataEnter' + param.id
        }
        ...
        tab = {
          ...
          title: () => this.$t('quality.project.spcDataHistoryAnalize') + param.id, // SPC历史数据分析
