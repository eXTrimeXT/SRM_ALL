            ...
            >
              <srm-col>
                <el-form-item
                  ...
                  prop="interfaceUrl"
                  :rules="[{ required: true, message: '请输入接口调用地址' }]"
                >
              ...
              <srm-col>
                <el-form-item
                  ...
                  prop="dataType"
                  :rules="[{ required: true, message: '请选择入参类型' }]"
                >
                  <DictSelect
              ...
              <srm-col>
                <el-form-item
                  ...
                  prop="outType"
                  :rules="[{ required: true, message: '请选择出参类型' }]"
                >
                  <DictSelect
            ...
            >
              ...
              <srm-col>
                <el-form-item
                  ...
                  prop="paramStruct"
                  :rules="[{ required: true, message: '请选择参数构造方式' }]"
                >
                  <DictSelect
            ...
            >
              <srm-col>
                <el-form-item
                  ...
                  prop="interfaceUrl"
                  :rules="[{ required: true, message: '请填写接口调用地址' }]"
                >
                  <el-input v-model="allParams.form.interfaceUrl" />
                </el-form-item>
              </srm-col>
            ...
            >
              <srm-col :initCol="1">
                <el-form-item
                  ...
                  prop="demoText"
                  :rules="[{ required: true, message: '请填写参数报文' }]"
                >
                  <el-input
            ...
            >
              ...
              <srm-col>
                <el-form-item
                  label="http地址"
                  prop="dataSource"
                  :rules="[{ required: true, message: '请填写http地址' }]"
                >
  ...
  data () {
    return {
      ...
      rules: {
        ...
        interfaceCode: [{ required: true, message: '请输入接口编码' }],
        source: [{ required: true, message: '请选择场景' }]
      }
    }
  },
  computed: {},
  ...
  methods: {
    ...
    checkLine () {
      if (this.allParams.form.source == 'JDBC') {
        for (let i = 0; i < this.allParams.sqlParams.length; i++) {
          if (!this.checkColumn(this.allParams.sqlParams[i], 'SQL参数,')) {
            return false
          }
        }
      }
      for (let i = 0; i < this.allParams.params.length; i++) {
        if (!this.checkColumn(this.allParams.params[i], '入参,')) {
          return false
        }
      }
      for (let i = 0; i < this.allParam.length; i++) {
        if (!this.checkColumn(this.allParam[i], '入参子层,')) {
          return false
        }
      }
      for (let i = 0; i < this.allParams.columns.length; i++) {
        if (!this.checkColumn(this.allParams.columns[i], '出参,')) {
          return false
        }
      }
      for (let i = 0; i < this.allColumns.length; i++) {
        if (!this.checkColumn(this.allColumns[i], '出参子层,')) {
          return false
        }
      }
      return true
    ...
    checkColumn (column, remark) {
      if (!column.columnDesc) {
        this.$message.warning(remark + '字段名称必填')
        return
      }
      if (!column.columnName) {
        this.$message.warning(remark + '字段编码必填')
        return
      }
      if (!column.columnType) {
        this.$message.warning(remark + '字段类型必填')
        return
      }
      return true
    },
