      ...
      >
        ...
        >
          <DictSelect
            ...
            :disabled="
              (isBuyer
                ? editable && scope.row.isEdit === 'Y' && !!scope.row.sourceId
                : true) || illegal === 'view'
            "
            @change="changeHandle"
          />
        ...
        >
          ...
          <el-input
            ...
            :disabled="
              (isBuyer ? editable && scope.row.isEdit !== 'Y' : true) ||
                illegal === 'view'
            "
            @change="changeHandle"
          />
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        //     align: "center",
        //     minWidth: "100",
        //     label: t => t.$t("contractMod.stagePaymentAmount"),
  ...
  methods: {
    ...
    //     const stagePaymentAmount =
    //       (form.includeTaxAmount * row.paymentRatio) / 100;
