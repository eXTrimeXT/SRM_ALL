  ...
  >
    <el-main>
      ...
      >
        <srm-row :gutter="32">
          <srm-col>
            <el-form-item label="调查模板编码" prop="questTemplateCode">
              <el-input v-model="configData.questTemplateCode" disabled />
            </el-form-item>
          </srm-col>
          <srm-col>
            <el-form-item label="调查模板名称" prop="questTemplateName">
          ...
          <srm-col>
            ...
            >
              <div class="inputSelect mt24">
                <el-input v-model="configData.quoteQuestTemplateName" placeholder="点击右侧图标选择模板" disabled/>
          ...
          <srm-col :init-col="2">
            <el-form-item label="备注" prop="questTemplateRemark">
        ...
        >
          ...
          >
            ...
            <el-table
              ...
              max-height="350px"
            >
              <el-table-column align="center" prop="questTemplatePropSort" label="*排序">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.questTemplatePropSort" :disabled="curOpt === 'view'" />
                </template>
              </el-table-column>
              <el-table-column align="center" prop="questTemplatePropField" label="*字段编码">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.questTemplatePropField" :disabled="curOpt === 'view'" />
                </template>
              </el-table-column>
              <el-table-column align="center" prop="questTemplatePropFieldDesc" label="字段描述">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.questTemplatePropFieldDesc" :disabled="curOpt === 'view'" />
                </template>
              </el-table-column>
              <el-table-column align="center" prop="questTemplatePropType" label="*字段类型">
                <template slot-scope="scope">
                  <dict-select
              ...
              <el-table-column align="center" prop="questTemplatePropDict" label="字典">
                <template slot-scope="scope">
                  <el-input
              ...
              <el-table-column align="center" prop="questTemplatePropComponent" label="组件属性">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.questTemplatePropComponent" :disabled="curOpt === 'view'" />
                </template>
              </el-table-column>
              <!-- 燕豪新增 -->
              <el-table-column align="center" prop="conditionType" label="条件">
                <template slot-scope="scope">
                  <dict-select
              ...
              <el-table-column align="center" prop="conditionValue" label="条件值" min-width="150">
                <template slot-scope="scope">
                  <el-date-picker
      ...
      <div>
        ...
        >
          <srm-row type="flex">
            ...
            <srm-col :init-col="3">
              <el-form-item label="模板类型" prop="questTemplateType">
                <dict-select
