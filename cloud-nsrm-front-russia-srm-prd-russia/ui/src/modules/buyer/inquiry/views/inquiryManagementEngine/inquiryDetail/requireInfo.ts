...
const RequireInfoSegment: Record<any, any> = {
  ...
  itemList: {
    ...
    ...requiredFunctionValidatorSegment('请先录入物料信息!'),
    properties: generateXindexInOrder({
      ...
      orgOuId: {
        ...
        ...requiredFunctionValidatorSegment('请选择业务实体!')
      },
      ...
      orgInvId: {
        ...
        ...requiredFunctionValidatorSegment('请选择库存组织!')
      },
        ...
        'x-component-props': {
          ...
          '@before-open': generateCharFunctionExpression(({ $table, $self, $message }, _, callback) => {
            ...
            if (!row.orgOuId || !row.orgInvId) {
              $message.warning('请先选择业务实体以及库存组织')
              callback(null)
            }
          })
        }
      ...
      'inqSouItem.itemType': {
        ...
        ...requiredFunctionValidatorSegment('请选择行类型!')
      },
      ...
      requireQuantity: {
        ...
        ...requiredFunctionValidatorSegment('请录入预计采购量!')
      },
      ...
      priceStartTime: {
        ...
        ...requiredFunctionValidatorSegment('请选择定价开始日期!')
      },
      ...
      priceEndTime: {
        ...
        ...requiredFunctionValidatorSegment('请选择定价结束日期!')
      },
