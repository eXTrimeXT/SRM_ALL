                ...
                dropdownMenu: {
                  ...
                  'x-content': {
                    default: {
                      ...
                      render: generateCharFunctionExpression((h: any) => {
                        return [
                          h('el-dropdown-item', { attrs: { command: 'win' } }, '入围下一轮'),
                          h('el-dropdown-item', { attrs: { command: 'loss' } }, '淘汰')
                        ]
                      }, true)
                    }
                  }
                ...
                dropdownMenu: {
                  ...
                  'x-content': {
                    default: {
                      ...
                      render: generateCharFunctionExpression((h: any) => {
                        return [
                          h('el-dropdown-item', { attrs: { command: 'win' } }, '中标'),
                          h('el-dropdown-item', { attrs: { command: 'loss' } }, '落标')
                        ]
                      }, true)
                    }
                  }
            ...
            toApprovalBill: {
              ...
              'x-component-props': {
                ...
                '@click': generateCharFunctionExpression(async ({ $queryEngine, $message, $confirm, $t, $router, $projectId }) => {
                  ...
                  const confirmSubmitResult = await $confirm('确定生成寻源结果审批单吗？', {
                  ...
                  const confirmResult = await $confirm('价格审批单创建成功，需要跳转到价格审批单页面吗？', {
