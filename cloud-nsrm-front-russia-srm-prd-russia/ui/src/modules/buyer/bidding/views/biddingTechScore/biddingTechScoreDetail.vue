  ...
  <div class="technology-score-detail">
    ...
    <div class="display-form-content">
      <SrmRow>
        ...
        <!--发布时间-->
        <SrmCol :init-col="3">
          <span>{{ $t('bidMod.releaseDatetime') }}</span>{{ biddingData.publishTime }}
        </SrmCol>
        <!--投标截止时间-->
        <SrmCol :init-col="3">
          <span>{{ $t('bidMod.enrollEndDatetime') }}</span>{{ biddingData.orderEndTime }}
        </SrmCol>
        <!--编制人-->
        <SrmCol :init-col="3">
        ...
        <!--投标开始时间-->
        <SrmCol :init-col="3">
          <span>{{ $t('bidMod.bidingStartDatetime') }}</span>{{ biddingData.orderStartTime }}
        </SrmCol>
        <!--预计投标地点-->
        <SrmCol :init-col="3">
