...
import bargainTechScoreDetail from './bargainTechScoreDetail.vue'
...
export default {
  ...
  data () {
    return {
      tableViewUrl: brgBuyerHttp.tech.techProgressReviewUrl,
      tableData: [],
      pageSize: 15,
      tableHeader: [
        // 项目编号
  ...
  methods: {
    ...
    editOrgData (row) {
      let tab = {
        component: bargainTechScoreDetail,
        ctrlHeight: true,
        params: {
          flag: 'edit',
          row: row,
          tabName: `bargainTechScoreDetail${row.souName}`
        },
        title: row.souName,
        name: `bargainTechScoreDetail${row.souName}`
      }
