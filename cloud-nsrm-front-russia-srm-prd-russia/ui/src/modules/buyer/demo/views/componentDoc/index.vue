            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <div class="the_QuickSearch_wrapper">
                  ...
                  <span>供应商查询单选 scc_base_purchase_category</span>
                  <QuickSearch
              ...
              <el-col :span="12">
                <div class="the_QuickSearch_wrapper">
                  <!-- 供应商查询多选 -->
                  <span>供应商查询多选-input形式 scc_sup_company_info_for_component</span>
                  <QuickSearch
              ...
              <el-col :span="12">
                <div class="the_QuickSearch_wrapper">
                  <!-- 供应商查询多选 -->
                  <span>供应商查询多选-按钮形式 scc_sup_company_info_for_component</span>
                  <div>
                    <QuickSearch
                      :show-input="preform.companyName"
                      btnTitle="选择供应商"
