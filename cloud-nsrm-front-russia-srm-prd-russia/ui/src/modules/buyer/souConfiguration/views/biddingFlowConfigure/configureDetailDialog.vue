  ...
  >
    ...
    >
      <SrmRow>
        <!--模板名称-->
        <SrmCol :init-col="4">
          <el-form-item label="流程名称" prop="processConfigName">
      ...
      <SrmRow>
        <!--流程简述-->
        <SrmCol :init-col="1">
          <el-form-item label="流程简述" prop="remark">
            <el-input
...
<script>
import { bidBuyerHttp } from 'modb@/souConfiguration/api'
...
export default {
  ...
  methods: {
    ...
    async confirm () {
      ...
      const response = await bidBuyerHttp.process.editProcessConfig(params)
      if (response) {
