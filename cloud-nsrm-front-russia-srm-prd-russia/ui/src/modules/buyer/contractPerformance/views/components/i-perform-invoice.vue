  ...
  data () {
    return {
      ...
      columns: [
        ...
        { prop: 'actualInvoiceDate', label: this.$t('实际开票完成时间'), width: 180 },
        ...
        { prop: 'palnPaymentDate', label: this.$t('计划付款时间'), width: 150 },
        { prop: 'paymentApplyNo', label: this.$t('付款申请单号'), width: 150 },
        { prop: 'actualPaymentDate', label: this.$t('实际付款时间'), width: 150 },
