    ...
    <el-main>
      ...
      >
        <template #firstMonthLabel="props">
          <label style="font-weight: normal;"> {{ props.scope.row.firstMonthLabel }}月 </label>
          <el-input
        ...
        <template #secondMonthLabel="props">
          <label style="font-weight: normal;"> {{ props.scope.row.secondMonthLabel }}月 </label>
          <el-input
            v-model="props.scope.row[props.scope.column.property]"
            class="month-input"
            :type="props.inputType || 'string'"
        ...
        <template #threeMonthLabel="props">
          <label style="font-weight: normal;"> {{ props.scope.row.threeMonthLabel }}月 </label>
          <el-input
            v-model="props.scope.row[props.scope.column.property]"
            class="month-input"
            :type="props.inputType || 'string'"
