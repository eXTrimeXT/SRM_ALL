        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  <dictSelect
                    ...
                    v-model="scope.row.ceeaMaterialStatus" />
                </template>
              </el-table-column> -->
              <!-- <el-table-column
                prop="ceeaSupplierCode"
                label="供应商编码"
                min-width="150px"
                show-overflow-tooltip
              >
                <template slot-scope="scope">
                  <template>
                    <el-form-item
                      :prop="'tableData.' + scope.$index + '.ceeaSupplierCode'"
                    >
                      <QuickSearch
                        :showInput="scope.row.ceeaSupplierCode"
              ...
              >
                <template slot-scope="{ row }">
                  <span>{{row.ceeaIfCatalogMaterial==='Y'?'是':'否'}}</span>
                </template>
              </el-table-column> -->
              <!-- 是否启用 -->
              <!--<el-table-column
              ...
              >
                <template slot-scope="scope">
                  <el-button
                    ...
                    type="text"
                    @click="openOrganizationDialog(scope.row)"
                  >查看</el-button>
                </template>
              </el-table-column> -->
              <!-- 上架人 -->
