      ...
      <div class="form-container">
        <el-collapse v-model="activeDims" class="tab-form-style">
          <el-form :disabled="isReadOnly" ref="form" :model="form" :rules="rules">
            <!-- 条码基本信息 -->
            <el-collapse-item title="内箱条码基本信息" name="1">
              <srm-row :gutter="32">
                <srm-col :span="6">
                  <el-form-item prop="innerBoxCode" label="内箱条码编号">
                ...
                <srm-col v-if="!innShow&&!editMode" :span="6">
                  <el-form-item prop="currentLotQuantity" label="待装箱数量">
                    <el-input v-model="form.currentLotQuantity" />
                  </el-form-item>
                </srm-col>
                <srm-col v-if="!innShow&&editMode" :span="6">
                  <el-form-item prop="currentBoxQuantity" label="数量（重量/净重）">
          ...
          <!-- 条码扩展信息 -->
          <el-collapse-item v-show="expandFields.length > 0" title="內箱条码扩展信息" name="2">
