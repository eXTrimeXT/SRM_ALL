        ...
        >
              ...
              <div>
                <el-form ref="filterForm" :model="filterForm">
                  <srm-row :gutter="32">
                    ...
                    <!-- <srm-col>
                      <el-form-item :label="$t('purchaseDemand.requestDateFrom')">
                        <el-date-picker v-model="filterForm.startDate" />
                      </el-form-item>
                    </srm-col>
                    <srm-col>
                      <el-form-item :label="$t('purchaseDemand.requestDateTo')">
          ...
          <el-collapse-item :title="$t('bidMod.fileInfo')" name="4">
            ...
            <el-table :data="procurementFile" style="width: 100%" border max-height="250px">
              ...
              <el-table-column align="center" prop="creationDate" :label="$t('purchaseDemand.attachmentCreatedDate')" />
