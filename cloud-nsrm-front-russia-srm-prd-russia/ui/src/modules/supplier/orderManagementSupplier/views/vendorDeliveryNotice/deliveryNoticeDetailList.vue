  ...
  >
    <el-main>
      ...
      <TableView
        ...
        customTableKey="vendorDeliveryNoticeDetailList"
      />
    </el-main>
  </el-container>
</template>
...
import purchaseOrderDetail from 'mods@/orderManagementSupplier/views/vendorPurchaseOrder/vendorPurchaseOrderDetail'
...
export default {
  ...
  data () {
    return {
      tableUrl: '/api-sup-ce/sup/deliveryNotice/listPageDeliveryNoticeDetail',
      dictCodes: {
      ...
      tableHeader: [
        ...
        {
          prop: 'receiveDate',
          label: _ => this.$t('purchaseDemand.requirementDate1'), // 要求到货日期
          minWidth: 120,
          formattor: val => (val ? parseTime(val, '{y}-{m}-{d}') : '')
        },
        {
