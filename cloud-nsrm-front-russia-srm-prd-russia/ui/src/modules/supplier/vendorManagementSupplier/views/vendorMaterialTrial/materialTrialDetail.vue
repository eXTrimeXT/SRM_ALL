        ...
        >
          ...
          >
            <srm-row>
              ...
              <srm-col>
                <el-form-item label="物料试用类型" prop="entryType">
                  <DictSelect
              ...
              <srm-col v-if="form.entryType === 'ENTRY_TYPE'">
                <el-form-item label="资质审查单号" prop="reviewFormNumber">
                  <QuickSearch
                    disabled
  ...
  data () {
    return {
      ...
      formRules: {
        ...
        entryType: [{ required: true, message: '请输入物料试用类型' }],
        reviewFormNumber: [{ required: true, message: '请输入资质审查单号' }]
      },
      vendorConfirmInfo: {
        // 供应商回复信息
        expressType: '', // 送样方式
