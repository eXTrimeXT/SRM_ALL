            ...
            <el-row :gutter="32">
              <el-col :span="8">
                <div class="mg-l-header">
                  供应商名称：<strong>{{ allParams.vendorName }}</strong>
                </div>
              </el-col>
              <el-col :span="8">
                <div class="mg-l-header">
                  反馈状态：
                  <strong>{{ resultFlagFormat(allParams.resultFlag) }}</strong>
                </div>
              </el-col>
              <el-col :span="8">
                <div class="mg-l-header">
                  反馈时间：<strong>{{ allParams.lastUpdateDate }}</strong>
                </div>
              </el-col>
            </el-row>
            <el-row>
                      ...
                      <template v-if=" el.employeeResultDtoList && el.employeeResultDtoList.length > 0">
                        ...
                        >
                          ...
                          <template v-if="elm.surveyResultDtoList && elm.surveyResultDtoList.length > 0">
                            <div>
                              <span>员工姓名：<strong>{{ elm.employeeName }}</strong></span>
                              <span>-</span>
                              <span>员工岗位：<strong>{{ elm.employeeJob }}</strong></span>
                            </div>
