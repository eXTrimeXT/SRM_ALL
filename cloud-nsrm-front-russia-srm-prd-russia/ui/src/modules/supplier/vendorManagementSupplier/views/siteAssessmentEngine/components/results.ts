...
export const results = {
  ...
  //       }`),
  //       'x-render-table-column': {
  //         title: "{{$t('common.pleaseSelect')}}", // 评审与结论阶段显示该模板
  //         minWidth: 140,
  //         customRender: true
  //       }
  //     },
  ...
  //         }`),
  //         'readonly': expression(`$attrs.params.flag == 'view' || $form.query('state').get('data').bolType == 3 || $form.query('state').get('data').bolType == 4`),
  ...
  //       'x-component-props': {
  //         disabled: expression(`$form.query('state').get('data').bolType == 3 || $form.query('state').get('data').bolType == 4`)
  //       },
  //       'x-render-table-column': {
  //         minWidth: 100
  //       }
