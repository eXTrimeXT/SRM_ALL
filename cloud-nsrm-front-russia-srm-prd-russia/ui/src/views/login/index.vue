  ...
  >
    <el-main :class="{ 'login-main-body': isPC, 'login-main-body-mobile': !isPC }">
      ...
      <div class="login-top-sec">
        ...
        <div class="login-contain">
          ...
          >
            <div class="iconfont-button themeLink">
              <i class="iconfont iconearth" />
              <span style="float:right;line-height:18px;margin-left:7px;color: #fff;">{{ newLang }}</span>
            </div>
          ...
          <div v-if="(singlePoint==='N' || showLoginBox === 'Y' ) && (loginType === 'innerLogin' || loginType === 'workChatLogin')" class="form-div">
            ...
            >
              ...
              <el-form-item prop="isRememberUser" class="form-account">
                <el-checkbox v-model="isRememberUser" class="vendor-account" label="记住账号" />
            ...
            <div class="other-login-type">
              ...
              <div class="type-content">
                <span v-if="loginType === 'workChatLogin'" type="text" @click="switchType">SRM登录</span>
                <span type="text" @click="singlePointLogin">IAM登录</span>
                <span v-if="loginType === 'innerLogin' && isWorkchatLogin === 'Y'" type="text" @click="workChatLogin">企业微信登录</span>
          ...
          <div v-else class="single-point-login">
            ...
            <div class="iamLogin">
              ...
              <el-tabs v-model="activeName" class="tabs_box" :stretch="true" @tab-click="tabHandleClick">
                ...
                <el-tab-pane label="采购商登录" name="second" />
              </el-tabs>
              <div style="width:86%; margin:10px auto">
                ...
                <div class="btns">
                  <div class="btn" @click="iamForgetPassword">
                    修改密码
                  </div>
      ...
      <div class="login-footer">
        <div class="copy-right">
          <span>Copyright © 2016-2023 | 长城汽车股份有限公司版权所有 | 冀ICP备05008632号 | 版本信息：V2.0</span>
    ...
    >
      <div class="register-wrapper">
        ...
        <div class="info">
          密码已下发至您的邮箱，请注意查收！登录后需先完成企业信息认证，点击【用户管理】-【企业信息】菜单根据指引填写即可。
        </div>
