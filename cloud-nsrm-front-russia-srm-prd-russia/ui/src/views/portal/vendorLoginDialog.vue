...
import { getToken, removeRedirectUrl, setRedirectUrl, getRedirectUrl, setEntranceType } from '@/utils/auth'
      ...
      this.$refs.vendorLoginForm.validate(async (valid) => {
        if (valid) {
          ...
          let resData = await this.$http({
            ...
            method: 'POST',
            data: {
              username: this.vendorLoginForm.username,
              password: dataEncryption(this.vendorLoginForm.password, data),
              redirectUri: ''
            },
            loading: true
          })
...
::v-deep .el-dialog .el-dialog__header {
  padding: 45px 40px 30px 112px !important;
}
