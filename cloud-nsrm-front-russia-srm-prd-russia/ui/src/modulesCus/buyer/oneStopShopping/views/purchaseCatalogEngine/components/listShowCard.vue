          ...
          <div class="itemWrpper">
            ...
            <div class="item-info">
              <!-- <div class="item-price">
                ...
                <span class="price-currency"> {{ item.currencyName }}</span>
              ...
              <p>
                ...
                <span class="price-currency"> {{ $getDictLabel('currency', item.currencyCode) }}</span>
              </p>
              <p>
              ...
              <p :title="item.materialName">
                ...
                <span class="item-desc-font">{{ item.extGoodsName }}</span>
              </p>
              <p>
