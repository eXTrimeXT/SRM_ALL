  ...
  computed: {
    ...
    compName () {
      ...
      case 'EXT_SOU_FIX_PRICE':
        ...
        myComponent = () =>
          import(
            'modcb@/inquiry/views/priceOrders/priceOrderDetail.vue'
          )
        break
      case 'MQL_PR_SOU_REQUIREMENT_INIT':
        // 采购需求提报招标立项
        myComponent = () =>
          import(
            'modcb@/purchasingDemand/views/purchaseApplication/purchaseApplicationDetailZhaobiao'
          )
        break
      case 'REQUIREMENT':
        // 采购需求提报
      ...
      case 'SOU_CA':
        ...
        myComponent = () =>
          import(
            'modcb@/caManagement/views/calibrationApply/edit.vue'
          )
        break
      case 'SOU_DCA':
        // 定标废弃申请
        myComponent = () =>
          import(
            'modcb@/caManagement/views/calibrationApplyAbandon/edit.vue'
          )
        break
      case 'SOU_TN':
        // 中落标通知
        myComponent = () =>
          import(
            'modcb@/bidNoticeManagement/views/bidNotice/edit.vue'
          )
        break
      case 'SOU_ATN':
        // 中落标废弃申请
        myComponent = () =>
          import(
            'modcb@/bidNoticeManagement/views/bidNoticeAbandon/edit.vue'
          )
        break
      case 'BORROW':
        // 借阅申请审批
      ...
      case 'bidDataSubmit':
        ...
        myComponent = () =>
          import(
            'modcb@/purchasingDemand/views/biddingDocuments/edit.vue'
          )
        break
      case 'RCOMMVENDOR':
        // 推荐供应商
        myComponent = () =>
          import(
            'modcb@/supplierRecommend/views/recommendVendor/edit.vue'
          )
        break
    ...
    formQuery () {
      ...
      case 'EXT_SOU_FIX_PRICE':
        query = {
          ...
          row: {
            fixPriceHeadId: this.query.formId
          }
        }
        break
      case 'MQL_PR_SOU_REQUIREMENT_INIT':
      ...
      case 'SOU_DCA':
        query = {
          ...
          row: {
            caId: this.query.formId,
            originalCaId: this.query.originalCaId || null
          }
        }
        break
      case 'SOU_TN':
      ...
      case 'SOU_ATN':
        query = {
          ...
          row: {
            bidNoticeId: this.query.formId,
            originalBidNoticeId: this.query.originalBidNoticeId || null
          }
        }
        break
      case 'BORROW':
      ...
      case 'bidDataSubmit':
        ...
        query = {
          ...
          approvalFlag: true,
          readOnly: true,
          row: { dataSubmitId: this.query.formId }
        }
        break
      case 'RCOMMVENDOR':
        // 推荐供应商
