  ...
  <el-container class="the_demotion_detail flex-container" direction="vertical">
    <el-main>
      <el-collapse v-model="activeDims" class="tab-form-style">
            ...
            <srm-row>
              ...
              <srm-col :initCol="4">
                <el-form-item :label="$t('vendorMod.relegation.creationTime')">
                  <el-input v-model="companyDemotion.creationDate" disabled />
                </el-form-item>
              </srm-col>
              <!-- 降级生效时间 -->
        ...
        >
          ...
          >
            ...
            <el-table-column
              ...
              sortable
            />
            <el-table-column prop="warningStatus" label="目前预警状态" sortable>
              <template slot-scope="scope">
                <span>{{ $getDictLabel('WARNING_STATUS',scope.row.warningStatus) }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="firstScore" label="最近第一次绩效成绩" sortable />
            <el-table-column prop="secondScore" label="最近第二次绩效成绩" sortable />
            <el-table-column prop="thirdScore" label="最近第三次绩效成绩" sortable />
            <el-table-column label="近三次的绩效成绩">
              <template slot-scope="scope">
        ...
        <!-- 改善单据 -->
        <el-collapse-item ref="improveDocuments" title="改善单据" name="4">
    ...
    <!-- 查看绩效明细 -->
    <el-dialog title="绩效明细" width="90%" :visible.sync="performenceDialog.show">
