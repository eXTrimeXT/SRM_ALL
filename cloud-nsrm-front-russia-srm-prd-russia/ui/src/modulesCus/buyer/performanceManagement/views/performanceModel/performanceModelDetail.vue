              ...
              <srm-row>
                ...
                <srm-col>
                  <el-form-item :label="$t('perfMod.creationDate')">
                    <el-input v-model="modeForm.creationDate" disabled />
                  </el-form-item>
                </srm-col>
                <srm-col>
                ...
                <srm-col v-if="modeForm.attribute1 == 'ORDER'">
                  <el-form-item :label="$t('公司')" prop="organizationName">
  ...
  data () {
    return {
      ...
      rules: {
        ...
        isFormula: [{ required: true, message: this.$t('请填写是否启用高级公式配置') }],
      ...
      performanceManagement.getPefTempDimAndOrgCat().then(res => {
        ...
        datas.forEach(e => {
          if (e.indicatorDimension == 'OHTER') {
            e.indicatorDimensionName = '其他'
          }
          if (e.indicatorDimension == 'TEAM') {
            e.indicatorDimensionName = '团队'
          }
        })
              ...
              if (this.modeForm.attribute1 == 'PROJECT') {
                ...
                if (bolDimensionWeight == 1) {
                  ...
                  return this.__jump_error__(
                    'modindicatorInfo',
                    null,
                    '维度下面所有指标权重之和为100' // '维度下面所有指标权重之和为100!'
                  )
                }
