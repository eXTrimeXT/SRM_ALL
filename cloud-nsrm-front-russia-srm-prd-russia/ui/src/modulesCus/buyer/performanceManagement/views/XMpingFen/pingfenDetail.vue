        ...
        <div class="form-container2">
          ...
          >
            <el-collapse v-model="activeDims" class="tab-form-style">
              <el-collapse-item ref="aptInfo" title="评分信息" name="1">
                <srm-row>
                  <srm-col>
                    <el-form-item
                      label="评分项目名称"
              ...
              <el-collapse-item title="评分详情" name="3">
                <!-- <p class="btn_line">
                  <el-button
                    v-if="!isReadOnly"
                    :disabled="isReadOnly"
              ...
              <el-collapse-item title="复核驳回信息" name="3">
  ...
  methods: {
    ...
    async saveOrSubmitBill (type) {
      ...
      if (type === 'SUBMIT') {
        ...
        if (bol) {
          this.$message.warning('评分详情有分数未填写')
          return false
        }
