...
export default {
  ...
  created () {
    ...
    this.tableHeader = [
      ...
      { prop: 'contractNo', label: '合同单号', width: 120 },
      { prop: 'contractName', label: '合同名称', width: 120 },
      { prop: 'ouOrganizationName', label: '公司', width: 120 },
      { prop: 'companyCode', label: '供应商编码', width: 120 },
      { prop: 'companyName', label: '供应商名称', width: 120 },
      { prop: 'bidCode', label: '招标编号', width: 120 },
      { prop: 'extInvestNo', label: '投资编号', width: 120 },
      {
        prop: 'projectStatus',
