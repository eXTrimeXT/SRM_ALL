...
export default {
  ...
  methods: {
    ...
    getFormDetail (id) {
      return new Promise(async resolve => {
        ...
        if (response && response.data) {
          ...
          project.designArea = project.designArea ? project.designArea.split(',') : []
          this.allParams = {
            header: {
              ...project,
              // 默认普通报价
          ...
          this.$nextTick(() => {
            this.$refs.inquiryDetailInfo && this.$refs.inquiryDetailInfo.clearFormValidate()
          })
        }
        resolve()
      })
    ...
    getFormatAllParams ({ isTempSave }) {
      ...
      header.designArea = header.designArea.length ? header.designArea.join() : ''
      return {
