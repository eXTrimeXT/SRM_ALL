  ...
  <div class="inquiry-detail-info">
    ...
    >
      <el-collapse v-model="activeDims" class="tab-form-style">
        ...
        <!-- 基本信息-->
        <el-collapse-item :title="$t('cusEntry.centralizedPurchase.baseInfo')" name="2">
          <BaseInfo :header.sync="headerData" />
        </el-collapse-item>
        <!--c 联系方式 4-->
        <el-collapse-item :title="$t('bidMod.contactInfo')" name="3">
          <OriginContactInfo
...
import BaseInfo from './inquiryDetailInfo/base-info'
export default {
  ...
  data () {
    return {
      rules: {
        ...
        extVendorPerformanceRank: [{ required: true, message: this.$t('cusEntry.tipMessage.extVendorPerformanceRankMsg') }]
      },
      activeDims: ['1', '2', '3'],
      BUSINESS_TYPE_ENUM
    }
