    ...
    properties: {
      ...
      productCapableInfos: {
        ...
        properties: generateXindexInOrder({
          ...
          capacityRatio: {
            type: 'string',
            title: i18nExpression('可提供的供应商产能比例'),
            'x-render-table-column': {
              minWidth: 120
            },
            'x-component-props': {
