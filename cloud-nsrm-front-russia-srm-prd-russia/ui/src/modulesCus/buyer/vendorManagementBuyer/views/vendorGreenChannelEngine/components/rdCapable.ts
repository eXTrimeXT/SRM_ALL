      ...
      rdCapables: {
        ...
        properties: generateXindexInOrder({
          ...
          seniorEngineerQuantity: {
            type: 'string',
            title: i18nExpression('高级工程师数量(其中)'),
            'x-render-table-column': {
              minWidth: 120
            },
            'x-component-props': {
      ...
      rdCapableAdditionals: {
        ...
        properties: {
          ...
          'ifTechnicalStandard': {
            ...
            title: i18nExpression(`是否建立企业技术标准`)
          },
          // 产品采用技术标准
