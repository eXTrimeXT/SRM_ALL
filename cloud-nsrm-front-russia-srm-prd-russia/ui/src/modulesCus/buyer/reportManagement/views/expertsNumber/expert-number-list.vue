...
export default {
  ...
  data () {
    return {
      preArr: [],
      pageUrl: '/api-sup-ce/mdv/expertHotListPage',
      tableHeader: [],
      queryParams: {},
      dictCodes: {},
      pageSize: 15,
      gridList: 'ExpertsNumberList'
    }
  },
  created () {
    this.preArr = [
      {
        prop: 'expertFullName',
        label: () => this.$t('cusEntry.reportManagement.expertName')
      },
      {
        prop: 'buName',
    ...
    this.tableHeader = [
      ...
      {
        prop: 'quantity',
        label: () => this.$t('cusEntry.reportManagement.involvedQuantity'),
        minWidth: 120
      }
    ]
  },
