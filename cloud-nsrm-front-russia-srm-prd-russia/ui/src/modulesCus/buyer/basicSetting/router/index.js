...
export default {
  ...
  children: [
    ...
    // 组织设置 /baseSetting/organizationSetting
    {
      ...
      component: () => import('modc@/buyer/basicSetting/views/organizationSetting'),
    ...
    // 流程角色 /baseSetting/processRole
    {
      path: 'processRole',
      component: () => import('modc@/buyer/basicSetting/views/processRole'),
      name: 'processRole',
      meta: {
        title: 'cusEntry.route.processRole',
        requiresAuth: true
      }
    },
    // 准入流程配置 /baseSetting/accessFlowSetting
    {
      ...
      component: () => meiqlCtrl.accessFlowSetting === 'Y'
        ? import('modcb@/basicSetting/views/accessFlowSetting')
    ...
    // 用户登录统计 /baseSetting/userRegisterCount
    {
      ...
      component: () => import('modcb@/basicSetting/views/userRegisterCount'),
    ...
    // 采购分类维护 /baseSetting/purchaseCategoryMaintenance
    {
      ...
      component: () =>
        import('modcb@/basicSetting/views/purchaseCategoryMaintenance'),
