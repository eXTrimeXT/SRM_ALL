        ...
        <div class="form-container2">
          ...
          >
            <el-collapse v-model="activeDims" class="tab-form-style">
              <el-collapse-item ref="aptInfo" title="采购申请详情" name="1">
                <srm-row>
                  <srm-col>
                    <!-- 申请部门 -->
                    <el-form-item
                  ...
                  <srm-col :initCol="1">
                    ...
                    <el-form-item prop="ceeaAppointReason">
                      <span style="font-size:12px;">
                        <em class="toRequired" style="margin-left:0;">*</em>需求取消说明
                      </span>
                      <el-input
              ...
              <el-collapse-item ref="itemInfo" title="需求取消明细行" name="2">
                <el-table
...
export default {
  ...
  created () {
    ...
    if (this.$attrs.params.flag === 'add') {
      ...
      this.$http({
        ...
        //     username2 = e.fullName
        //   }
        //   if (e.groupType == 'SOU') {
        //     username1 = e.fullName
        //   }
        // })
        let souReqHead = data
  ...
  methods: {
    ...
    async getFormDetail (requirementCancelId) {
      ...
      //   this.cancelAttachList = data.data.cancelAttachList
      //   let list = data.data.cancelLineList.map(
      ...
      //     },
      //   )
      //   this.requirementHead.cancelLineList = list
      //   this.allcancelLineList = list
    ...
    async submitEvent (allparam) {
      ...
      //   if (valid) {
      console.log(allparam.cancelReason)
