      ...
      },
      {
        ...
        buttons: [
          ...
          // 拟定 可以提交 提交之后变成待执行
          {
            ...
            callback: row => {
              this.changeStatus('EXECUTE', row, '确定提交该行数据？')
            }
          },
          // 拟定、待执行、执行中 可以终止
          {
            ...
            callback: row => {
              this.changeStatus('STOP', row, '确定终止该行数据？')
            }
          }
          // 已终止 可以失效
          // {
          //   show: row => ['STOP'].includes(row.agreementStatus),
          //   formattor: () => '失效',
          //   code: 'centralizedAgree:expired',
          //   callback: row => {
          //     this.changeStatus('EXPIRED', row, '确定失效该行数据？')
          //   }
          // }
        ]
      }
      ...
      const map = new Map([
        ...
        [
          'change',
          {
            ...
            title: '集采协议变更' + (row.agreementCode || ''),
            name: row.agreementCode
          }
        ]
      ])
