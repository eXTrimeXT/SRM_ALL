    ...
    <div class="content">
      ...
      <div class="content-box">
        ...
        <div class="content-item">
          ...
          <div class="content-info">
            <p>①凡有意参加报名的供应商,请至长城控股电子招标平台注册报名:地址上为:https://srm.gwm.cn,《供应商注册指南 可在平台网站首页"用户登录选择"栏附近查看,并根据手册要求进行注册,注册成功后可根据项目名称,按报名要求进行报名,未按照此方式报名的,视作无效报名;</p>
            <p>②如无法在招标平台完成注册的,请及时联系；</p>
            <p>③.如对本项目有技术疑问或想了解更多详细信息，可将问题分条描述清晰，发送至（zbgys@gwm.cn）。邮件中请注明公司名称、联系人及联系电话；</p>
            <p>④邮件主题须注明项目名称、报名联系人，如XX项目疑问XX收，将统一进行答疑回复。</p>
          </div>
        </div>
        <!-- 无意向金时不展示 -->
