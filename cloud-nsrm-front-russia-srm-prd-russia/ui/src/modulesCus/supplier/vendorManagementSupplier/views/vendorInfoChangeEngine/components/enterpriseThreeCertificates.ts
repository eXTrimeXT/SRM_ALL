    ...
    properties: {
      ...
      enterpriseThreeCertificatesBefore: {
        ...
        properties: {
          ...
          businessStartDate: {
            type: 'date',
            'x-visible': expression(`$form.query(\'enterpriseThreeCertificatesBefore.ifLongPeriod\').take().value !== \'Y\'`),
          ...
          businessEndDate: {
            type: 'date',
            'x-visible': expression(`$form.query(\'enterpriseThreeCertificatesBefore.ifLongPeriod\').take().value !== \'Y\'`),
            title: i18nExpression('vendorMod.businessEndAt'), // 营业日期至
            'x-disabled': true,
            'x-decorator': 'FormItem'
          },
          companyShortName: {
      ...
      enterpriseThreeCertificatesAfter: {
        ...
        properties: {
          ...
          registeredCapital: {
            ...
            //           },
            //           style: { 
            //             'padding-left': $self.readPretty ? '5px' : 0
            //           },
            //           on: {
            //             'change': (v) => {
            //               targetField.value = v
          ...
          businessStartDate: {
            type: 'date',
            'x-visible': expression(`$form.query(\'enterpriseThreeCertificatesAfter.ifLongPeriod\').take().value !== \'Y\'`),
            title: i18nExpression('vendorMod.businessStartFrom'), // 营业日期从
            'x-reactions': expression(`() => {
