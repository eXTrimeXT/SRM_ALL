    ...
    properties: {
      ...
      companyBaseInfoBefore: {
        ...
        properties: {
          ...
          companyProvince: {
            type: 'string',
            'x-hidden': `{{ $form.query('state').get('data').userType === 'PERSONAL' || $form.query('.companyBaseInfoBefore.companyCountry').take().value !== 'CN'}}`,
    ...
    properties: {
      ...
      companyBaseInfoAfter: {
        ...
        properties: {
          ...
          companyProvince: {
            type: 'string',
            'x-hidden': `{{ $form.query('state').get('data').userType === 'PERSONAL' || $form.query('.companyBaseInfoAfter.companyCountry').take().value !== 'CN'}}`,
            title: i18nExpression('components.address.area'),
            'x-component': 'DictSelect',
            'x-reactions': expression(`() => {
