    ...
    properties: {
      ...
      personBaseInfoBefore: {
        ...
        properties: {
          ...
          companyProvince: {
            type: 'string',
            'x-hidden': `{{ $form.query('state').get('data').userType !== 'PERSONAL' || $form.query('.personBaseInfoBefore.companyCountry').take().value !== 'CN'}}`,
    ...
    properties: {
      ...
      personBaseInfoAfter: {
        ...
        properties: {
          ...
          companyProvince: {
            type: 'string',
            'x-hidden': `{{ $form.query('state').get('data').userType !== 'PERSONAL' || $form.query('.personBaseInfoAfter.companyCountry').take().value !== 'CN'}}`,
            title: i18nExpression('components.address.area'),
            'x-decorator': 'FormItem',
            'x-component': 'DictSelect',
            'x-component-props': {
