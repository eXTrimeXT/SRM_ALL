        ...
        <div class="rank-container">
          ...
          <div class="container-right">
            ...
            <el-tabs v-model="activeName" class="mg-10" @tab-click="tabClick">
              <el-tab-pane label="实时排名" name="first">
                <PriceRanking :base-info="baseInfo" :table-data="itemPriceList.slice(0,5)" />
              </el-tab-pane>
              <el-tab-pane label="报价历史" name="second">
                <QuoteRecord
  ...
  computed: {
    ...
    infoList () {
      ...
      return [
        ...
        {
          label: '延长竞价触发点',
          value: projectInfo.extendTrigger ? `${projectInfo.extendTrigger}分钟` : '-',
          enable: true
        },
        {
          label: '竞价规则',
        ...
        {
          label: '延长竞价时长',
          value: projectInfo.extendMinute ? `${projectInfo.extendMinute}分钟` : '-',
          enable: true
        },
        {
          label: '评分规则',
