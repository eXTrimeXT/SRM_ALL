    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, scope) => {
            if (this.readPretty == true) {
              return scope.row.planInvoiceCompleteDate
            } else {
              return (
                <el-date-picker
        ...
        { prop: 'extAcceptanceDate', label: '承兑期限', width: 120 },
        { prop: 'extAcceptanceRatio', label: '承兑比例%', width: 130 },
        { prop: 'extWireTransferRatio', label: '电汇比例%', width: 130 },
