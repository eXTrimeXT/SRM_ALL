      ...
      <el-collapse v-model="colValue">
        ...
        <el-collapse-item ref="perPlanMilestone" title="里程碑" name="2">
          <el-table border stripe :data="perPlanMilestoneList">
            ...
            <el-table-column prop="planStartDate" label="计划开始时间" min-width="130" show-overflow-tooltip />
            ...
            <el-table-column prop="practicallyEndDate" min-width="150">
              ...
              <template slot-scope="scope">
                <el-date-picker v-model="scope.row.practicallyEndDate" :disabled="disabledFlag || form.dataCreationType === 'BUYER'" placeholder="选择日期" value-format="yyyy-MM-dd" />
              </template>
            </el-table-column>
            <el-table-column prop="remarks" label="特殊备注" min-width="150" />
            <el-table-column prop="fileId" label="附件模板" min-width="150" show-overflow-tooltip>
              <template slot-scope="scope">
                <SrmCommonFile
                  :default-file="{
