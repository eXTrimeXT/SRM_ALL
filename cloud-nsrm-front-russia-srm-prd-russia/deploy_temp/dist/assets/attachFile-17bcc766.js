import{af as i18nExpression,aC as requiredValidatorSegment,ae as expression,ah as radioGroupByYOrNSegment,ai as generateXindexInOrder}from"./index-17d0ccd5.js";const companyType={beforeChange:{type:"void","x-component":"div","x-component-props":{class:"formClassAllChange"},properties:{beforeChangeTitle:{type:"void","x-component":"changeTitle","x-component-props":{language:"supplierChange.beforeChange"}},companyTypeBefore:{type:"object","x-query-engine-skip":!0,"x-component":"FormGrid","x-component-props":{class:"forms"},properties:{overseasRelation:{type:"string",title:i18nExpression("vendorMod.overseasRelation"),"x-component":"DictSelect","x-component-props":{code:"RELATION_NEW",disabled:!0},"x-decorator":"FormItem",...requiredValidatorSegment},companyType:{type:"string",title:i18nExpression("vendorMod.companyType"),"x-component":"DictSelect","x-hidden":expression("$form.query('.companyTypeBefore.overseasRelation').take()?.value != 'INSIDE'"),"x-component-props":{code:"COMPANY_NATURE",disabled:!0},"x-decorator":"FormItem","x-validator":{required:expression("$form.query('.overseasRelation').take()?.value == 'INSIDE'"),message:i18nExpression("common.requiredField")}},supplierType:{type:"string",title:i18nExpression("supplierRating.supplierType"),"x-component":"DictSelect","x-component-props":{code:"SUPPLIER_TYPE",disabled:!0},"x-decorator":"FormItem",...requiredValidatorSegment}}}}},afterChange:{type:"void","x-component":"div","x-component-props":{class:"formClassAllChange"},properties:{afterChangeTitle:{type:"void","x-component":"changeTitle","x-component-props":{language:"supplierChange.afterChange"}},companyTypeAfter:{type:"object","x-query-engine-skip":!0,"x-component":"FormGrid","x-component-props":{class:"forms"},properties:{overseasRelation:{type:"string",title:i18nExpression("vendorMod.overseasRelation"),"x-component":"DictSelect","x-component-props":{code:"RELATION_NEW",disabled:!0},"x-reactions":expression(`() => {
                ...
                let className = redFunction(oldData, newData)
                $self.setComponentProps({ class: className })
            }`),"x-disabled":expression("$form.readPretty"),"x-decorator":"FormItem"},businessStartDate:{type:"date","x-hidden":expression("$form.query('.companyTypeAfter.companyType').take().value == 'GETI'"),title:i18nExpression("vendorMod.businessStartFrom"),"x-reactions":expression(`() => {
                ...
                let className = redFunction(oldData, newData)
                $self.setComponentProps({ class: className })
            }`),"x-disabled":expression("$form.readPretty"),"x-decorator":"FormItem"},businessEndDate:{type:"date","x-hidden":expression("$form.query('.companyTypeAfter.companyType').take().value == 'GETI'"),title:i18nExpression("common.pleaseSelectDate"),"x-reactions":expression(`() => {
                ...
                let className = redFunction(oldData, newData)
                $self.setComponentProps({ class: className })
            }`),title:expression("$t('vendorMod.creationDate')"),"x-validator":{required:!0,message:i18nExpression("请选择上市时间")}},listedExchange:{type:"string","x-visible":"{{$form.query('.companyBaseInfoAfter.ceeaIfListed').take().value == 'Y'}}","x-decorator":"FormItem","x-component-props":{disabled:expression("$form.readPretty")},title:expression("$t('vendorMod.listedExchange')"),"x-validator":{required:!0,message:i18nExpression("请选择上市交易所")}},ceeaBusinessModel:{type:"string",title:i18nExpression("vendorMod.bizModel"),"x-component":"DictSelect","x-component-props":{code:"BIZ_MODEL"},"x-reactions":expression(`() => {
                ...
                let className = redFunction(oldData, newData)
                $self.setComponentProps({ class: className })
            }`),title:expression("$t('vendorMod.parentCompanyName')"),"x-component-props":{disabled:expression("$form.readPretty")},"x-validator":{required:!0,message:i18nExpression("请输入母公司名称")}},ceeaParentCompanyLcCode:{type:"string","x-decorator":"FormItem","x-component":"Input","x-visible":"{{$form.query('.companyBaseInfoBefore.ceeaHasParentCompany').take().value == 'Y'}}","x-reactions":expression(`() => {
                ...
                let className = redFunction(oldData, newData)
                $self.setComponentProps({ class: className })
            }`),title:expression("$t('vendorMod.parentCompanyLcCode')"),"x-component-props":{disabled:expression("$form.readPretty")},"x-validator":{required:!0,message:i18nExpression("请输入母公司统一信用代码")}},dunsCode:{type:"string","x-visible":expression("$form.query('.companyTypeAfter.overseasRelation').take().value != 'INSIDE'"),title:"D-U-N-S","x-reactions":expression(`() => {
              ...
              `)},"x-validator":{required:!0,message:i18nExpression("common.requiredField")}},bankName:{type:"string",title:i18nExpression("components.bank.bankName"),"x-render-table-column":{minWidth:120},"x-reactions":expression(`() => {
              ...
              }`)}},authDate:{type:"date",title:i18nExpression("vendorMod.authDate"),"x-render-table-column":{minWidth:210},"x-component-props":{disabled:!0}},authOrg:{type:"string",title:i18nExpression("vendorMod.authOrg"),"x-render-table-column":{minWidth:120},"x-component-props":{disabled:!0}},endDate:{type:"date",title:i18nExpression("vendorMod.certUntil"),"x-render-table-column":{minWidth:210},"x-component-props":{disabled:!0}}})}}},afterChange:{type:"void","x-component":"div","x-component-props":{class:""},properties:{afterChangeTitle:{type:"void","x-component":"changeTitle","x-component-props":{language:"supplierChange.afterChange"}},toolbar:{type:"void","x-component":"ButtonList","x-component-props":{class:"list-form__toolbar"},properties:{add:{type:"void",title:i18nExpression("common.add"),"x-component-props":{type:"primary","@click":expression(`() => {
                ...
                let row = $table.getRowByIndex($self.index)
                row.authNum = row.authNum.replace(/[\\W]/g, '')
              }`)}},authDate:{type:"date",title:i18nExpression("vendorMod.authDate"),"x-render-table-column":{minWidth:220},"x-reactions":expression(`() => {
                ...
                $self.setComponentProps({ class: className })
            }`),"x-component-props":{disabled:expression("$form.readPretty")}},authOrg:{type:"string",title:i18nExpression("vendorMod.authOrg"),"x-render-table-column":{minWidth:120},"x-reactions":expression(`() => {
                const oldData = $form.query('sceneAttachmentInfoBefore').get('value')[$self.index]?.authOrg || null
                let className = redFunction(oldData, $self?.value)
                $self.setComponentProps({ class: className })
            }`),"x-component-props":{disabled:expression("$form.readPretty")}},endDate:{type:"date",title:i18nExpression("vendorMod.certUntil"),"x-render-table-column":{minWidth:220},"x-reactions":expression(`() => {
