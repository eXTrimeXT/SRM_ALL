import{N as NavTabs}from"./index-a035e78f.js";import{al as defineComponent,ar as defineSchemas,ae as expression,ai as generateXindexInOrder,aC as requiredValidatorSegment,aj as editTableFormItemValid,am as usePageHelper,an as useAttrs,br as useDebounceFn,bs as toJS,as as RenderEngine,n as normalizeComponent,bt as changeFieldVisibleByDeps}from"./index-17d0ccd5.js";const _sfc_main$2=defineComponent({__name:"edit",setup(__props){const schema=defineSchemas({TagRuleConfig:{type:"void","x-decorator":"QueryEngine","x-component":"FormContainer","x-query-engine":{service:"sup-ce",actions:{save:{cascadeDeletion:!0,transformRequest:expression(`(data,headers) => {
            data.query['*'] = {}
