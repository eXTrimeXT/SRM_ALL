import{N as NavTabs}from"./index-a035e78f.js";import{al as defineComponent,ar as defineSchemas,ae as expression,af as i18nExpression,ai as generateXindexInOrder,aj as editTableFormItemValid,ag as yearMonthDaySelectorSegment,an as useAttrs,am as usePageHelper,as as RenderEngine,ax as omit,ch as composeFormCollapse,a9 as OrganizationSelector,ad as QuickSearch,n as normalizeComponent,bW as dataTimeSelectorSegment,c5 as yearMonthDayHourMinuteSecondSelectorSegment,bt as changeFieldVisibleByDeps,ci as onActivated,cj as bus}from"./index-17d0ccd5.js";import"./TableView-c2798def.js";/* empty css                                                                   */import"./mixins-f89b147e.js";import"./i-order-detail.vue_vue_type_style_index_0_scoped_e7516933_lang-4ed993c7.js";import{d as deppOmit}from"./util-6482eb24.js";import"./index-92e24989.js";import"./drag-5571e5c7.js";const _sfc_main$2=defineComponent({__name:"edit-engine",setup(__props){const handleSubmit=(type="submit",$values,$queryEngine)=>{if(type==="submit"){for(let i=0;i<$values.perPlanMilestoneId.length;i+=1)if(!$values.perPlanMilestoneId[i].practicallyEndDate){app.__jump_error__("perPlanMilestone","component","请填写里程碑---实际结束时间");return}}let data=deppOmit($values,["lastUpdateDate","creationDate","creationDate","contractCreationDate","currentPlanEndDate"]);return data=omit(data,["perPlanId.contractClass","perPlanId.contractNo","perPlanId.includeTaxAmount","perPlanId.vendorName","perPlanId.buName","perPlanId.currencyName","perPlanId.templateName","perPlanId.perPlanNo","perPlanId.processNum","perPlanMilestoneId.serialNumber","perPlanMilestoneId.milestoneType","perPlanMilestoneId.nodePersonName","perPlanMilestoneId.planStartDate","perPlanMilestoneId.planEndDate","perPlanMilestoneId.remarks","perPlanMilestoneId.fileId","perAcceptanceAttList.fileName","perAcceptanceAttList.createdUserName"]),$queryEngine.request.save({...data,perPlanMilestoneId:data.perPlanMilestoneId&&data.perPlanMilestoneId[0]},{customizeAction:type==="submit"?"vendorSubmit":void 0})},schema=defineSchemas({PerAcceptance:{type:"void","x-component":"FormContainer","x-decorator":"QueryEngine","x-query-engine":{service:"cm",actions:{vendorSubmit:{autoFormatResult:!1,transformRequest:expression(`(data, headers) => {
            data.query['*'] = {}
