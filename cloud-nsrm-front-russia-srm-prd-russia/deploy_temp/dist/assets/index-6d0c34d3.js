import{N as NavTabs}from"./index-a035e78f.js";import"./mixins-f89b147e.js";import{T as TableView}from"./TableView-c2798def.js";/* empty css                                                                   */import{ac as createDictClass,h as http,n as normalizeComponent,H as FormWrapper,bV as lodashExports,al as defineComponent,ar as defineSchemas,ae as expression,ai as generateXindexInOrder,c7 as buttonListItemVisibleByPermission,af as i18nExpression,bM as exportExcelSegment,bX as queryFieldValueExpression,bN as queryFieldStatePropertyExpression,ag as yearMonthDaySelectorSegment,bt as changeFieldVisibleByDeps,am as usePageHelper,ci as onActivated,br as useDebounceFn,c8 as action,as as RenderEngine}from"./index-17d0ccd5.js";import"./index-798c970d.js";import"./enum-d9c76693.js";import"./z-material-table-78984a65.js";import{w as wrapper}from"./axios-cache-plugin-1edad216.js";import"./big-e21bdbb6.js";import{c as contractManagement}from"./index-6a91ec6d.js";import contractInformation from"./edit-engine-8fc2dd97.js";import{t as transformMQL}from"./util-a92f9f8e.js";import{i as inviteHttp}from"./index-937b327d.js";import"./index-a2e65ccc.js";import"./index-2fe75bb8.js";/* empty css                                              */import"./util-6482eb24.js";import"./index-92e24989.js";import"./drag-5571e5c7.js";import"./index-b9c50d13.js";import"./index-531039c3.js";import"./index-374e2d45.js";import"./index-6af40985.js";import"./number-f5ee71d6.js";import"./bundle.cjs-544db961.js";import"./validate-8a9c1e8f.js";import"./uniqueId-bf6f89eb.js";createDictClass({tax:[]});wrapper(http,{ttl:6e4*5});const _sfc_main$2={name:"InviteHistoryDialog",components:{FormWrapper,TableView},props:{visible:{type:Boolean,default:!1},mode:{type:String,default:"collect"}},data(){return{searchFormConfig:[{prop:"projectName",label:"定价单号"},{prop:"buId",label:"公司",type:"OUorganizationSelector"},{prop:"vendorName",label:"供应商",type:"quicksearch",showKey:"companyName",propKey:"companyName",name:"scc_sup_company_info_all"},{prop:"itemCode",label:"物料编码"}],tableData:[],tableHeader:[],queryParam:{},tableViewUrl:inviteHttp.hisListPageUrl,selectedRows:[]}},watch:{visible:{handler(nVal){nVal&&this.getQueryData()},immediate:!0,deep:!0}},created(){this.tableHeader=[{prop:"projectName",label:"定价单号"},{prop:"buName",label:"公司"},{prop:"vendorName",label:"供应商"},{prop:"itemCode",label:"物料编码"},{prop:"itemName",label:"物料名称"},{prop:"noTaxPrice",label:"未税单价"},{prop:"quality",label:"数量"},{prop:"noTaxTotalPrice",label:"未税总价"}]},methods:{getQueryData(params={}){this.queryParam=transformMQL.listPageData({type:"SouInviteHistoryBuyer",action:"query",params}),this.$nextTick(()=>{this.$refs.list.query()})},handleCurrentChange(val){this.selectedRows=val},close(){this.$emit("close")},confirm(){if(!this.selectedRows||!this.selectedRows.length)return this.$message.warning("请勾选列表");if(lodashExports.uniqBy(this.selectedRows,"buName").length>1)return this.$message.warning("同一个公司才可以一起创建");if(lodashExports.uniqBy(this.selectedRows,"vendorName"),lodashExports.uniqBy(this.selectedRows,"vendorName").length>1)return this.$message.warning("同一个供应商才可以一起创建");this.$emit("confirm",this.selectedRows)}}};var _sfc_render$2=function(){var _vm=this,_c=_vm._self._c;return _c("SrmDialog",_vm._g(_vm._b({attrs:{title:"查看邀请历史",size:"large",visible:_vm.visible,"close-on-click-modal":!1,"before-close":_vm.close},on:{"update:visible":function($event){_vm.visible=$event}}},"SrmDialog",_vm.$attrs,!1),_vm.$listeners),[_c("FormWrapper",{attrs:{colLength:3,"form-array":_vm.searchFormConfig},on:{getFormData:_vm.getQueryData}}),_c("TableView",{ref:"list",attrs:{"table-data":_vm.tableData,"table-header":_vm.tableHeader,"pre-query-data":_vm.queryParam,checkbox:!0,checkChange:_vm.handleCurrentChange,"com-active":_vm.$attrs.changeTab,"open-custom-tabl":!1,url:_vm.tableViewUrl,adeptMeiQl:!0}}),_c("div",{staticClass:"dialog-footer",attrs:{slot:"footer"},slot:"footer"},[_c("el-button",{on:{click:_vm.close}},[_vm._v(" 取消 ")]),_c("el-button",{attrs:{type:"primary"},on:{click:_vm.confirm}},[_vm._v(" 确定 ")])],1)],1)},_sfc_staticRenderFns$2=[],__component__$2=normalizeComponent(_sfc_main$2,_sfc_render$2,_sfc_staticRenderFns$2,!1,null,null,null,null);const ContractDetailDialog=__component__$2.exports,_sfc_main$1=defineComponent({__name:"list-engine",setup(__props){const generateAddOneEventExpression=type=>expression(`() => {
  $addOne('${type}', $self.query('ContractHead.table').take().componentProps.componentInstance.getCheckboxRecords())
            ...
            $queryEngine.state.paginationManagement.refresh()
              ...
              }`)}},reponsiblityAdjust:{type:"void",title:"招标负责人调整","x-visible":expression("$buyer()"),"x-component-props":{...buttonListItemVisibleByPermission("cm:contractManager:reponsiblityAdjust"),"@click":expression(`() => {
                let rows = $form.query('ContractHead.table').take().componentProps.componentInstance.getCheckboxRecords()
                console.log('rows',rows)
                if(!rows.length){
                  return $message.warning('请选择合同')
        ...
        $contractManagement.contract
          ...
          .catch((err) => {
            ...
            if(type === 'ok'){
              $self.query('adjustQuery.operatorAdjustDialog.form').take().submit(values => {
                ...
                closeLoading()
                  ...
                  }`)}}})}}}}},responsiblityQuery:{type:"void","x-component":"QueryEngine","x-query-engine":{service:"cm",type:"ContractHead"},properties:{reponsiblityAdjustDialog:{type:"void",title:"招标负责人选择","x-component":"RDialog","x-component-props":{class:"the-adjust-dialog",size:"small","close-on-click-modal":!1,beforeClose:expression(`(done,type,closeLoading) => {
            if(type === 'ok'){
            ...
            }`)},properties:{form:{type:"object","x-decorator":"FormLayout","x-decorator-props":{layout:"vertical"},"x-component":"FormGrid","x-component-props":{maxColumns:2,columnGap:32,rowGap:0},properties:generateXindexInOrder({extContractHandlerName:{type:"string",title:"招标负责人","x-decorator":"FormItem",required:!0,"x-component":"QuickSearchWrapper","x-component-props":{name:"scc_rbac_user_display",showKey:"nickname",propKey:"nickname","@close-quicksearch":expression(`(val) => {
                    console.log('val',val)
