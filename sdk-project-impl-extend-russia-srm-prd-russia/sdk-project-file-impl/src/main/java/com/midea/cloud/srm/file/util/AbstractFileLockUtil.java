...
@Slf4j
public abstract class AbstractFileLockUtil {
    ...
    public String getPublicKey() {
        String publicRedis = businessType() + FileCommon.SECRET_SUFFIX_PUBLIC;
...
//
    ...
    public String getPrivateKey() {
        String privateRedis = businessType() + FileCommon.SECRET_SUFFIX_PRIVATE;
...
//
    ...
    private String generateKey(String valueKey) {
        ...
        String lockKey = businessType + FileCommon.SECRET_SUFFIX_LOCK;
...
//
                ...
                redisUtil.set(businessType + FileCommon.SECRET_SUFFIX_PRIVATE, privateKey, keyTimeout());
                redisUtil.set(businessType + FileCommon.SECRET_SUFFIX_PUBLIC, publicKey, keyTimeout());
...
// 96-1024
        keyPairGen.initialize(keySize, new SecureRandom());// keyPair
