 ...
 * @author huangbf3
 */
public class BusBidOpenStatusServiceImpl implements ProjectStatusService {
    @Override
    public ApiProjectStatusRangeVo<SouBiddingProStatusEnum> currentStatus() {
        ...
        vo.setStatus(SouBiddingProStatusEnum.BUS_BID_OPEN);

        vo.setNextStatus(Arrays.asList(SouBiddingProStatusEnum.CONFIRM_BID));
        return vo;
    }
}
