package com.midea.cloud.srm.sou.expert.plugin.event.applyapprovalsubmit;
...
public class DefaultExtSouExpertApplyApprovalSubmitPlugin implements IExtSouExpertApplyApprovalSubmitPlugin {
    ...
    public ExtSouExpertApplyApprovalSubmitContext judgeApplyApprovalSubmitAuth(ExtSouExpertApplyApprovalSubmitContext context) {
    ...
    @Override
    @ApiOperation("执行处理")
    public ExtSouExpertApplyApprovalSubmitContext executeApplyApprovalSubmit(ExtSouExpertApplyApprovalSubmitContext context) {
