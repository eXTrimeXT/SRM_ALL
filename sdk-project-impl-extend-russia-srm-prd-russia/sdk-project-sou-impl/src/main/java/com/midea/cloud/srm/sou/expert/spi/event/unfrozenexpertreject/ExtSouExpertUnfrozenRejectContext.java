...
@NoArgsConstructor
public class ExtSouExpertUnfrozenRejectContext extends SdkPluginContext {

    @ApiModelProperty("入参: 专家拒绝解冻信息")
    ...
    public ExtSouExpertUnfrozenRejectContext(ExtSouExpertFrozenRejectDTO param) {
        this.param = param;
    }
