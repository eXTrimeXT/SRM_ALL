package com.midea.cloud.srm.sou.expert.plugin.event.changeapprovalsubmit;
...
public class DefaultExtSouExpertChangeApprovalSubmitPlugin implements IExtSouExpertChangeApprovalSubmitPlugin {
    ...
    public ExtSouExpertChangeApprovalSubmitContext judgeChangeApprovalSubmitAuth(ExtSouExpertChangeApprovalSubmitContext context) {
    ...
    @Override
    @ApiOperation("执行处理")
    public ExtSouExpertChangeApprovalSubmitContext executeChangeApprovalSubmit(ExtSouExpertChangeApprovalSubmitContext context) {
