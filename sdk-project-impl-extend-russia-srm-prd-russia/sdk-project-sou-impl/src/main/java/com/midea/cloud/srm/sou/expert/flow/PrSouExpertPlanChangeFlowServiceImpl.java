...
/**
 * 专家库 - 专家变更 - 审批流回调定义
 * PS: 审批流编码  MQL_SOU_EXPERT_APPLY_CHANGE
 *
...
public class PrSouExpertPlanChangeFlowServiceImpl implements IFlowBusinessCallbackService {
    ...
    public String getDataPushFlow(Long businessId, String param) {
        ...
        //数据来源
        mainInfoMap.put("SJLY", expertApply.getApplyFromType());
        //申请编号
        mainInfoMap.put("SQBH", expertApply.getExpertApplyNo());
        //申请人
        mainInfoMap.put("SQR", expertApply.getApplyBy());
        //单据状态
        mainInfoMap.put("DJZT", expertApply.getApplyStatus());
        //工号
        mainInfoMap.put("GH", user.getUsername());
        //姓名
        mainInfoMap.put("XM", user.getNickname());
        //最高学历
        mainInfoMap.put("ZGXL", expertApply.getHighestDegree());
        //毕业时间
        mainInfoMap.put("BYSJ", educationList == null || educationList.size() == 0 ? null : educationList.get(0).getStudyDateTo());
        //性别
        mainInfoMap.put("XB", expertApply.getSex());
        //所属单位
        ...
        //序列等级
        mainInfoMap.put("XLDJ", "");
        //在职状态
        mainInfoMap.put("ZZZT", expertApply.getJobStatus());
        //手机号码
        mainInfoMap.put("SJHM", expertApply.getPhone());
        //入厂时间
        mainInfoMap.put("RCSJ", expertApply.getHireDate());
        //毕业院校
        mainInfoMap.put("BYYX", educationList == null || educationList.size() == 0 ? null : educationList.get(0).getStudyCollege());
        //所学专业
        mainInfoMap.put("SXZY", educationList == null || educationList.size() == 0 ? null : educationList.get(0).getMajor());
        //申报等级
        mainInfoMap.put("SBDJ", expertApply.getApplyLevel());
        //申请说明
        ...
        String processTitle = "专家升级" + "-" + user.getNickname();
