package com.midea.cloud.srm.sou.inq.select.dto;

import com.midea.cloud.srm.model.sou.openapi.sourcing.dto.init.ApiSouVendorAuthEditDTO;
...
public class ApiSiSouStartNewRoundDTO extends BaseObjectX {
