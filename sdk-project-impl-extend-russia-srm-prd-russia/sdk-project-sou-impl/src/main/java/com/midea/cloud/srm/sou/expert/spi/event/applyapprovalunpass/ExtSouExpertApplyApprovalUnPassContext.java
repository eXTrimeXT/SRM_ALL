...
@NoArgsConstructor
public class ExtSouExpertApplyApprovalUnPassContext extends SdkPluginContext {

    /** @see ExtSouExpertApply#getExpertApplyId */
    @ApiModelProperty("专家申请ID")
    private ExtSouExpertApplyUnPassDTO param;

    public ExtSouExpertApplyApprovalUnPassContext(ExtSouExpertApplyUnPassDTO param) {
        this.param = param;
    }
