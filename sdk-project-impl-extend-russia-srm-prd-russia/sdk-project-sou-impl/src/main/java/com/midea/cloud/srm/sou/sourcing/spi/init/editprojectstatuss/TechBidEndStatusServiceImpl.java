 ...
 * @author huangbf3
 */
public class TechBidEndStatusServiceImpl implements ProjectStatusService {
    @Override
    public ApiProjectStatusRangeVo<SouBiddingProStatusEnum> currentStatus() {
        ...
        vo.setStatus(SouBiddingProStatusEnum.TECH_BID_END);


        vo.setNextStatus(Arrays.asList(SouBiddingProStatusEnum.TECH_BID_OPEN));
        return vo;
    }
}
