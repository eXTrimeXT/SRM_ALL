...
@NoArgsConstructor
public class ExtSouExpertChangeApprovalUnPassContext extends SdkPluginContext {

    /** @see ExtSouExpertApply#getExpertApplyId */
    @ApiModelProperty("专家申请ID")
    private ExtSouExpertApplyUnPassDTO param;

    public ExtSouExpertChangeApprovalUnPassContext(ExtSouExpertApplyUnPassDTO param) {
        this.param = param;
    }
