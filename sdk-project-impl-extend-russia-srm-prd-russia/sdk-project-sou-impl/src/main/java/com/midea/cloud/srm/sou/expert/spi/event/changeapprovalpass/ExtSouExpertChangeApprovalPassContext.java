...
@NoArgsConstructor
public class ExtSouExpertChangeApprovalPassContext extends SdkPluginContext {
    ...
    public ExtSouExpertChangeApprovalPassContext(long expertApplyId) {
