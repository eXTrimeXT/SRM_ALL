...
@NoArgsConstructor
public class ExtSouExpertGreenApprovalSubmitContext extends SdkPluginContext {

    /** @see ExtSouExpertApply#getExpertApplyId */
    @ApiModelProperty("专家申请ID")
    private Long expertApplyId;

    public ExtSouExpertGreenApprovalSubmitContext(long expertApplyId) {
