package com.midea.cloud.srm.sou.expert.plugin.event.applyapprovalunpass;
...
public class DefaultExtSouExpertApplyApprovalUnPassPlugin implements IExtSouExpertApplyApprovalUnPassPlugin {
    ...
    public ExtSouExpertApplyApprovalUnPassContext judgeApplyApprovalUnPassAuth(ExtSouExpertApplyApprovalUnPassContext context) {
    ...
    @Override
    @ApiOperation("执行处理")
    public ExtSouExpertApplyApprovalUnPassContext executeApplyApprovalUnPass(ExtSouExpertApplyApprovalUnPassContext context) {
