package com.midea.cloud.srm.sou.expert.plugin.event.applyapprovalpass;
...
public class DefaultExtSouExpertApplyApprovalPassPlugin implements IExtSouExpertApplyApprovalPassPlugin {
    ...
    public ExtSouExpertApplyApprovalPassContext judgeApplyApprovalPassAuth(ExtSouExpertApplyApprovalPassContext context) {
    ...
    @Override
    @ApiOperation("执行处理")
    public ExtSouExpertApplyApprovalPassContext executeApplyApprovalPass(ExtSouExpertApplyApprovalPassContext context) {
        // 1: 更新专家申请状态
