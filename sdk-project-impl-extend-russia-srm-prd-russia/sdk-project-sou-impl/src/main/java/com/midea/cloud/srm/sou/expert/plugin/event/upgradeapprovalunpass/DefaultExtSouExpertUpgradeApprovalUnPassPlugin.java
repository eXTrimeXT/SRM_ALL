package com.midea.cloud.srm.sou.expert.plugin.event.upgradeapprovalunpass;
...
public class DefaultExtSouExpertUpgradeApprovalUnPassPlugin implements IExtSouExpertUpgradeApprovalUnPassPlugin {

    @Autowired
    private QlService qlService;
    @Override
    @ApiOperation("校验操作条件/权限")
    public ExtSouExpertUpgradeApprovalUnPassContext judgeUpgradeApprovalUnPassAuth(ExtSouExpertUpgradeApprovalUnPassContext context) {
    ...
    @Override
    @ApiOperation("执行处理")
    public ExtSouExpertUpgradeApprovalUnPassContext executeUpgradeApprovalUnPass(ExtSouExpertUpgradeApprovalUnPassContext context) {
