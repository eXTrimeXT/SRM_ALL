package com.midea.cloud.srm.sou.expert.plugin.event.upgradeapprovalpass;
...
public class DefaultExtSouExpertUpgradeApprovalPassPlugin implements IExtSouExpertUpgradeApprovalPassPlugin {
    ...
    public ExtSouExpertUpgradeApprovalPassContext judgeUpgradeApprovalPassAuth(ExtSouExpertUpgradeApprovalPassContext context) {
    ...
    @Override
    @ApiOperation("执行处理")
    public ExtSouExpertUpgradeApprovalPassContext executeUpgradeApprovalPass(ExtSouExpertUpgradeApprovalPassContext context) {
        // 1: 更新专家申请状态
