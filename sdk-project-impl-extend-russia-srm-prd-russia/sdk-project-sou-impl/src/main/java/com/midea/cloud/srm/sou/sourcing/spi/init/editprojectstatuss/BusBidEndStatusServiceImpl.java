 ...
 * @author huangbf3
 */
public class BusBidEndStatusServiceImpl implements ProjectStatusService {
    @Override
    public ApiProjectStatusRangeVo<SouBiddingProStatusEnum> currentStatus() {
        ...
        vo.setStatus(SouBiddingProStatusEnum.BUS_BID_END);

        vo.setNextStatus(Arrays.asList(SouBiddingProStatusEnum.TECH_BID_OPEN, SouBiddingProStatusEnum.BUS_BID_OPEN));
        return vo;
    }
}
