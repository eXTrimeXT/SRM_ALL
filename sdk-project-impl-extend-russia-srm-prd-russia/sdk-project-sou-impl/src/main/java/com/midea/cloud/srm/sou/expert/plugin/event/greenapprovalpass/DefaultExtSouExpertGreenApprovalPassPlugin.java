package com.midea.cloud.srm.sou.expert.plugin.event.greenapprovalpass;
...
public class DefaultExtSouExpertGreenApprovalPassPlugin implements IExtSouExpertGreenApprovalPassPlugin {
    ...
    public ExtSouExpertGreenApprovalPassContext judgeGreenApprovalPassAuth(ExtSouExpertGreenApprovalPassContext context) {
    ...
    @Override
    @ApiOperation("执行处理")
    public ExtSouExpertGreenApprovalPassContext executeGreenApprovalPass(ExtSouExpertGreenApprovalPassContext context) {
        // 1: 更新专家申请状态
