package com.midea.cloud.srm.sou.expert.plugin.event.upgradeapprovalsubmit;
...
public class DefaultExtSouExpertUpgradeApprovalSubmitPlugin implements IExtSouExpertUpgradeApprovalSubmitPlugin {
    ...
    public ExtSouExpertUpgradeApprovalSubmitContext judgeUpgradeApprovalSubmitAuth(ExtSouExpertUpgradeApprovalSubmitContext context) {
    ...
    @Override
    @ApiOperation("执行处理")
    public ExtSouExpertUpgradeApprovalSubmitContext executeUpgradeApprovalSubmit(ExtSouExpertUpgradeApprovalSubmitContext context) {
