 ...
 */
@Data
public class ImportExcelJcAgreementLineDto implements Serializable {
    ...
    @ExcelProperty(value = "协议价类型", index = 3)
    private Integer xyjType;

    @ExcelProperty(value = "起订量", index = 4)
    private Integer startNum;

    @ExcelProperty(value = "整倍起售数量", index = 5)
    private Integer multipleStartNum;

    @ExcelProperty(value = "协议未税单价", index = 6)
    private BigDecimal priceTax;

    @ExcelProperty(value = "税率编码", index = 7)
    private String taxRateCode;

    @ExcelProperty(value = "参考价", index = 8)
    private BigDecimal referencePrice;

    @ExcelProperty(value = "交货周期(天)", index = 9)
    private Integer leadTime;

    @ExcelProperty(value = "质保期", index = 10)
    private Integer sellByDate;

    @ExcelProperty(value = "协议行说明", index = 11)
