package com.midea.cloud.srm.model.supcooperate.ext.requirement.pr.division.dto;
...
@ColumnWidth(20)
@HeadRowHeight(-10)
@ApiModel(description = "品类分工规则EXCEL模型")
public class DivisionCategoryModelDTO implements Serializable {
     ...
     * 业务实体编码
     */
    @ExcelProperty(value = "业务实体编码", index = 0)
    @NotEmpty(message = "业务实体编码不能为空")
     ...
     * 负责人用户名
     */
    @ExcelProperty(value = "负责人账号",index =7)
    @NotEmpty(message = "负责人账号不能为空")
