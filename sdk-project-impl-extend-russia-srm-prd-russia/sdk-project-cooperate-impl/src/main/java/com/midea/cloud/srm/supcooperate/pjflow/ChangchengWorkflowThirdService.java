package com.midea.cloud.srm.supcooperate.pjflow;
    ...
    public FlowResponseDTO startThird(FlowCallbackDTO flowCallbackDTO) throws Exception {
        ...
        if(isOpen){
            ...
            if(dictItem!=null&& StringUtils.equals(dictItem.getItemDescription(), YesOrNo.YES.getValue())){
                ...
                resultDTO = pjProjectBidExtClient.startProcessByCategoty(flowCallbackDTO.getBusinessId(),flowCallbackDTO.getBusinessType(),bpmParam);
            }else{
                resultDTO = pjProjectBidExtClient.createProcessByCategory(JSONObject.parseObject(flowCallbackDTO.getFlowParam())
