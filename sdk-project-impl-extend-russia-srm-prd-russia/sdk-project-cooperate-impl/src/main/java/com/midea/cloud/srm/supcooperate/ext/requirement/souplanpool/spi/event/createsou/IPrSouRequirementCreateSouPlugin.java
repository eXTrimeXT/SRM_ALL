 ...
 * @since 2023/10/11
 */
public interface IPrSouRequirementCreateSouPlugin extends ISdkPlugin {
    /**
     * 校验操作条件/权限
     * @param context 参数
     * @return 返回
     ...
     */
    @ApiOperation("前置处理")
    default PrSouRequirementCreateSouContext beforeCreateBidSou(PrSouRequirementCreateSouContext context) { return context; }
    /**
     * 执行处理
     * @param context 参数
     * @return 返回
     */
    @ApiOperation("执行处理")
    default PrSouRequirementCreateSouContext executeCreateBidSou(PrSouRequirementCreateSouContext context) { return context; }
    /**
     * 后置处理
     * @param context 参数
     * @return 返回
     ...
     */
    @ApiOperation("后置处理")
    default PrSouRequirementCreateSouContext afterCreateBidSou(PrSouRequirementCreateSouContext context) { return context; }
    /**
     * 一般情况下，不用重写该方法
     * @return 返回
     */
