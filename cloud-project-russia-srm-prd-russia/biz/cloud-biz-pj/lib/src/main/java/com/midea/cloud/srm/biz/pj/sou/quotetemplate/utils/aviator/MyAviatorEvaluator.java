package com.midea.cloud.srm.biz.pj.sou.quotetemplate.utils.aviator;//package com.midea.cloud.srm.price.preencrypt.utils.aviator;
//
...
//import com.googlecode.aviator.runtime.function.math.*;
...
// * @since 2021/5/30
// */
//public class MyAviatorEvaluator {
//
...
//     */
//    private static int BYTECODE_VER = Opcodes.V1_6;
//
...
//        MyAviatorEvaluator.traceOutputStream = traceOutputStream;
//    }
//
//    static {
...
//    }
//
//    protected final static Map<String, Object> FUNC_MAP = new HashMap<String, Object>();
//
//    static {
...
//            log.info("[Aviator WARN] The function '" + name + "' is already exists, but you replace it.");
//        }
...
//        MyExpressionLexer lexer = new MyExpressionLexer(expression);
//        CodeGenerator codeGenerator = newCodeGenerator(cached);
//        MyExpressionParser parser = new MyExpressionParser(lexer, codeGenerator);
//        return parser.parse();
//    }
//
//
