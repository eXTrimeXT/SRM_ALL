...
@Data
@NoArgsConstructor
public class SouItemRefreshContext {
    ...
    @ApiModelProperty("刷新批次哈")
    protected String newBatchNo;

    private static final ThreadLocal<SouItemRefreshContext> CONTEXT_HOLDER = new ThreadLocal<>();
    public static void setContextHolder(SouItemRefreshContext context) {
        CONTEXT_HOLDER.set(context);
    }
    public static SouItemRefreshContext getContextHolder() {
