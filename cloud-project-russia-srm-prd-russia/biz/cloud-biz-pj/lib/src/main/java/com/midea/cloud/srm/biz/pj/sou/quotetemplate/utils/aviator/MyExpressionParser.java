...
//
//    private final MyExpressionLexer lexer;
//
...
//
//
//    public MyExpressionParser(MyExpressionLexer lexer, CodeGenerator codeGenerator) {
//        super();
//        this.lexer = lexer;
...
//            }
//        }
//        else if (this.lookhead.getType() == Token.TokenType.Number || this.lookhead.getType() == Token.TokenType.String
//                || this.lookhead.getType() == Token.TokenType.Variable || this.lookhead == Variable.TRUE
