...
/**
 * 寻源核心 - 价格维度算分[单项 + 综合评分法]
 *
 * @author zhangwk12@midea.com
 * @since 2022/09/12
 */
@Service
public class DefaultSouCalculateIndividualCompositePriceScoreServiceImpl implements SouCalculateScoreDimensionService, ISouCalculatePriceScoreService {
