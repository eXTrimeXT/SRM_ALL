...
import com.midea.cloud.srm.model.extapi.sou.brg.entity.ExtBrgSouOrderItem;
...
@TableName("scc_sou_brg_order_item")
@ApiModel("项目式询价.供应商投标行信息")
public class BrgSouOrderItem extends ExtBrgSouOrderItem {
