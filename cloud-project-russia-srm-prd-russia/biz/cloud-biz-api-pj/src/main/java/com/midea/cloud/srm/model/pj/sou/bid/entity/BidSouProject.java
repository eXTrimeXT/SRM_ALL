...
import com.midea.cloud.srm.model.extapi.sou.bid.entity.ExtBidSouProject;
...
@TableName("scc_sou_bid_project")
@ApiModel("询价头信息")
public class BidSouProject extends ExtBidSouProject {
