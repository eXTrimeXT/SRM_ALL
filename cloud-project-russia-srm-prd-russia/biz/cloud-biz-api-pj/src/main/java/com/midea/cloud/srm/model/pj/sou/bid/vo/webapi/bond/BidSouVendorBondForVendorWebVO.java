 ...
 */
@Data
public class BidSouVendorBondForVendorWebVO {
    ...
    public static BidSouVendorBondForVendorWebVO convertBidVO(BidSouProject bidProject, @Nullable BidSouVendorBond bond) {
        BidSouVendorBondForVendorWebVO vo = new BidSouVendorBondForVendorWebVO();
