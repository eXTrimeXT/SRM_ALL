...
@Data
@ApiModel("比价信息")
public class InqSouPriceCompareVO {
    /** vendorName */
     ...
     * 便捷方法
     */
    public static InqSouPriceCompareVO convert(List<PriceLibrary> priceLibraryList,
        ...
        if (priceLibraryList.isEmpty()) {
            return new InqSouPriceCompareVO();
        }

        InqSouPriceCompareVO vo = new InqSouPriceCompareVO();
