...
import com.midea.cloud.srm.model.pj.sou.mqlapi.sourcing.vo.tech.MqlSouTechProgressDetailQueryVO;
...
public class MqlSouTechProgressQueryVO extends BaseObjectX {
    ...
    private List<MqlSouTechProgressDetailQueryVO> techProgressList;

    public static MqlSouTechProgressQueryVO convertApiVO(List<SouGroup> groupList,
        ...
        MqlSouTechProgressQueryVO vo = new MqlSouTechProgressQueryVO();
        // 技术评分信息
        ...
        boolean hasReviewed;
        MqlSouTechProgressDetailQueryVO techProgress;
        BigDecimal totalScore;
        for (SouVendor vendor : vendorList) {
            hasReviewed = true;
            techProgress = new MqlSouTechProgressDetailQueryVO();
