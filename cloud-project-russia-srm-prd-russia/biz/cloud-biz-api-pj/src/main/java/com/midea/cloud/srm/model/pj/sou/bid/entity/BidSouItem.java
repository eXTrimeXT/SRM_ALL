...
import com.midea.cloud.srm.model.extapi.sou.bid.entity.ExtBidSouItem;
...
@TableName(value = "scc_sou_bid_item", autoResultMap = true)
public class BidSouItem extends ExtBidSouItem {
