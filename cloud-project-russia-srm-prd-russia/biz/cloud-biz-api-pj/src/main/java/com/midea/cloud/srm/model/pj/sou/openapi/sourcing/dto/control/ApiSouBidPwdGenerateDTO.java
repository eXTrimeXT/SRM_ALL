...
@NoArgsConstructor
@AllArgsConstructor
public class ApiSouBidPwdGenerateDTO extends BaseObjectX {
    ...
    public ApiSouBidPwdGenerateDTO(long projectId, String openBidType) {
        this.projectId = projectId;
        this.openBidTypes = Collections.singleton(openBidType);
    }
