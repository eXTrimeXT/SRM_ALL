...
import com.midea.cloud.srm.model.pj.sou.openapi.inq.vo.select.ApiInqSouTempSelectDetailDataVO;
...
@ApiModel("简易询价的模板报价的比价数据模型－分项维度")
public class ApiInqSouTempSelectDataVO extends BaseObjectX {
    ...
    private List<ApiInqSouTempSelectDetailDataVO> souTempSelectDetailDataVOList;
