...
import com.midea.cloud.srm.model.extapi.sou.bid.entity.ExtBidSouBaseMaterialPrice;
...
@TableName("scc_sou_bid_base_mt_price")
@ApiModel("招投标.缓存基材价格")
public class BidSouBaseMaterialPrice extends ExtBidSouBaseMaterialPrice {

    @ApiModelProperty("ID")
    @TableId("BID_BASE_MATERIAL_PRICE_ID")
    private Long bidBaseMaterialPriceId;
