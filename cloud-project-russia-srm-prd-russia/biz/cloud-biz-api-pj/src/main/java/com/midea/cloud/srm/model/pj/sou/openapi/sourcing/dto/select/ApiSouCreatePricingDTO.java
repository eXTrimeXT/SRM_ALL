...
public class ApiSouCreatePricingDTO extends BaseObjectX {

    /** 定价头 */
    private ApprovalHeader approvalHeader;
    /** 中标行 */
    private List<ApiSouCreatePricingItemDTO> approvalBiddingItemList;
    /** 定价附件 */
     ...
     */
    public static ApiSouCreatePricingDTO convertApiVO(SouProject souProject,
        ...
        ApiSouCreatePricingDTO pricingDTO = new ApiSouCreatePricingDTO();
    ...
    private static List<ApiSouCreatePricingItemDTO> convertItems(ApprovalHeader approvalHeader,
                                                                 SouProject souProject,
                                                                 Map<Long/* souItemId */, SouItem> souItemMap,
                                                                 Map<Long/* vendorId */, SouVendor> vendorMap,
                                                                 Map<String/* currencyCode */, SouCurrency> currencyMap,
                                                                 List<SouOrderItem> souOrderItemList) {
        List<ApiSouCreatePricingItemDTO> approvalItemList = new ArrayList<>(souOrderItemList.size());

        for (SouOrderItem souOrderItem : souOrderItemList) {
            ApiSouCreatePricingItemDTO approvalItem = new ApiSouCreatePricingItemDTO();
            ...
            // 是否阶梯报价
            approvalItem.setIsLadder(souItem.getIsLadder().name());
            // 阶梯价类型
