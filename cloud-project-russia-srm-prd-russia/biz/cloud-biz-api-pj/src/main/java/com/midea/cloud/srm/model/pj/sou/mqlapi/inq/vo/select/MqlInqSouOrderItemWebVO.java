...
public class MqlInqSouOrderItemWebVO extends MqlInqSouOrderItemVO {
    ...
    public static List<MqlInqSouOrderItemWebVO> convertInqVO(List<MqlSouOrderItemVO> voList) {
        if (voList.isEmpty()) { return Collections.emptyList(); }
        List<MqlInqSouOrderItemWebVO> inqVOList; {
            ...
            voList.forEach(vo -> inqVOList.add(SouObjectXUtil.convertTargetObj(vo, MqlInqSouOrderItemWebVO.class)));
        }
        return inqVOList;
    }
    ...
    public static List<EssentialFactorVO> convertFormulaInfo(
        ...
        /* json反序列化 */
        Map<Long, String> userPriceMap;/* factorId price */
