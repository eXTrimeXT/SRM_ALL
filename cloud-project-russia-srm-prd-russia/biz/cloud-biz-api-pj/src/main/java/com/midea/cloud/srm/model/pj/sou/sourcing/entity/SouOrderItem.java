...
import com.midea.cloud.srm.model.pj.sou.sourcing.enums.SouOrderItemPriceApprovalStatusEnum;
...
public class SouOrderItem extends BaseEntity<SouOrderItem> {
    ...
    // ---------------------------------------------- 转价格审批单状态(用于明细单独转的情况) ---------------------------------------
    /** @see SouOrderItemPriceApprovalStatusEnum */
    //@TableField("PRICE_APPROVAL_STATUS")
    //@ApiModelProperty("转价格审批单状态")
