 ...
 */
@Data
public class BrgSouOrderPriceCompareWebVO {
     ...
     * 便捷方法
     */
    public static BrgSouOrderPriceCompareWebVO convert(List<PriceLibrary> priceLibraryList,
        ...
        if (priceLibraryList.isEmpty()) {
            return new BrgSouOrderPriceCompareWebVO();
        }

        BrgSouOrderPriceCompareWebVO vo = new BrgSouOrderPriceCompareWebVO();
