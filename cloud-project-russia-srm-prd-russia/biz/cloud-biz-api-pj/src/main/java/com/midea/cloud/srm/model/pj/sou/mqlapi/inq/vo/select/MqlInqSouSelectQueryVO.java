...
public class MqlInqSouSelectQueryVO extends MqlSouSelectQueryVO {
    ...
    public static List<MqlInqSouSelectQueryVO> convertInqVO(List<MqlSouSelectQueryVO> selectList) {
        if (selectList.isEmpty()) { return Collections.emptyList(); }
        List<MqlInqSouSelectQueryVO> voList; {
        ...
        selectList.forEach(select -> voList.add(SouObjectXUtil.convertTargetObj(select, MqlInqSouSelectQueryVO.class)));
        return voList;
    }
