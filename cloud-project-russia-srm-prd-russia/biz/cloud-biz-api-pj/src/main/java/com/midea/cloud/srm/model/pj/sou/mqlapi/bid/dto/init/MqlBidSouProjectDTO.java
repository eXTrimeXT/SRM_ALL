...
import com.midea.cloud.srm.model.pj.sou.mqlapi.bid.dto.init.MqlBidSouCurrencyDTO;
import com.midea.cloud.srm.model.pj.sou.mqlapi.bid.dto.init.MqlBidSouItemDTO;
import com.midea.cloud.srm.model.pj.sou.mqlapi.bid.dto.init.MqlBidSouProjectEditDTO;
...
public class MqlBidSouProjectDTO extends MqlBidSouProjectEditDTO {
    ...
    private List<MqlBidSouCurrencyDTO> currencyList;

    @ApiModelProperty("物料需求")
    private List<MqlBidSouItemDTO> itemList;
