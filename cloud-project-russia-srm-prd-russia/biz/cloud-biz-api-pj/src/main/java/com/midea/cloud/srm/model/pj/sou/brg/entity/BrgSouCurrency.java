...
import com.midea.cloud.srm.model.extapi.sou.brg.entity.ExtBrgSouCurrency;
...
@TableName("scc_sou_brg_currency")
@ApiModel(description = "寻源-项目式询价可用币种")
public class BrgSouCurrency extends ExtBrgSouCurrency {
