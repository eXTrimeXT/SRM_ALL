 ...
 */
@Data
public class BidSouOrderPriceCompareWebVO {
    /** vendorName */
     ...
     * 便捷方法
     */
    public static BidSouOrderPriceCompareWebVO convert(List<PriceLibrary> priceLibraryList,
        ...
        if (priceLibraryList.isEmpty()) {
            return new BidSouOrderPriceCompareWebVO();
        }

        BidSouOrderPriceCompareWebVO vo = new BidSouOrderPriceCompareWebVO();
