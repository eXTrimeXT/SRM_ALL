...
import com.midea.cloud.srm.model.pj.sou.mqlapi.inq.dto.init.MqlInqSouCurrencyDTO;
import com.midea.cloud.srm.model.pj.sou.mqlapi.inq.dto.init.MqlInqSouItemDTO;
import com.midea.cloud.srm.model.pj.sou.mqlapi.inq.dto.init.MqlInqSouProjectEditDTO;
...
public class MqlInqSouProjectDTO extends MqlInqSouProjectEditDTO {
    ...
    private List<MqlInqSouCurrencyDTO> currencyList;

    @ApiModelProperty("物料需求")
    private List<MqlInqSouItemDTO> itemList;
