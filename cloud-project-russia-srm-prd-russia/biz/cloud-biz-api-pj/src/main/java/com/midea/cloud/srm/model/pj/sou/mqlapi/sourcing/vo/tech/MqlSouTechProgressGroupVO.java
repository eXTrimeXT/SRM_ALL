...
public class MqlSouTechProgressGroupVO extends BaseObjectX {
    ...
    public static List<MqlSouTechProgressGroupVO> convertApiVO(List<SouGroup> groupList, List<SouTechScoreHead> techScoreHeadList) {
        if (groupList.isEmpty()) {
            return Collections.emptyList();
        }

        List<MqlSouTechProgressGroupVO> voList = new ArrayList<>(groupList.size());
        ...
        MqlSouTechProgressGroupVO vo;
        SouTechScoreHead techScoreHead;
        for (SouGroup group : groupList) {
            vo = new MqlSouTechProgressGroupVO();
            voList.add(vo);
