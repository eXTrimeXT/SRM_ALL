...
import com.midea.cloud.srm.model.extapi.sou.bid.entity.ExtBidSouCurrency;
...
@TableName("scc_sou_bid_currency")
@ApiModel(description = "寻源-招投标可用币种")
public class BidSouCurrency extends ExtBidSouCurrency {
