...
import com.midea.cloud.srm.model.extapi.sou.brg.entity.ExtBrgSouBaseMaterialPrice;
...
@TableName("scc_sou_brg_base_mt_price")
@ApiModel("项目式询价.缓存基材价格")
public class BrgSouBaseMaterialPrice extends ExtBrgSouBaseMaterialPrice {

    @ApiModelProperty("ID")
    @TableId("BRG_BASE_MATERIAL_PRICE_ID")
    private Long brgBaseMaterialPriceId;
