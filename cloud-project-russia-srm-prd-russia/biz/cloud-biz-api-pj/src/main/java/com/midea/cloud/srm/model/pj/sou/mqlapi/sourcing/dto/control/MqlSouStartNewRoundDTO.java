...
public class MqlSouStartNewRoundDTO extends BaseObjectX {
    ...
    protected List<MqlSouVendorDTO> newVendors;
    ...
    public void formatParams() {
        ...
        if (newVendors != null) {
            for (MqlSouVendorDTO vendor : newVendors) {
                if (vendor.getVendorId() == null) {
                    throw new IllegalArgumentException("缺少vendorId信息");
                }
                if (vendor.getAuthList() != null) {
                    for (SouVendorAuth auth : vendor.getAuthList()) {
