...
import com.midea.cloud.srm.model.pj.sou.openapi.bid.dto.init.ApiBidSouProjectInfoDTO;
import com.midea.cloud.srm.model.pj.sou.openapi.bid.dto.init.ApiBidSouRequireInfoDTO;
...
public class ApiBidSouInitDTO extends BaseObjectX {
    ...
    private ApiBidSouProjectInfoDTO projectInfo;
    @ApiModelProperty("项目需求")
    private ApiBidSouRequireInfoDTO requireInfo;
