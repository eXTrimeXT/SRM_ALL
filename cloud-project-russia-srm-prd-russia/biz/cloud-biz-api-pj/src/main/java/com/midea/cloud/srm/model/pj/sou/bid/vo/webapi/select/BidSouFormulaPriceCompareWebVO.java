 ...
 */
@Data
public class BidSouFormulaPriceCompareWebVO {
     ...
     */
    public static BidSouFormulaPriceCompareWebVO convert(Integer searchRound,
        ...
        BidSouFormulaPriceCompareWebVO vo = new BidSouFormulaPriceCompareWebVO();
        // 轮次
    ...
    private static void extracted(List<ApiBidSouItemVO> itemList, Map<Long, List<PricingFormulaLine>> formulaLineMap, BidSouFormulaPriceCompareWebVO vo) {
        // 物料价格公式明细
        vo.setOrderItemFormulaMap(new HashMap<>(itemList.size() << 3));
        for (ApiBidSouItemVO item : itemList) {
