...
import com.midea.cloud.srm.model.pj.sou.openapi.brg.dto.init.ApiBrgSouProjectInfoDTO;
import com.midea.cloud.srm.model.pj.sou.openapi.brg.dto.init.ApiBrgSouRequireInfoDTO;
...
public class ApiBrgSouInitDTO extends BaseObjectX {
    ...
    private ApiBrgSouProjectInfoDTO projectInfo;
    @ApiModelProperty("项目需求")
    private ApiBrgSouRequireInfoDTO requireInfo;
