...
@Data
@ApiModel("比价信息")
public class MqlInqSouPriceCompareVO {
/**    vendorName */
    @ApiModelProperty("节点信息")
    private Map<String, List<InqSouPriceCompareNode>> priceNodes;

    @Data
    @ApiModel("比价节点信息")
    private static class InqSouPriceCompareNode {
     ...
     * 便捷方法
     */
    public static MqlInqSouPriceCompareVO convert(List<PriceLibrary> priceLibraryList,
        ...
        if (priceLibraryList.isEmpty()) {
            return new MqlInqSouPriceCompareVO();
        }

        MqlInqSouPriceCompareVO vo = new MqlInqSouPriceCompareVO();
        ...
        if (!priceLibraryMap.isEmpty()) {
            ...
            priceLibraryMap.forEach((vendorName, plList) -> {
                plList.forEach(pl -> {
                    InqSouPriceCompareNode node = new InqSouPriceCompareNode();
                    BigDecimal rate;
