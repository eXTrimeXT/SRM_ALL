...
public class ApiBidSouOrderDTO extends ApiSouOrderEditDTO {

    @ApiModelProperty("报价明细")
    protected List<ApiBidSouOrderItemDTO> orderItemList;
    @ApiModelProperty("供应商报价附件")
    protected List<ApiSouOrderFileDTO> orderFileList;
    @ApiModelProperty("用于生成报价单号-参考SequenceCodeConstant")
    protected String orderNoGenerateCode = "SEQ_SOU_BID_ORDER_NO";
