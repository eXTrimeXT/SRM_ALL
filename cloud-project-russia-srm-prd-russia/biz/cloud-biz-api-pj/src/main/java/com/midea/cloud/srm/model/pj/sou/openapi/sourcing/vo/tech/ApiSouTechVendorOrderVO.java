...
public class ApiSouTechVendorOrderVO extends SouVendor {

    @ApiModelProperty("公司信息")
    private CompanyInfo companyInfo;

    @ApiModelProperty("技术标附件")
    private List<ApiSouOrderFileVO> techFileList;

    public static ApiSouTechVendorOrderVO convertApiVO(SouVendor vendor,
                                                       CompanyInfo companyInfo,
                                                       List<SouFileConfig> techFileConfigList,
                                                       List<SouOrderFile> orderFileList) {
        ApiSouTechVendorOrderVO vo = new ApiSouTechVendorOrderVO();
        ...
        vo.setTechFileList(new ArrayList<>(techFileConfigList.size())); {
            ...
            for (SouFileConfig fileConfig : techFileConfigList) {
                ApiSouOrderFileVO fileVO = new ApiSouOrderFileVO();
