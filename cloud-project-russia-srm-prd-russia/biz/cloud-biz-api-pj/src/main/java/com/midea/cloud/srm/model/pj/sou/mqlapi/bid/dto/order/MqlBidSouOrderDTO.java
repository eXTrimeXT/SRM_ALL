...
import com.midea.cloud.srm.model.pj.sou.mqlapi.bid.dto.order.MqlBidSouOrderItemDTO;
...
public class MqlBidSouOrderDTO extends SouOrder {

    @ApiModelProperty("物料需求")
    private List<MqlBidSouOrderItemDTO> orderItemList;
