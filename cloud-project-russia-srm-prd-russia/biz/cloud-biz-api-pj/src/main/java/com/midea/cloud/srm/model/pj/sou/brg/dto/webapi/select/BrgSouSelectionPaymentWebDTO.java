 ...
 */
@Data
public class BrgSouSelectionPaymentWebDTO {

    /** @see BrgSouOrderItemPayment#getProjectId */
    @ApiModelProperty("寻源单ID")
    private Long projectId;

    /** @see BrgSouOrderItemPayment#getOrderItemId */
    ...
    public void formatParams() {
        ...
        for (BrgSouOrderItemPayment payment : paymentList) {
            index++;
            // ID(置空)
