...
import com.midea.cloud.srm.model.pj.sou.openapi.comp.vo.select.ApiCompSouOrderItemReportVO;
...
public class ApiCompSouOrderReportVO extends BaseObjectX {

    @ApiModelProperty("物料需求维度信息(以及中标供应商对该物料的最终报价)")
    private List<ApiCompSouOrderItemReportVO> souItemInfos;
