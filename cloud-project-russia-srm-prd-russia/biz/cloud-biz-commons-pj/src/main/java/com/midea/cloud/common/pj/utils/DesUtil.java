...
public class DesUtil {
    ...
    private final static String DEFAULT_KEY = "hN/xQHkXJTg1QO844/Mur1nbuUKzhIDzQqI1imVJR98=";
    ...
    public static String encrypt(String data, String key) throws Exception {
        String realKey = StringUtils.isNotBlank(key) ? key : DEFAULT_KEY;
        byte[] bt = encrypt(data.getBytes(ENCODE), realKey.getBytes(ENCODE));
        String strs = new BASE64Encoder().encode(bt);
        return strs;
    }
