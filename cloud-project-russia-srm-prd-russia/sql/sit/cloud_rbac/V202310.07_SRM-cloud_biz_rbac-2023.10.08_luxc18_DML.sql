...
WHERE PERMISSION_ID IN (443517830733824);
...
values  (443517830733824, -1, 6946547548487680, '二开-查询信息变更列表', 'INTERFACE', 'InfoChange#queryInfoChangePage-6946547548487680', 'InfoChange#queryInfoChangePage', null, null, null, null, null, null, null, null, null, 8123195817787648, 'super', '2023-10-08 09:18:26', '10.254.103.115', '超级管理员', null, null, '2023-10-08 09:18:26', '10.254.103.115', '超级管理员', null, 0);