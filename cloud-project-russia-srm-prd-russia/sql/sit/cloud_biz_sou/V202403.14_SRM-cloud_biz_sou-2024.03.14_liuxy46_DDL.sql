CREATE TABLE IF NOT EXISTS `scc_sou_tech_score_file` (
    `TECH_SCORE_FILE_ID` bigint(20) NOT NULL COMMENT '技术标评审附件表id',
    `TECH_SCORE_HEAD_ID` bigint(20) DEFAULT NULL COMMENT '技术标评审ID',
    ...
    PRIMARY KEY (`TECH_SCORE_FILE_ID`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='技术标评审附件';