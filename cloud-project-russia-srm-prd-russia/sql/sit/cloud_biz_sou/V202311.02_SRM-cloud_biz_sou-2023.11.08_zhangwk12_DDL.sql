create table scc_npm_sou_inq_vendor (
    SOU_VENDOR_ID           bigint(20)       not null primary key,
    PROJECT_ID              bigint(20)       not null comment '寻源单ID',
...
) comment '长城询比价邀请供应商拓展表';

create table scc_npm_sou_inq_vendor_del (
    ...
    LINKMAN_NAME            varchar(80)      null comment '联系人',
