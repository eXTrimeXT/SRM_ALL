<template>
  ...
  >
    <!--展示表单，提供插槽-->
    <slot name="formRow">
      <div v-if="showInfo" class="ladder-price-form-row">
        <!--物料编码-->
        <div class="form-col">
      ...
      <div class="form-col">
        ...
        <span class="value">
          <el-radio
            ...
            label="standard"
            :disabled="readonly || pageFlag.isQuote"
          >
    ...
    <p v-if="!readonly && !pageFlag.isQuote">
      <el-button
        type="primary"
        @click="addRow"
      >
    ...
    >
      ...
      <!--报价-->
      <template v-if="pageFlag.isQuote">
        <!--未税单价-->
        <el-table-column
          align="right"
          prop="price"
