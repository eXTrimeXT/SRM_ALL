...
export default {
  ...
  methods: {
    ...
    handleExceed (files, fileList) {
      ...
      this.$message.warning(this.$t('oneStopShopping.prompt', { limit: this.limit, num: files.length, total: (files.length + fileList.length) }))
    },
    watchImgList (data) {
