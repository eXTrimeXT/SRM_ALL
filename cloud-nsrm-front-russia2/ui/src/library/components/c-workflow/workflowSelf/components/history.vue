<template>
  <div>
    <el-steps :active="curStatus" :align-center="true" finish-status="success">
      <el-step :title="$t('vendorMod.finishCompanyInfo')" :description="$t('cusEntry.library.longDescription')" />
      <el-step :title="$t('common.successSubmit')" :description="$t('cusEntry.library.longDescription')" />
      <el-step :title="$t('vendorMod.approvalSuccess')" :description="$t('cusEntry.library.longDescription')" />
    </el-steps>
    <vxe-table
