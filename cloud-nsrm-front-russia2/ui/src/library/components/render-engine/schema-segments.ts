...
export const russiaLanguage = 'ru_RU' // 俄罗斯特殊的时间格式
/**
 ...
 */
export const editTableFormItemValidFunction = (message: string): Record<any, any> => {
  return {
    ...feedbackLayoutIsPopover,
    'x-validator': {
      required: true,
...
export const yearMonthDayStartSelectorSegment = {
  ...
  'x-component-props': {
    ...
    format: (localStorage.getItem('cloudDateFormat') ? localStorage.getItem('cloudDateFormat') : 'yyyy-MM-dd') + `  [${localStorage.getItem('cloudTimeZoneFormat')}]`,
...
export const yearMonthDayEndSelectorSegment = {
  ...
  'x-component-props': {
    placeholder: i18nExpression('common.pleaseSelectDate'),
    format: localStorage.getItem('cloudDateFormat') + `  [${localStorage.getItem('cloudTimeZoneFormat')}]`,
    'value-format': 'yyyy-MM-dd',
    '@change': expression(`(date) => {
...
export const yearMonthDaySelectorSegment = {
  ...
  'x-component-props': {
    placeholder: i18nExpression('common.pleaseSelectDate'),
    format: localStorage.getItem('cloudDateFormat') + `  [${localStorage.getItem('cloudTimeZoneFormat')}]`,
    // format: Vue.prototype.$formatDatePicker,
    'value-format': 'yyyy-MM-dd'
  }
}
...
export const yearMonthDayHourMinuteSecondSelectorSegment = {
  ...
  'x-component-props': {
    ...
    type: 'datetime',
    format: localStorage.getItem('cloudDateTimeFormat') + `  [${localStorage.getItem('cloudTimeZoneFormat')}]`,
