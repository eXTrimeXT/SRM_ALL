            ...
            properties: {
              inactive: {
                ...
                'x-component-props': {
                  popconfirm: {
                    // '确定要失效此物料信息？'
                    title: i18nExpression('cusEntry.supplement20250211.confirmInvalidateMaterialInfo')
                  },
...
const $editTab = (type:string, row:Object) => {
  ...
  if (type === 'add') {
    // '货源清单'
    name = i18nExpression('vendorMod.supplyList')
    // '新增货源清单'
    title = i18nExpression('vendorMod.newSourcelList')
  ...
  // '货源清单'
    name = i18nExpression('vendorMod.supplyList') + row.catalogId
    // '货源清单'
    title = i18nExpression('vendorMod.supplyList') + row.catalogId
  }
  let tab = {
