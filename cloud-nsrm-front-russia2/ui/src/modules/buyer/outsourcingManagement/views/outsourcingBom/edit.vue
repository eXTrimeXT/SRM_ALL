    ...
    data () {
      return {
        ...
        statuss: [
          {
            value: 'Y',
            label: this.$t('common.yes')  // '是'
          },
          {
            value: 'N',
            label: this.$t('common.no')  // '否'
          }
        ],
        BomLineColumns: [
          {
        ...
        rules: {
          materialCode: [{ required: true, message: this.$t('vendorMod.required') }],  // '必填'
          materialName: [{ required: true, message: this.$t('vendorMod.required') }],  // '必填'
          orgName: [{ required: true, message: this.$t('vendorMod.required') }],  // '必填'
          orgCode: [{ required: true, message: this.$t('vendorMod.required') }],  // '必填'
          orgId: [{ required: true, message: this.$t('vendorMod.required') }],  // '必填'
          organizationName: [{ required: true, message: this.$t('vendorMod.required') }],  // '必填'
          organizationCode: [{ required: true, message: this.$t('vendorMod.required') }],  // '必填'
          organizationId: [{ required: true, message: this.$t('vendorMod.required') }],  // '必填'
          status: [{ required: true, message: this.$t('vendorMod.required') }]  // '必填'
        },
        readOnly: false
      }
    },
