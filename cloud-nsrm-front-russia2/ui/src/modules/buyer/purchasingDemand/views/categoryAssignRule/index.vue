...
export default {
  ...
  data () {
    return {
      ...
      iModal: {
        ...
        extraData: {},
        upLoadUrl: '/api-sup-ce/division/divisionCategory/importExcelNew'
      },
      reviewFormNumber: '',
      gridData: [],
      pageSize: 15,
      ...
      preArr: [
        ...
        {
          prop: 'duty',
          label: () => this.$t('purchaseDemand.duty'),
          type: 'dict',
          code: 'DUTY'
        }, // 职责
        {
          prop: 'personInChargeNickname',
          label: () => this.$t('purchaseDemand.personInChargeNickname')
        }, // 负责人名称
        {
          prop: 'ifMainPerson',
  ...
  methods: {
    ...
    downloadTemplate () {
      // 下载模板
      downloadFileLink(
        '/api-sup-ce/division/divisionCategory/importModelDownload',
    ...
    deleteOne (row) {
      this.$confirm(this.$t('common.confirmDelete'), {
        ...
        .then(() => {
          this.$http({
            url:
              '/api-sup-ce/division/divisionCategory/deleteDivisionCategory',
            method: 'GET',
            params: { divisionCategoryId: row.divisionCategoryId },
            loading: true
          })
            .then(data => {
