...
export default {
  ...
  created () {
    ...
    this.tableHeader = [
      ...
      {
        prop: 'processNum',
        label: this.$t('contract_mod.processNum'),  // '里程碑模板编号'
        width: 150
      },
      {
        prop: 'templateName',
        label: this.$t('contract_mod.templateName'),  // '里程碑模板名称'
        width: 150
      },
      {
        prop: 'status',
      ...
      },
      {
        ...
        label: this.$t('contract_mod.contractTaxAmount'),  // '合同含税金额'
        width: 130
      },
      {
      ...
      },
      {
        ...
        label: this.$t('contract_mod.currentMilestoneNode'),  // '当前里程碑节点'
        width: 130,
        dataType: 'dict',
      ...
      },
      {
        ...
        label: this.$t('contract_mod.nodePerson'),  // '节点责任人'
        width: 120
      },
      {
        prop: 'currentPlanEndDate',
        label: this.$t('contract_mod.milestonePlanEndDate'),  // '里程碑计划结束日期'
        width: 150,
        dataType: 'dateTime'
      },
      {
