...
<!-- 里程碑节点附件信息 -->
  <srm-dialog
    v-if="visible"
    :title="$t('cusEntry.supplement20250211.milestoneNodeAttachmentInfo')"
  ...
  >
    <el-table :data="tableData" border stripe>
      ...
      <el-table-column prop="creationDate" :label="$t('common.creationTime')" :formatter="(row, column, cellValue) => $parseTime(cellValue)" />
    </el-table>
  </srm-dialog>
</template>
<script>
