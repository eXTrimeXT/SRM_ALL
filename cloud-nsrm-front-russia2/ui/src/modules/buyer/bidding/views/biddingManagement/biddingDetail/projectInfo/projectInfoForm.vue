<template>
  <SrmRow>
    ...
    <SrmCol :init-col="3">
      <!--预计投标开始时间-->
      <el-form-item :label="$t('bidMod.planOrderStartTime')" prop="orderStartTime">
        <el-date-picker
    ...
    <SrmCol :init-col="3">
      <!--投标截止时间-->
      <el-form-item :label="$t('bidMod.bidingEndDatetime2')" prop="orderEndTime">
        <el-date-picker
    ...
    <SrmCol :init-col="3">
      <!--预计招标地点-->
      <el-form-item :label="$t('bidMod.planOrderSite')" prop="orderSite">
