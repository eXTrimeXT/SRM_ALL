...
export default {
  ...
  methods: {
    ...
    async queryParamsChangeHandler () {
      ...
      let setData = {}
      if (window.location.host === 'sccdemosyy.meicloud.com' || window.location.host === 'localhost:7899') {
          // 此处为本地demo不需要国际化
            setData = {
              'activeNum': 62,
              'addNum': 22,
              'category': {
                  ...
                  'legend': [this.$t('cusEntry.supplement20250211.quantityLessThanOrEqualToTwo'), 
                            this.$t('cusEntry.supplement20250211.quantityRange2To5'), 
                            this.$t('cusEntry.supplement20250211.quantityRange5To10'), 
                            this.$t('cusEntry.supplement20250211.quantityGreaterThanTen')],
                  'lineSeriesData': [],
                  'seriesData': [{
                    // '数量(X<=2)'
                      'name': this.$t('cusEntry.supplement20250211.quantityLessThanOrEqualToTwo'),
                      'value': 9
                  }, {
                    // '数量(2<X<=5)'
                      'name': this.$t('cusEntry.supplement20250211.quantityRange2To5'),
                      'value': 5
                  }, {
                    // '数量(5<X<=10)'
                      'name': this.$t('cusEntry.supplement20250211.quantityRange5To10'),
                      'value': 7
                  }, {
                    // '数量(X>10)'
                      'name': this.$t('cusEntry.supplement20250211.quantityGreaterThanTen'),
                      'value': 4
                  }],
                  'xAxisData': []
              },
