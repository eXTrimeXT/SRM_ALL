      ...
      >
        ...
        >
          <OrionWorkflowTab
            ...
            :show-toolbar="(!readonly || pageFlag === 'approve') && allParams.header.extProjectStatus === 'DRAFT'"
            @workflow-success="workflowSuccess"
            @afterProcessActionSuccess="workflowSuccess"
          />
        </el-tab-pane>
      </el-tabs>
