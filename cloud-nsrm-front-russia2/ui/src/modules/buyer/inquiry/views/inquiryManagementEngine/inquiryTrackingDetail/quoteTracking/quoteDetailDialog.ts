      ...
      quoteTableList: {
        ...
        properties: generateXindexInOrder({
          ...
          requireQuantity: {
            type: 'string',
            'x-render-table-column': {
              title: i18nExpression('bidMod.requireQuantity'),  //'预计采购量'
              minWidth: 100
            }
          },
          // 行类型
          ...
          standardNotaxTotalPrice: {
            type: 'string',
            'x-render-table-column': {
              title: i18nExpression('contractMod.totalAmountNoTax2'),   // '未税总金额'
              minWidth: 100
            }
          },
          // 含税单价
          ...
          ladderType: {
            ...
            'x-render-table-column': {
              title: i18nExpression('bidMod.ladderType'),  // '阶梯价类型'
              minWidth: 100
            },
          ...
          isLadder: {
            type: 'string',
            title: i18nExpression('bidMod.viewLadderDetail'),  // '查看阶梯价明细'
            // 普通式报价才显示
            'x-visible': generateCharExpressionByFunction(({ $values }) => {
              return $values.header?.orderType === 'SIMPLE'
            }),
            'x-render-table-column': {
              title: i18nExpression('cusEntry.supplement20250211.staircasePriceDetails'),  // '阶梯价明细'
              minWidth: 125
            },
            'x-component': 'RButton',
            'x-component-props': {
          ...
          isFormula: {
            type: 'void',
            title: i18nExpression('bidMod.viewFormulaDetail'),  // '查看公式报价明细'
            // 公式报价才显示 
            'x-visible': generateCharExpressionByFunction(({ $values }) => {
