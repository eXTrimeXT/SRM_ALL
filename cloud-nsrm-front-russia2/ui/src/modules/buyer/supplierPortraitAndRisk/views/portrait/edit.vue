          ...
          <srm-row :gutter="32" style="margin-bottom:20px">
            <srm-col>
              <div class="grid-content bg-purple">
                ...
                <span style="color:#000000">{{ $parseTime(title.companyCreationDate) }}</span>
              </div>
            </srm-col>
            <srm-col>
              <div class="grid-content bg-purple">
              ...
              <table class="my-table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $parseTime(R3_ObjData.registerInfo.establishmentDate) }}</td>
                    <td class="grey">
                      {{ $t("vendorMod.dateIssue") }}
                    </td>
                    <td>{{ $parseTime(R3_ObjData.registerInfo.issueDate) }}</td>
                    <td class="grey">
          ...
          <srm-row>
            ...
            >
              <el-table border stripe :data="assessData" max-height="345px">
                ...
                <el-table-column prop="assessmentDate" :formatter="(row, column, cellValue) => $parseTime(cellValue)" :label="$t('perfMod.assessmentDate2')" />
                <el-table-column prop="respFullName" :formatter="(row, column, cellValue) => $parseTime(cellValue)" :label="$t('perfMod.respFullName')" />
                <el-table-column
