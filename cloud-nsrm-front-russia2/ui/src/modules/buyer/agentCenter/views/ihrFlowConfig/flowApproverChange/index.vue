...
export default {
  ...
  methods: {
    ...
    loadIframeProduct () {
      ...
      var url = host + '/oasis/#/oasis/ihr/flow/approver_change?token=' + token + '&localeKey=' + localeKey + '&entranceType=' + entranceType
      this.iframeUrl = url
    }
  }
}
