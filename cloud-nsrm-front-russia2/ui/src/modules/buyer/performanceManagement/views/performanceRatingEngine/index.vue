    ...
    "properties": {
      "dialog": {
        ...
        "x-component-props": {
          ...
          // "确认"
          "okText": i18nExpression('components.common.confirm'),
          // "取消"
          "cancelText": i18nExpression('components.common.cancel'),
          "size": "middle",
          "modal": true,
          ...
          "form": {
            ...
            "properties": {
              "levelName": {
                "type": "string",
                // "等级名称"
                "title": i18nExpression('perfMod.levelName'),
              ...
              "organizationName": {
                "type": "string",
                // "采购组织"
                "title": i18nExpression('cusEntry.supplement20250121.purchaseOrg'),
                "x-decorator": "FormItem",
              ...
              "scoreStart": {
                "type": "string",
                // "综合绩效得分>"
                "title": i18nExpression('cusEntry.supplement20250211.scoreOfComprehensivePerformance'),
                "x-decorator": "FormItem",
                ...
                "x-component-props": {
                  ...
                  "controls": true,
                  // "请输入"
                  "placeholder": i18nExpression('common.pleaseInput'),
                  "style": {
                    "opacity": 1
                  }
                },
              ...
              "scoreEnd": {
                "type": "string",
                // "综合绩效得分<="
                "title": i18nExpression('cusEntry.supplement20250211.integratedPerformanceScore'),
                "x-decorator": "FormItem",
                "x-component": "InputNumber",
                "x-component-props": {
                  "controls-position": "right",
              ...
              "status": {
                // "等级状态"
                "title": i18nExpression('perfMod.status'),
                "x-decorator": "FormItem",
                "x-component": "Select",
                "name": "status",
                "type": "string",
              ...
              "levelDescription": {
                "type": "string",
                // "等级说明"
                "title": i18nExpression('perfMod.levelDescription'),
                "x-decorator": "FormItem",
      ...
      "k3lng0gdkej": {
        ...
        "properties": {
          ...
          "scoreStart": {
            "type": "string",
            // "综合绩效得分"
            "title": i18nExpression('bidMod.performanceScore'),
            "x-decorator": "FormItem",
            "x-decorator-props": {
              "labelWidth": 80,
              "style": {
        ...
        "properties": {
          "add": {
            ...
            "x-component-props": {
              "type": "primary",
              // "新增"
              text: i18nExpression('common.add'),
              "size": "small",
              "plain": false,
              "round": false,
              "circle": false,
              ...
              "operation": {
                ...
                "properties": {
                  ...
                  "enable": {
                    ...
                    "x-component-props": {
                      "type": "text",
                      "text": i18nExpression('common.view'), // "查看"
                      "size": "small",
                      "plain": false,
                      "round": false,
                      "circle": false,
                  ...
                  "disable": {
                    "type": "void",
                    "title": i18nExpression('common.disable'),  // "禁用"
                    "x-component": "Button",
                    "x-component-props": {
                      "type": "text",
                      "size": "small",
