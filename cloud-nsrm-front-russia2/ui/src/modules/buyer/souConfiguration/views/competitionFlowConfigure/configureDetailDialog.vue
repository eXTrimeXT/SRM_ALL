...
<!-- 竞价流程配置 -->
  <SrmDialog
    :title="$t('route.competitionFlowConfigure')"
    size="large"
  ...
  >
    ...
    >
      <SrmRow>
        ...
        <SrmCol :init-col="4">
          <!-- 模板名称 -->
          <el-form-item :label="$t('dataConfMod.templateName')" prop="processConfigName">
        ...
        <SrmCol :init-col="4">
          <!-- 竞价范围 -->
          <el-form-item label="$t('bidMod.scopeBidding')" prop="publishScope">
            <DictSelect
      ...
      <SrmRow>
        ...
        <SrmCol :init-col="1">
          <!-- 模板简述 -->
          <el-form-item :label="$t('bidMod.tempDesc')" prop="remark">
            <el-input
