...
export default {
  ...
  data () {
    return {
      ...
      filterConfig: [
        { prop: 'organizationId', label: this.$t('cusEntry.supplement20250205.purchaseOrgId') },  // '采购组织ID'
        {
          prop: 'orderStatus',
          label: this.$t('orderMod.buyerOrderSynergy.orderStatus'),  // '订单状态'
          type: 'slot',
  ...
  methods: {
    ...
    viewHandle (row) {
      ...
      const tab = {
        ...
        title: this.$t('cusEntry.supplement20250211.orderHeaderDemoTabOrderNumberView'),  // '订单头demo-tab订单号查看'
    ...
    addHandle (row) {
      ...
      const tab = {
        ...
        title: this.$t('cusEntry.supplement20250211.orderHeaderDemoTabAdd'),  // '订单头demo-tab新增'
        name: 'demoorderEdit'
      }
      this.$emit('tab-add', tab)
    },
    ...
    editHandle (row) {
      ...
      const tab = {
        ...
        title: this.$t('cusEntry.supplement20250211.orderHeaderDemoTabEdit'),  // '订单头demo-tab编辑'
        name: 'demoorderEdit' + row.demoOrderId
      }
      this.$emit('tab-add', tab)
    },
