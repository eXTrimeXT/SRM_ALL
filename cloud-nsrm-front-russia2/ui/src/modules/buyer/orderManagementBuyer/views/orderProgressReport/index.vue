...
export default {
  ...
  created () {
    this.queryForm = [
      ...
      {
        prop: 'statementStartTime',
        label: this.$t('purchaseDemand.requestDateFrom'),  // '需求日期从'
        type: 'date'
      },
      {
        prop: 'statementEndTime',
        label: this.$t('purchaseDemand.requestDateTo'),  // '需求日期至'
        type: 'date'
      },
      { prop: 'orderType',
          ...
          'list': [
            {
              ...
              'cfsaReceivedFactoryName': this.$t('cusEntry.supplement20250211.heiLongJiangProvinceQingGangChangLinMeatFoodFactory'),  // '黑龙江省青冈长林肉类食品有限公司工厂'
              'cfsaRequirementLineNum': 10,
              'cfsaTotalAmountTax': 280,
              'createdBy': this.$t('cusEntry.supplement20250211.systemAdmin'),  // '系统管理员'
              'createdByIp': '127.0.0.1',
              'createdFullName': this.$t('cusEntry.supplement20250211.systemAdmin'),  // '系统管理员'
              'createdId': -1,
              ...
              'divisionName': this.$t('cusEntry.supplement20250211.foodDivision'),  // '食品事业部'
              ...
              'itemDesc': this.$t('cusEntry.supplement20250211.glove'),  // '手套'
              ...
              'orderType': 'Z001',
              'orderTypeName': this.$t('cusEntry.supplement20250211.standardOrder'),  //'标准订单'
              'orgCode': '2060',
              'pageNum': null,
              'pageSize': null,
              ...
              'tenantId': null,
              'termOfPayment': 'Z001',
              'termOfPaymentName': this.$t('cusEntry.supplement20250211.currentStock'),  // '现款现货'
              'unitCode': 'A23',
              'unitName': this.$t('cusEntry.supplement20250211.doubleNotice'),  // '双'
              'unitPriceContainingTax': 0.8,
              'userId': null,
              'vendorCode': 'S0007490',
              'vendorId': 534355879579648,
              'vendorName': this.$t('cusEntry.supplement20250211.qingGangXianQingGangZhenLianYingShengZiShangCheng'),  // '青冈县青冈镇联营生资商场'
              'version': null,
              'warehouseReceiptAmount': 80,
              'warehouseReceiptCreatedBy': this.$t('cusEntry.supplement20250211.systemAdmin'),  // '系统管理员'
            ...
            },
            {
              ...
              'categoryName': this.$t('cusEntry.supplement20250211.freshHoofedAnimals'),  // '鲜头蹄类'
              'cfsaInvocieDate': null,
              'cfsaReceivedFactoryCode': '2380',
              'cfsaReceivedFactoryId': 505211268710400,
              'cfsaReceivedFactoryName': this.$t('cusEntry.supplement20250211.sichuanGuChuanZangYouShiGuFoodTechFactory'),  // '四川古川藏优食谷食品科技有限公司工厂'
              ...
              'itemDesc': this.$t('cusEntry.supplement20250211.freshToughShortPigFeet'),  // '鲜带筋短猪脚'
              ...
              'tenantId': null,
              'termOfPayment': 'Z002',
              'termOfPaymentName': this.$t('cusEntry.supplement20250211.threeDayAccountPeriod'),  // '3天账期'
              'unitCode': 'KG',
              'unitName': 'KG',
              ...
              'vendorName': this.$t('cusEntry.supplement20250211.mianyangSiHuiXunYangTradeCoLtd'),  // '绵阳市四汇勋洋贸易有限公司'
              'version': null,
              'warehouseReceiptAmount': 19000,
              'warehouseReceiptCreatedBy': this.$t('cusEntry.supplement20250211.systemAdmin'),  // '系统管理员''系统管理员'
            ...
            },
            {
              ...
              'categoryName': this.$t('cusEntry.supplement20250211.pigCategory'),  // '猪类'
              'cfsaInvocieDate': null,
              'cfsaReceivedFactoryCode': '2370',
              'cfsaReceivedFactoryId': 505211268694016,
              'cfsaReceivedFactoryName': this.$t('cusEntry.supplement20250211.heiLongJiangDaoTaiFuFoodFactory'),  // '黑龙江道台府食品有限公司工厂'
              'cfsaRequirementLineNum': 1,
              'cfsaTotalAmountTax': null,
              'createdBy': this.$t('cusEntry.supplement20250211.systemAdmin'),  // '系统管理员'
              'createdByIp': '127.0.0.1',
              ...
              'itemDesc': this.$t('cusEntry.supplement20250211.spineSkin'),  // '脊皮'
              ...
              'tenantId': null,
              'termOfPayment': 'Z005',
              'termOfPaymentName':this.$t('cusEntry.supplement20250211.daysThirtyAccountPeriod'),  //  '30天账期'
              'unitCode': 'KG',
              'unitName': 'KG',
              ...
              'vendorName': this.$t('cusEntry.supplement20250211.variableNameharbinPafeiteTradeCoLtd'),  // '哈尔滨帕沸特商贸有限公司'
              'version': null,
            ...
            },
            {
              ...
              'categoryName': this.$t('cusEntry.supplement20250211.sausageCategory'),  // '香肠类'
              'cfsaInvocieDate': null,
              'cfsaReceivedFactoryCode': '2380',
              'cfsaReceivedFactoryId': 505211268710400,
              'cfsaReceivedFactoryName': this.$t('cusEntry.supplement20250211.sichuanGuChuanZangYouShiGuFoodTechFactory'),  // '四川古川藏优食谷食品科技有限公司工厂'
              ...
              'itemDesc': this.$t('cusEntry.supplement20250211.spicySausage100g2Pack'),  // '麻辣小香肠100G*2'
              ...
              'vendorName': this.$t('cusEntry.supplement20250211.sichuanYangDayeFoodTechCoLtd'),  // '四川杨大爷食品科技有限公司'
              'version': null,
            ...
            },
            {
              ...
              'categoryName': this.$t('cusEntry.supplement20250211.freezeFatOil'),  //'冻油脂类'
              'cfsaInvocieDate': null,
              'cfsaReceivedFactoryCode': '2060',
              'cfsaReceivedFactoryId': 505211268259840,
              'cfsaReceivedFactoryName': this.$t('cusEntry.supplement20250211.heiLongJiangProvinceQingGangChangLinMeatFoodFactory'),   // '黑龙江省青冈长林肉类食品有限公司工厂'
              ...
              'itemDesc': this.$t('cusEntry.supplement20250211.hangingBoardOil1x25'),  // '吊挂板油1*25'
            ...
            },
            {
              ...
              'cfsaReceivedFactoryName': this.$t('cusEntry.supplement20250211.mianyangChanglinFoodSlaughterFactory'),  // '绵阳长林食品股份有限公司屠宰工厂'
              'cfsaRequirementLineNum': 10,
              ...
              'vendorName': this.$t('cusEntry.supplement20250211.chengduRongshenPackagingDesignCoLtd'),  // '成都市荣申包装设计有限责任公司'
              'version': null,
            ...
            },
            {
              ...
              'itemDesc': this.$t('cusEntry.supplement20250211.pigHandRaw'),  // '猪手(生)'
            ...
            },
            {
              ...
              'categoryName': this.$t('cusEntry.supplement20250211.canLid'),  // '罐盖'
              'cfsaInvocieDate': '2021-02-03 00:00:00',
              'cfsaReceivedFactoryCode': '2120',
              'cfsaReceivedFactoryId': 505211268370432,
              'cfsaReceivedFactoryName': this.$t('cusEntry.supplement20250211.puTianShiPuGuanFoodIndustrialCoLtdFactory'), // '莆田市莆罐食品工业有限公司工厂'
              'cfsaRequirementLineNum': 10,
              ...
              'itemDesc': this.$t('cusEntry.supplement20250211.normalLid315XifulingFish'),  // '315#普通盖(喜福临鱼)'
              ...
              'tenantId': null,
              'termOfPayment': 'Z007',
              'termOfPaymentName': this.$t('cusEntry.supplement20250211.sixtyDayPaymentTerm'),  // '60天账期'
              'unitCode': 'EA',
              'unitName': this.$t('cusEntry.supplement20250211.groupNotice'),  // '个'
              'unitPriceContainingTax': 0.25,
              'userId': null,
              'vendorCode': 'S0007339',
              'vendorId': 534355482472448,
              'vendorName': this.$t('cusEntry.supplement20250211.jiangxiXianhePackagingCoLtd'),  // '福建贤和包装有限公司'
              'version': null,
