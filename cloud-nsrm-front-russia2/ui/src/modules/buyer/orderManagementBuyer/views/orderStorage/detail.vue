              ...
              <template v-if="flag != 'add'" type="flex">
                ...
                <srm-col>
                  <el-form-item :label="$t('common.creationTime')" prop="creationDate">
                    <el-date-picker v-model="form.creationDate" :format="$formatDatePickerTime" disabled type="date" />
                  </el-form-item>
                </srm-col>
                <srm-col>
                  <el-form-item
                ...
                <srm-col>
                  <el-form-item :label="$t('dataConfMod.lastUpdateDate')" prop="lastUpdateDate">
                    <el-date-picker v-model="form.lastUpdateDate" :format="$formatDatePickerTime" disabled type="date" />
                  </el-form-item>
                </srm-col>
              </template>
              <srm-col :initCol="1">
  ...
  data () {
    return {
      ...
      form: {
        ...
        organizationName: '',
        receiveAddress: null,
        warehouseDate: parseTime(new Date(), '{y}-{m}-{d}', true),
        comments: '',
