  ...
  return [
    {
      attrs: {
        prop: 'lineNum',
        label: _ => _this.$t('orderMod.deliveryLineNum'), // 送货通知行号
        align: 'center',
        minWidth: '120',
    ...
    },
    {
      attrs: {
        ...
        label: _ => _this.$t('orderMod.surplusDeliveryQuantity'), // 剩余可通知数量
        align: 'center',
        minWidth: '150',
        showOverflowTooltip: true
      },
      headerSlot: 'remainingDeliveryNoticeQuantityHeader'
    },
    {
      attrs: {
        prop: 'noticeSum',
      ...
      rules: { required: true, validator: _this.noticeNumValidate },
      slot: 'noticeSum'
    },
    {
      attrs: {
        prop: 'deliveryNoticeQuantity',
        label: _ => _this.$t('orderMod.buyerOrderSynergy.noticeSum'), // 累计通知数量
        align: 'center',
        minWidth: '120',
        showOverflowTooltip: true
      }
    ...
    },
    {
      attrs: {
        prop: 'receiveDate',
        label: _ => _this.$t('contractMod.deliveryDate1'), // 到货日期
        align: 'center',
        minWidth: '150',
        showOverflowTooltip: true
      },
      slot: 'receiveDate',
      rules: { required: true, message: _this.$t('orderMod.receiveContract') }
    },
    {
      attrs: {
