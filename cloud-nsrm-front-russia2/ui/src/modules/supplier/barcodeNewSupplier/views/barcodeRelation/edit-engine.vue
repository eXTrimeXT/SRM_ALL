...
// @ts-ignore
import { formGridSegment, requiredValidatorSegment, yearMonthDaySelectorSegment } from 'lib@/components/render-engine/schema-segments'
// @ts-ignore
...
const bindSubmit = ($form: any, $queryEngine: any, $bus: any) => {
  ...
  if (!selects.length) {
    return app.$message.warning(t('cusEntry.supplement20250211.message2')) // 请选择内箱条码
  }
...
const searchInnerBox = useDebounceFn(($form: any, $queryEngine: any) => {
  if (!$form.values.outerBoxId) {
    return app.$message.warning(t('cusEntry.supplement20250211.message3')) // 请先选择外箱条码
  }
  ...
  TagInnerBox: {
    ...
    items: {
      ...
      properties: {
        ...
        bindSubmit: {
          type: 'void',
          'x-content': i18nExpression('orderMod.bindCommit'),
          'x-component': 'Button',
          'x-component-props': {
            type: 'primary',
            '@click': expression(`() => {
      ...
      collapse: {
        ...
        properties: generateXindexInOrder({
          ...
          bindForm: {
            ...
            'x-component-props': {
              title: i18nExpression('cusEntry.supplement20250211.bindableOuterBoxBarcode')
            },
                ...
                properties: {
                  ...
                  relationMaterialQuantity: {
                    ...
                    'x-decorator-props': {
                      ...
                      tooltip: i18nExpression('cusEntry.supplement20250211.relationMaterialQuantityTip')
                    },
                    'x-component-props': {
                      disabled: true
                    }
                  ...
                  leftMaterialQuantity: {
                    ...
                    'x-decorator-props': {
                      ...
                      tooltip: i18nExpression('cusEntry.supplement20250211.leftMaterialQuantityTip')
                    },
                    'x-component-props': {
                      disabled: true
                    }
                  ...
                  boundInnerBoxQuantity: {
                    type: 'string',
                    'x-decorator': 'FormItem',
                    title: i18nExpression('cusEntry.supplement20250211.boundInnerBoxQuantity'),
                    'x-decorator-props': {
                      // 1个外箱已绑定的内箱数量
                      tooltip: i18nExpression('buyerDeliveryOrder.prompt17')
                    },
                    'x-component-props': {
                      disabled: true
                    }
                    ...
                    properties: generateXindexInOrder({
                      ...
                      relationMaterialQuantity: {
                        ...
                        'x-render-table-column': {
                          ...
                          description: i18nExpression('buyerDeliveryOrder.prompt21')
                        }
                      },
                      // 生成内箱条码数量
                      tagNo: {
