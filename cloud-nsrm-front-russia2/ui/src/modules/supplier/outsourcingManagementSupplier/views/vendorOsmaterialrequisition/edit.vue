      ...
      <div class="form-container">
        ...
        >
          <el-row :gutter="32">
            ...
            <el-col :span="6">
              <!-- <el-form-item prop="lastUpdatedBy" :label="$t('common.updatePeople')">
                   <el-input v-model="form.lastUpdatedBy" :disabled="disabled"/>
        </el-form-item> -->
              <!-- 委外领料单处理状态 -->
              <el-form-item
                prop="handleStatus"
                :label="$t('cusEntry.supplement20250211.handleStatus')"
              >
            ...
            <el-col :span="6">
              ...
              <el-form-item
                ...
                :label="$t('cusEntry.supplement20250211.buyerOutsourcingDate')"
              >
                <el-date-picker
            ...
            <el-col :span="24">
              ...
              <el-form-item
                ...
                :label="$t('cusEntry.supplement20250211.buyerReceiveAddressContact')"
              >
                <el-input
            ...
            <el-col :span="24">
              ...
              <el-form-item
                ...
                :label="$t('cusEntry.supplement20250211.buyerSpecialRemarks')"
              >
                <el-input
        ...
        >
          ...
          >
            ...
            <el-table-column
              ...
              :label="$t('cusEntry.supplement20250211.notReceivedQuantity')"
              min-width="120"
              align="center"
            />
            <!-- 供应商编码 -->
            ...
            <el-table-column
              ...
              :label="$t('cusEntry.supplement20250211.sumOutsourcingQuantity')"
              min-width="120"
              align="center"
            />
            <!-- 库存地点 -->
            ...
            <el-table-column
              ...
              :label="$t('cusEntry.supplement20250211.storageQuantity')"
              min-width="180"
              align="center"
            >
              <template slot-scope="scope">
            ...
            <el-table-column
              ...
              :label="$t('cusEntry.supplement20250211.vendorRequireQuantity')"
              min-width="180"
              align="center"
            >
              <template slot-scope="scope">
            ...
            <el-table-column
              ...
              :label="$t('cusEntry.supplement20250211.buyerOutsourcingQuantity')"
              min-width="180"
              align="center"
            />
            <!-- 供应商签收数量 -->
            ...
            <el-table-column
              ...
              :label="$t('cusEntry.supplement20250211.vendorConfirmDate')"
              min-width="180"
              align="center"
            ...
            <el-table-column
              prop="buyerRemark"
              :label="$t('cusEntry.supplement20250211.materialRowNote')"
              min-width="120"
              align="center"
            />
          </el-table>
          <div style="padding: 10px 0;">
            <div>{{ $t('outsource.vendorDiffDescription') }}</div>
            <el-input
          ...
          <div style="padding: 10px 0;">
            <div>{{ $t('outsource.buyerAdditionalRemarks') }}</div>
            <el-input
  ...
  data () {
    return {
      ...
      tableHeader: [
        ...
        {
          prop: 'sumOutsourcingQuantity',
          label: this.$t('cusEntry.supplement20250211.sumOutsourcingQuantity')
        }
      ],
      filterConfig: [
        {
        ...
        { prop: 'requirementHeadNum', label: this.$t('orderMod.requirementHeadNum') },
        ...
        // 采购订单创建人
        { prop: 'orderCreatedBy', label: this.$t('cusEntry.supplement20250211.orderCreatedBy') },
  ...
  methods: {
    ...
    confirm () {
      ...
      if (this.currentRows.length == 0) {
        // 委外领料单明细不能为空
        this.$message({ type: 'error', message: this.$t('cusEntry.supplement20250211.message19') })
        return false
      }
