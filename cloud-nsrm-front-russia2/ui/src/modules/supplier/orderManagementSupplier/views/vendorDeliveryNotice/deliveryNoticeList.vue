  ...
  >
    <el-main>
      ...
      <TableView
        ...
        customTableKey="vendorDeliveryNoticeList"
      />
    </el-main>
  </el-container>
</template>
...
export default {
  ...
  data () {
    return {
      tableUrl: '/api-sup-ce/sup/deliveryNotice/listPageDeliveryNoticeByParam',
      dictCodes: {
          ...
          buttons: [
            {
              ...
              code: 'sup:vendorDeliveryNotice:edit',
              show: row => ['WAITING_VENDOR_CONFIRM'].includes(row.status)
            }
          ]
        }
      ],
