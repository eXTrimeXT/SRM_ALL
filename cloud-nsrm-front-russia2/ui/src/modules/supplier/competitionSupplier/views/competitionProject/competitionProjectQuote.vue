    ...
    <el-main class="competition-project-quote-wrap">
      <div class="competition-project-quote">
        ...
        <div class="evaluate-method-wrap">
          <srmRow>
            <srmCol :init-col="3">
              <span>{{ $t('bidMod.scoreRule') }}</span>{{ $getDictLabel('SOU_SCORE_RULE_TYPE', orderInfo.scoreRuleType) }}
            </srmCol>
          </srmRow>
        </div>

        <div
          v-if="orderInfo.projectStatus === SOU_PROJECT_STATUS_ENUM.ACCEPT_ORDER"
        ...
        >
          ...
          <el-table-column
            ...
            :label="$t('competition.orderNotaxPriceLastTime')"
            width="100"
            show-overflow-tooltip
          />
          ...
          <el-table-column
            ...
            width="100"
            show-overflow-tooltip
            :formatter="(row, colum, value) => $parseTime(value)"
          />
