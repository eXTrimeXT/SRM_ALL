    ...
    <el-collapse v-model="activeDims">
      ...
      <el-collapse-item :title="$t('bidMod.projectInformation')" name="1">
        <SrmRow>
          ...
          <!--竞价标题-->
          <SrmCol :init-col="3">
            <el-form-item :label="$t('bidMod.competitionLts.souName')">
          ...
          <!--评分规则-->
          <SrmCol :init-col="3">
            <el-form-item :label="$t('bidMod.evaluateMethod')">
      ...
      <!--竞价规则-->
      <el-collapse-item :title="$t('bidMod.competitionLts.competitionRules')" name="2">
        <SrmRow>
          <!--竞价规则-->
          <SrmCol :init-col="3">
            <el-form-item :label="$t('bidMod.competitionLts.competitionRules')" prop="auctRule">
          ...
          <SrmCol v-if="baseInfoData.auctRule === 'NO_ALLOW_SAME_PRICE'" :init-col="3">
            <el-form-item :label="$t('competition.noAllowSamePriceCount')" prop="noAllowSamePriceCount">
          ...
          <!--涨降幅百分比(%)-->
          <SrmCol :init-col="3">
            <el-form-item :label="$t('bidMod.competitionLts.floating')">
          ...
          <!--涨降金额-->
          <SrmCol :init-col="3">
            <el-form-item :label="$t('bidMod.competitionLts.floatingAmount')">
          ...
          <template v-if="baseInfoData.allowExtendTime === 'Y'">
            <!--延时竞价触发点(分钟)-->
            <SrmCol :init-col="3">
              <el-form-item :label="$t('bidMod.competitionLts.delayTriggerPoint1')" prop="extendTrigger">
            ...
            <!--延时分钟数-->
            <SrmCol :init-col="3">
              <el-form-item :label="$t('bidMod.competitionLts.delayMinutes1')" prop="extendMinute">
            ...
            <!--延时竞价最多可报次数-->
            <SrmCol :init-col="3">
              <el-form-item :label="$t('bidMod.competitionLts.delayedTimes')" prop="extendMaxOrderCount">
                <el-input v-model="baseInfoData.extendMaxOrderCount" />
              </el-form-item>
            </SrmCol>
            <!--延时触发的最大次数-->
            <SrmCol :init-col="3">
              <el-form-item :label="$t('competition.extendTriggerCount')" prop="extendTriggerCount">
                <el-input v-model="baseInfoData.extendTriggerCount" />
              </el-form-item>
            </SrmCol>
            <!--首次延时触发后最长延时时间限制 -->
            <SrmCol :init-col="3">
              <el-form-item :label="$t('competition.extendMaxMinute')" prop="extendMaxMinute">
      ...
      <el-collapse-item :title="$t('vendorMod.vendorContactInfor')" name="3">
        <SrmRow>
          ...
          <SrmCol :init-col="3">
            <!--手机号码-->
            <el-form-item :label="$t('vendorMod.mobilePhone')" prop="tel">
              <el-input
