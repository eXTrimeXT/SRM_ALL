  ...
  if (type === 'submit') {
    for (let i = 0; i < $values.perPlanMilestoneId.length; i += 1) {
      if (!$values.perPlanMilestoneId[i].practicallyEndDate) {
        // 请填写里程碑---实际结束时间
        app.__jump_error__('perPlanMilestone', 'component', $t('cusEntry.supplement20250205.milestoneActualEndTime'))
        return
      }
    }
  }
              ...
              layout: {
                ...
                properties: {
                  ...
                  status: {
                    type: 'string',
                    'x-decorator': 'FormItem',
                    title: i18nExpression('components.stratProcess.headers.docStatusValue'),
                    'x-component': 'DictSelect',
                    'x-component-props': {
                  ...
                  'perPlanId.includeTaxAmount': {
                    type: 'string',
                    'x-decorator': 'FormItem',
                    title: i18nExpression('purSettlementMod.includeTaxAmount'),
                    'x-query-engine-skip': true,
                    'x-component-props': {
                      'disabled': true
                    }
            ...
            properties: {
              perPlanMilestoneId: {
                ...
                properties: generateXindexInOrder({
                  ...
                  nodePersonName: {
                    type: 'string',
                    title: i18nExpression('common.nodeLeader'),
                    'x-query-engine-skip': true,
                    'x-render-table-column': {
                      minWidth: 130
                    }
                  ...
                  planEndDate: {
                    ...
                    'x-query-engine-skip': true,
                    title: i18nExpression('perfMod.planEndDate'),
                    'x-render-table-column': {
                      minWidth: 130
                    }
                  },
                  ...
                  nodePlanNum: {
                    ...
                    `),
                    'x-render-table-column': {
                      title: i18nExpression('perfMod.numberOfNodesDelivered'),
                      minWidth: 130
                    },
                    ...editTableFormItemValid
                  },
                  ...
                  practicallyEndDate: {
                    ...
                    `),
                    'x-render-table-column': {
                      title: i18nExpression('perfMod.actualEndTime'),
                      minWidth: 130
                    },
                    ...editTableFormItemValid
                  },
                  ...
                  remarks: {
                    type: 'string',
                    title: i18nExpression('perfMod.specialRemarks'),
                    'x-query-engine-skip': true,
                    'x-render-table-column': {
                      minWidth: 130
                    }
                    ...
                    properties: {
                      layout: {
                        ...
                        properties: {
                          edit: {
                            type: 'void',
                            title: i18nExpression('components.common.delete'),
...
const { app, t: $t, emitTabRemove } = usePageHelper()
