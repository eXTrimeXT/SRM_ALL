  ...
  <el-container class="flex-container" direction="vertical">
    <el-main>
      <el-collapse v-model="colValue">
        <el-collapse-item :title="$t('common.baseInfo')" name="1">
          <el-form ref="form" :model="form">
            <srm-row>
              ...
              <srm-col>
                <el-form-item :label="$t('contract_mod.templateName')" prop="templateName">
              ...
              <srm-col>
                <el-form-item :label="$t('contract_mod.perOrderNo')" prop="perPlanNo">
                  <el-input v-model="form.perPlanNo" disabled />
                </el-form-item>
              </srm-col>
              <srm-col>
                <el-form-item :label="$t('components.stratProcess.headers.docStatusValue')" prop="status">
                  <dict-select v-model="form.status" disabled code="CONTRACT_PLAN_STATUS" />
                </el-form-item>
              </srm-col>
              <srm-col>
                <el-form-item :label="$t('purSettlementMod.includeTaxAmount')" prop="includeTaxAmount">
                  <el-input v-model="form.includeTaxAmount" disabled />
                </el-form-item>
              </srm-col>
              <srm-col>
                <el-form-item :label="$t('vendorMod.currencyCode')" prop="currencyName">
              ...
              <srm-col>
                <el-form-item :label="$t('common.creationTime')" prop="creationDate">
                  <el-date-picker v-model="form.creationDate" :format="$formatDatePickerTime" disabled />
                </el-form-item>
              </srm-col>
            </srm-row>
          </el-form>
        ...
        <el-collapse-item :title="$t('bid_mod.milestoneType')" name="3">
          <IPerformPlan
            ref="perform"
        ...
        <el-collapse-item :title="$t('route.buyerPaymentPlan')" name="4">
    ...
    async saveBill (type) {
      ...
      if (type === 'SAVE') {
        ...
        if (totalPercent.toString() !== '100') {
          this.__jump_error__('payform', 'component', this.$t('cusEntry.supplement20250211.message11')) // 计划开票比例之后必须是100
          return
        }
