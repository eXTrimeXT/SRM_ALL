  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          prop: 'paymentRatio',
          label: this.$t('cusEntry.supplement20250211.paymentRatio'),
          width: 150,
          renderHeader: this._addStarToColumn,
          render: (h, scope) => {
            if (this.readPretty == true) {
        ...
        },
        {
          ...
          render: (h, scope) => {
            if (this.readPretty == true) {
              return this.$parseTime(scope.row.planInvoiceCompleteDate)
            } else {
              return (
                <el-date-picker
        ...
        // 付款节点
        { prop: 'paymentNode', label: this.$t('cusEntry.supplement20250205.paymentNode') },
        { prop: 'paymentApplyNo', label: this.$t('contractMod.paymentApplyNumber') },
        {
          prop: 'operation',
          ...
          render: (h, scope) => {
            ...
            let btn =
              <el-button type="text" disabled={this.disabled} onClick={() => this.$emit('delete', scope)}>
                { this.$t('components.common.delete') }
              </el-button>
            if (text) {
              return (
                <div>
