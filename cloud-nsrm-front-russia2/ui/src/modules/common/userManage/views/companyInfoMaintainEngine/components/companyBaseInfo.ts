      ...
      layout: {
        ...
        properties: {
          ...
          ceeaListedTime: {
            ...
            'x-validator': {
              required: true,
              message: i18nExpression('common.marketTime') // 请选择上市时间
            }
          },
          // 上市交易所
          listedExchange: {
            ...
            'x-validator': {
              required: true,
              message: i18nExpression('common.listingExchange') // 请选择上市交易所
            }
          },
          // 商业模式
          'ceeaBusinessModel': {
          ...
          companyProvince: {
            ...
            'x-component-props': {
              ...
              placeholder:  expression(`$t('common.pleaseSelect')`),
              disabled: expression(`$form.query('state').get('data').$disabled || $form.values.companyCountry!='CN'`)
            },
          },
          // 城市
          companyCity: {
          ...
          'ceeaParentCompanyName': {
            ...
            'x-validator': {
              required: true,
              message: i18nExpression('vendorMod.msgPCompany') // 请输入母公司名称
            }
          },
          // 母公司统一信用代码
          'ceeaParentCompanyLcCode': {
            ...
            'x-validator': {
              required: true,
              message: i18nExpression('cusEntry.supplement20250211.parentCompanyCreditCode') // 请输入母公司统一信用代码
            }
          },
          // 企业简介
          'ceeaCompanyIntro': {
