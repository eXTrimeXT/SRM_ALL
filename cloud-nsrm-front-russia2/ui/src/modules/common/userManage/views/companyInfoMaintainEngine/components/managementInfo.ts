        ...
        properties: {
          ...
          'ifIsoQuality': {
            ...
            'x-component-props': {
              ...
              '@change': expression(`$managementChange($self.value, $t('cusEntry.supplement20250211.iso9001'), $form)`) // ISO9001质量体系认证
              // '@change':expression(`() => {
          ...
          'ifIsoEnviron': {
            ...
            'x-component-props': {
              'disabled': expression(`$form.query('state').get('data').$disabled`),
              '@change':expression(`$managementChange($self.value, $t('cusEntry.supplement20250211.iso14001'), $form)`) // ISO14001环境体系认证
            },
          ...
          'ifOhsasSafe': {
            ...
            'x-component-props': {
              'disabled': expression(`$form.query('state').get('data').$disabled`),
              '@change':expression(`$managementChange($self.value, $t('cusEntry.supplement20250211.ohsas18000'), $form)`) // OHSAS18000职业、健康安全体系认证
            },
