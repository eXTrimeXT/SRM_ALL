  ...
  rdCapableList: {
    ...
    properties: {
      rdCapables: {
        ...
        default: expression(`$form.values.rdCapables?.length ? null : [{type: $t('vendorMod.peopleNumber')}]`),
        'x-component-props': {
          class: 'rdCapableList',
          preColumns: '',
          editMode: true,
        ...
        properties: generateXindexInOrder({
          ...
          seniorEngineerQuantity: {
            type: 'string',
            title: i18nExpression('vendorMod.seniorEngineerQuantity'),
            'x-render-table-column': {
              minWidth: 120
            },
            'x-component-props': {
          ...
          engineerQuantity: {
            type: 'string',
            title: i18nExpression('vendorMod.engineerQuantity'),
            'x-render-table-column': {
              minWidth: 120
            },
            'x-component-props': {
