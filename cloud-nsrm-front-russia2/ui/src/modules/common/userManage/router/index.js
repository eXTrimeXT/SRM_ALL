  ...
  children: [
    {
      ...
      component: meiqlCtrl.companyInfoMaintain === 'Y'
        ? () => import('mod@/common/userManage/views/companyInfoMaintainEngine')
    ...
    {
      path: 'updatePassword',
      component: () => import('mod@/common/userManage/views/profile/updatePassword'),
      name: 'updatePassword',
      meta: {
        title: 'route.updatePassword', // 修改密码
        requiresAuth: false
      }
    },
    {
      ...
      name: 'resetPwd',
      meta: {
        title: 'route.resetPwd', // 密码过期，重置密码
        requiresAuth: false
      }
    }
  ]
