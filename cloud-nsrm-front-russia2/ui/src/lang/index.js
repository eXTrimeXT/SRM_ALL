...
import elementRuLocale from '@meicloud/element-ui/lib/locale/lang/ru-RU' // 'element-ui/lib/locale/lang/ru-RU'// element-ui lang
import elementRuLocale1 from './elementRuLocale1.js'
...
import quickSearchRuLocaleCus from './langCus/quick-search-ru'
/**
 * [\u4e00-\u9fa5]
 * 多语言界面调用方法 如：导出
...
Vue.use(VueI18n)
// 处理覆盖IDE的代码
renderPIXEn.renderPix.components.common.expandForm = "Expand"
renderPIXEn.renderPix.components.common.collapseForm = "Collapse"
renderPIXEn.renderPix.components.common.search = "Search"
renderPIXEn.renderPix.components.common.reset = "Reset"
const messages = {
  'zh_CN': {
    ...zhLocale,
    ...renderPIXZh,
  ...
  'ru_RU': {
    ...ruLocale,
    ...renderPIXRu,
    'el': Object.assign({}, elementRuLocale.el, elementRuLocale1.el),
    ...quickSearchRuLocale,
    ...ruLocaleCus,
    ...quickSearchRuLocaleCus
  }
}
...
export function initLanguage (userLang) {
  ...
  const localLang = (navLang === 'zh-CN' || navLang === 'en-US' || navLang === 'ja-JP' || navLang === 'ru_RU') ? navLang.replace(/-/, '_') : false
