              ...
              <srm-row>
                ...
                <srm-col>
                  ...
                  <el-form-item
                    ...
                    prop="type"
                  >
                    <el-input :value="$t('route.pollingSource')" :disabled="isReadOnly" />
                  </el-form-item>
                </srm-col>
                <srm-col>
                  <!-- 创建人 -->
                ...
                <srm-col>
                  ...
                  <el-form-item
                    ...
                    :label-width="formLabelWidth"
                  >
                    <el-input :value="$t('bidMod.published')" :disabled="isReadOnly" />
                  </el-form-item>
                </srm-col>
                <srm-col :initCol="1">
                  <!-- 详情说明 -->
                ...
                <srm-col>
                  ...
                  >
                    <div class="form-item-line">
                      ...
                      >
                        <!-- 至少： -->
                        <span slot="prefix">{{ $t('cusEntry.common.least') }}</span>
                      </el-input>
                    </div>
                  </el-form-item>
                </srm-col>
