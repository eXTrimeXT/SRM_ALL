          ...
          <template v-if="showButtons">
            ...
            <div class="btn">
              <el-button type="primary" @click="viewTech">
                <!-- 技术澄清 -->
                {{ $t('cusEntry.bidMod.techClarification') }}
              </el-button>
            </div>
          </template>
        </div>
    ...
    <div class="content">
      ...
      <div class="content-box">
        ...
        <!-- <div v-if="form.isNeedDeposit === 'Y'" class="content-item">
          <div class="content-title"> -->
            <!-- 五、意向金 -->
            <!-- {{ $t('cusEntry.bidMod.intention') }}
          </div>
          <div class="content-info"> -->
            <!-- 投标意向金：{{ form.depositAmount }}（大写：人民币{{ amountToChinese(form.depositAmount) }}） -->
            <!-- {{ $t('cusEntry.bidMod.bidIntent') }}{{ form.depositAmount }}（{{ $t('cusEntry.bidMod.bidIntentDes' )}}{{ amountToChinese(form.depositAmount) }}）
          </div>
        ...
        <div class="content-item">
          <el-divider class="sub-title" content-position="left">
            <!-- 发布媒体 -->
            {{ $t('cusEntry.bidMod.releaseMedia') }}
          </el-divider>
          <div class="content-info">
        ...
        <div class="content-item">
          <el-divider class="sub-title" content-position="left">
            <!-- 争议解决 -->
            {{ $t('cusEntry.biddingSettings.disputeReso') }}
          </el-divider>
          <div class="content-info">
        ...
        <div class="content-item">
          <el-divider class="sub-title" content-position="left">
            <!-- 集团举报渠道 -->
            {{ $t('cusEntry.bidMod.reportChannels') }}
          </el-divider>
          <div class="content-info">
...
export default {
  ...
  created () {
    this.reqHeadId = this.$route.query.id
    this.getFormDetail()
  },
  methods: {
    async getFormDetail () {
