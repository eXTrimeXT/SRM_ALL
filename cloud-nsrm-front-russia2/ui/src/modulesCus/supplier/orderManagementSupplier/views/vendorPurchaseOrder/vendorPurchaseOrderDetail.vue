...
export default {
  ...
  methods: {
    ...
    printBill () {
      ...
      const xml = encodeURIComponent(this.$t("cusEntry.supplement20250121.purchaseOrderPrintTemplateUreportXml"))
    ...
    async confirmOrder () {
      ...
      //'请注意，确认订单后应当如约送货，否则按违约处理!'
      this.$confirm(this.$t("cusEntry.supplement20250121.confirmOrderNotice"), this.$t("components.approvalHead.tips.tip"), {
