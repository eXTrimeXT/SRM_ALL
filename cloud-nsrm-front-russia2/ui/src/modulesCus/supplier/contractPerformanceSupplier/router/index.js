  ...
  children: [
    {
      ...
      component: () => import('modcs@/contractPerformanceSupplier/views/contractPerformancePlanVendor'),
      name: 'contractPerformancePlanVendor',
      meta: {
    ...
    },
    {
      ...
      component: () => import('modcs@/contractPerformanceSupplier/views/contractPerformanceCheckVendor'),
