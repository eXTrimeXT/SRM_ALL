  ...
  <div class="tech-info">
    ...
    <div style="margin-bottom: 14px">
      ...
      <div style="margin: 8px 0">
        <p style="color: red;margin: 6px 0;">
          {{ $t('cusEntry.supplement20250205.bidQuotaTips15') }}
          <b style="font-size: 14px;margin-right:4px;">{{ $t('cusEntry.bidMod.bidFile') }}</b>
          {{ $t('cusEntry.supplement20250205.bidQuotaTips16') }}
        </p>
      </div>
      <!-- <el-button
        v-if="!readonly"
    ...
    <div style="margin: 12px 0 14px 0">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <SrmCommonFile
              ...
              :validate-options="{ accept: ['xls', 'xlsx', 'doc', 'docx', 'ppt', 'pptx', 'pdf', 'ofd', 'cad', 'wps', 'zip', 'rar'] }"
              :readonly="readonly"
        ...
        <!-- 标段 -->
        <el-table-column
          v-if="techOrderFileList.some(item => !!item.extBidSection)"
          align="center"
          prop="extBidSection"
