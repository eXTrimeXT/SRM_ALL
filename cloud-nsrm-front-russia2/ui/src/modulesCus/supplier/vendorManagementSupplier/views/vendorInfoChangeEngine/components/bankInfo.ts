import {expression, generateXindexInOrder, i18nExpression, methodExpression,generateCharExpressionByFunction} from '@meicloud/render-engine'
    ...
    properties: {
      ...
      bankInfoAfter: {
        ...
        'x-component-props': {
          ...
          primaryKey: 'bankChangeId',
          // 启用级联删除的储值行为
          cascadeDeletion: true
        },
        'x-query-engine-skip': true,
        'x-query-engine-relation': 'bankInfoChanges:*',
        properties: generateXindexInOrder({
          branchBankId: {
            type:"number",
            'x-hidden': true
