export default {
  ...
  children: [
    // 合同模板
    {
      ...
      component: () =>
        import('modcb@/contractManagement/views/contractModeManager'),
    ...
    {
      path: 'sealManagement',
      component: () => import('modcb@/contractManagement/views/sealManagement'),
      name: 'sealManagement',
      meta: {
        title: 'cusEntry.route.sealManagement',
        requiresAuth: true
      }
    }
  ]
