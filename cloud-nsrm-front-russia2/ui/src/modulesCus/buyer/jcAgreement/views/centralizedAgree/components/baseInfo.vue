<template>
  <SrmRow>
    <SrmCol :init-col="4">
      <!-- 协议编号 -->
      <el-form-item :label="$t('cusEntry.supplement20250121.protocolCode')" prop="agreementCode">
        <el-input v-model="baseForm.agreementCode" :disabled="readonly || isChange" />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- 公司主体--开票主体 -->
      <el-form-item :label="$t('cusEntry.supplement20250121.companyMain')" prop="companyName">
        <QuickSearch
          ...
          :dialogLabel="$t('cusEntry.orderMod.invoiceBody')"
    ...
    <SrmCol :init-col="4">
      <!-- 协议名称 -->
      <el-form-item :label="$t('cusEntry.supplement20250121.protocolName')" prop="agreementName">
        <el-input v-model="baseForm.agreementName" :disabled="readonly" />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- 供应区域 -->
      <el-form-item :label="$t('cusEntry.reportManagement.supplyArea')" prop="supplyArea">
        <DictSelect
    ...
    <SrmCol v-if="mode === 'central'" :init-col="4">
      <!-- 是否默认全组织 -->
      <el-form-item :label="$t('cusEntry.supplement20250121.isDefaultAllOrg')" prop="defaultAll">
        <el-checkbox
    ...
    <SrmCol v-if="mode === 'contract'" :init-col="4">
      <!-- 采购组织 -->
      <el-form-item :label="$t('cusEntry.supplement20250121.purchaseOrg')" prop="buyOrgId">
    ...
    <SrmCol :init-col="4">
      <!-- 付款条款 -->
      <el-form-item :label="$t('bidMod.paymentTerms')" prop="payment">
        <DictSelect
    ...
    <SrmCol :init-col="4">
      <!-- 供应商 -->
      <el-form-item :label="$t('common.vendor')" prop="supName">
        <QuickSearch
          :disabled="readonly || isChange"
    ...
    <SrmCol :init-col="4">
      <!-- 采购员 -->
      <el-form-item :label="$t('bidMod.quotePurchasor')" prop="buyPersonName">
        <QuickSearch
          :disabled="readonly"
    ...
    <SrmCol :init-col="4">
      <!-- 发票类型 -->
      <el-form-item :label="$t('components.ocr.invoiceType')" prop="invoiceType">
        <DictSelect
    ...
    <SrmCol :init-col="4">
      <!-- 付款方式 -->
      <el-form-item :label="$t('vendorMod.paymentMethod')" prop="payWay">
        <DictSelect
    ...
    <SrmCol :init-col="4">
      <!-- 有效日期从 -->
      <el-form-item :label="$t('dataConfMod.effectiveDateFrom')" prop="effectiveStartDate">
        <el-date-picker
    ...
    <SrmCol :init-col="4">
      <!-- 有效日期至 -->
      <el-form-item :label="$t('dataConfMod.withRetrospectiveEffect')" prop="effectiveEndDate">
        <el-date-picker
    ...
    <!-- 协议类型 -->
    <!-- <SrmCol :init-col="4">
      <el-form-item :label="$t('threePartyLoginConfig.protocolType')" prop="agreementType">
        <el-input v-model="baseForm.agreementType" disabled />
      </el-form-item>
    </SrmCol> -->
    <SrmCol :init-col="4">
      <!-- 协议附件 -->
      <el-form-item :label="$t('cusEntry.supplement20250121.protocolFile')" prop="agreementFileName">
        <SrmCommonFile
          :extra-data="fileInfo"
          :disabled="readonly"
          :default-file="{
