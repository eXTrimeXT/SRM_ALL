    ...
    biddingBase: {
      handler (val) {
        ...
        const tableHeaderData = [
          ...
          {
            prop: 'winStatus',
            label: this.$t('bidMod.currentInList'),
            minWidth: 120,
          ...
          {
            prop: 'selectStatus',
            label: this.$t('sourcingBuyer.result'),
            minWidth: 120,
          ...
          // 本币未税单价
          {
            ...
            label: this.$t('bidMod.standardNotaxPriceOr'),
            minWidth: 120
          },
          // 本币币种
          {
  ...
  methods: {
    ...
    async createPricingApproval () {
      ...
      await createPricingApproval(
        ...
        // apiUrl
        bidBuyerHttp.select.getCreatePricingApprovalUrl(this.biddingBase.projectId),
        {},
        this.$router
      )
    },
    ...
    openPriceComparisonTab (row) {
      ...
      const tab = {
        ...
        closable: true,
        title: this.biddingBase.souNo + this.$t('bidMod.priceCompare'),
