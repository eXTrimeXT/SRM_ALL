  ...
  <div>
    <div style="margin: 16px 0">
      ...
      <span style="font-size:14px; font-weight:bold">
        {{ $t('cusEntry.supplement20250121.viewBidNotice') }}
      </span>
    </div>
    <el-table
      border
    ...
    >
      ...
      <el-table-column
        align="center"
        prop="winAmount"
        :label="$t('cusEntry.supplement20250121.winAmount')"
        min-width="150"
        show-overflow-tooltip
      />
      <!-- 合同签署单位 -->
      <el-table-column
        ...
        :label="$t('cusEntry.supplement20250121.contractSign')"
        min-width="150"
        show-overflow-tooltip
      />
      <!-- 合同周期 -->
      <el-table-column
        align="center"
        prop="contractPeriod"
        :label="$t('cusEntry.supplement20250121.contractPeriod')"
        min-width="150"
        show-overflow-tooltip
      />
      <!-- 通知书附件 -->
      ...
      <el-table-column
        align="center"
        prop="isSend"
        :label="$t('cusEntry.supplement20250121.isSend')"
        min-width="150"
        :formatter="(row, column, cellValue) => $getDictLabel('YES_OR_NO', cellValue)"
        show-overflow-tooltip
      />
    ...
    <div style="margin: 30px 0 16px 0;font-size:14px; font-weight:bold">
      {{ $t('cusEntry.supplement20250121.viewInternalNotice') }}
    </div>
    ...
    >
      ...
      <el-table-column
        align="center"
        prop="extOrgOuName"
        :label="$t('cusEntry.orderMod.companyName')"
        min-width="150"
        show-overflow-tooltip
      />
      <el-table-column
