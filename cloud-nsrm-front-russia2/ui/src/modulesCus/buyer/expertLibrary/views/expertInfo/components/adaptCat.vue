<template>
  <div class="wrapper">
    <div class="header">
      <span class="red">*</span>
      <!-- 适用品类 -->
      {{ $t("cusEntry.supplement20250205.applicableProductCategories") }}
    </div>
    ...
    >
      ...
      <el-table-column
        prop="categoryName"
        :label="$t('components.category.categoryName')"
      />
    ...
    <srm-dialog
      :visible.sync="showCatDialog"
      :title="$t('cusEntry.supplement20250205.selectEvaluationCategories')"
      size="middle"
      :close-on-click-modal="false"
    >
      <el-cascader
