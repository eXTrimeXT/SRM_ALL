<template>
  <SrmRow>
    <SrmCol v-if="mode === 'expertApply'" :init-col="4">
      ...
      <el-form-item :label="$t('vendorMod.dataSources')" prop="applyFromType">
        <DictSelect
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('purchaseDemand.requirementHeadNum')" prop="expertApplyNo">
        <el-input v-model="baseForm.expertApplyNo" disabled />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- <el-form-item label="申请人" prop="applyByNickname"> -->
      <el-form-item :label="$t('components.approvalHead.headers.applicant')" prop="applyByNickname">
        <el-input v-model="baseForm.applyByNickname" disabled />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- <el-form-item label="单据状态" prop="applyStatus"> -->
      <el-form-item :label="$t('vendorMod.relegation.documentStatus')" prop="applyStatus">
        <DictSelect
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('dataConfMod.jobNum')" prop="applyBy">
        <QuickSearch
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('vendorMod.nickname')" prop="applyByNickname">
        <el-input v-model="baseForm.applyByNickname" disabled />
      </el-form-item>
    </SrmCol>
    <!-- <SrmCol :init-col="4">
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('cusEntry.supplement20250121.affiliatedCompany')" prop="orgOuId">
    ...
    <SrmCol :init-col="4">
      <el-form-item :label="$t('cusEntry.supplement20250205.department')" prop="departmentName">
        <el-select
    ...
    <SrmCol :init-col="4">
      <el-form-item :label="$t('components.orgPositionSel.position')" prop="job">
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('vendorMod.mobilePhone')" prop="phone">
        <el-input v-model="baseForm.phone" :disabled="readonly" />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- <el-form-item label="邮箱" prop="studyCollege"> -->
      <el-form-item :label="$t('common.email')" prop="jobRank">
        <el-input v-model="baseForm.jobRank" :disabled="readonly" />
      </el-form-item>
    </SrmCol>
    <!-- <SrmCol :init-col="4">
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('cusEntry.supplement20250205.applicationLevel')" prop="applyLevel">
        <DictSelect
    ...
    <SrmCol v-if="mode === 'expertUpgrade'" :init-col="1">
      ...
      <el-form-item :label="$t('cusEntry.supplement20250205.applicationDescription')" prop="upgradeReason">
...
export default {
  ...
  methods: {
    ...
    async getExpertByQuick (val, scope) {
      ...
      this.baseForm.jobRank = val ? val.email : null // 邮箱
      if (val && val.username) {
