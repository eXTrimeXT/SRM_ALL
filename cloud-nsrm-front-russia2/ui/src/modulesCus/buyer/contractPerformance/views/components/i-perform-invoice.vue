  ...
  data () {
    return {
      ...
      columns: [
        ...
        { prop: 'actualInvoiceDate', label: this.$t('实际开票完成时间'), width: 180, dataType: 'dateTime' },
        { prop: 'actualInvoiceAmount', label: this.$t('实际开票金额'), width: 150 },
        { prop: 'invoiceApplyNo', label: this.$t('开票申请单号'), width: 150 },
        { prop: 'paymentDays', label: this.$t('账期'), width: 150 },
        { prop: 'palnPaymentDate', label: this.$t('计划付款时间'), width: 150, dataType: 'dateTime' },
        { prop: 'paymentApplyNo', label: this.$t('付款申请单号'), width: 150 },
        { prop: 'actualPaymentDate', label: this.$t('实际付款时间'), width: 150, dataType: 'dateTime' },
        { prop: 'fineAmount', label: this.$t('罚款金额') },
        {
          prop: 'operation',
