  ...
  children: [
    {
      ...
      component: () => import('modcb@/contractPerformance/views/contractPerformanceProcessConfig'),
      name: 'contractPerformanceProcessConfig',
      meta: {
    ...
    },
    {
      ...
      component: () => import('modcb@/contractPerformance/views/contractPerformancePlan'),
    ...
    },
    {
      ...
      component: () => import('modcb@/contractPerformance/views/contractPerformanceCheck'),
