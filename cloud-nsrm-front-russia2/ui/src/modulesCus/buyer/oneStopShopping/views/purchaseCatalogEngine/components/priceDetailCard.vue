<template>
  <div class="catalog-detail-infor">
    <div class="detail-big-img">
      <img class="img-fit" :width="catalogList.length > 0 ? '100%' : '70%'" :src="bigImgShow ? bigImgShow : defaultImg" :alt="formDetail.materialName">
    </div>

    <div class="catalog-infor">
      <!-- 物料名称 -->
      <div class="catalog-title" :title="formDetail.materialName">
        {{ formDetail.materialNameShow }}
      </div>
      <div class="catalog-price-infor">
        <div class="price-block">
          ...
          <div class="item-price">
            ...
            <!-- 价格 -->
            <span class="price-amount">{{ formDetail.extReferencePrice }}</span>
      ...
      <div class="item-detail">
        ...
        <p>
          ...
          <span class="item-text">{{ formDetail.specificationShow }}</span>
        </p>
        <p>
