              ...
              <el-collapse-item ref="aptInfo" :title="$t('purchaseDemand.purAppDetail')" name="1">
                <srm-row>
                  ...
                  <srm-col v-if="requirementHead.extOrgBuCode == 'JSZX'">
                    <!-- 是否集采物资 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.ceeaPurchaseType')"
                    >
                      <DictSelect
                  ...
                  <srm-col>
                    <!-- 公司 -->
                    <el-form-item
                      :label="$t('cusEntry.perfMod.orgName')"
                      prop="orgId"
                    >
                  ...
                  <srm-col>
                    <el-form-item
                      :label="$t('purchaseDemand.applicationType')"
                      prop="ceeaPrType"
                    >
                      <DictSelect
                        ...
                        :class="requirementHead.ceeaPrType === 'type2' ? 'light-color' : null"
                      />
                    </el-form-item>
                  </srm-col>
                  <srm-col>
                  ...
                  <!-- 研发/生产 -->
                   <srm-col>
                    <el-form-item
                      :label="$t('cusEntry.supplement20250218.extFixPriceType')"
                      prop="extFixPriceType"
                    >
                      <dict-select
                        v-model="requirementHead.extFixPriceType"
                        :disabled="isReadOnly || requirementHead.auditStatus === 'APPROVED'"
                        code="FIX_PRICE_TYPE"
                      />
                    </el-form-item>
                  ...
                  <srm-col v-if="requirementHead.ceeaPrType == 'type2'">
                    <!-- 加急原因 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.ceeaUrgencyExplain')"
                      :rules="{
                        required: true,
                  ...
                  <srm-col v-if="!$attrs.params.isMobile" :initCol="1">
                    <!-- 采购申请说明 -->
                    <el-form-item prop="ceeaAppointReason" :label="$t('cusEntry.supplement20250121.ceeaAppointReasonTip')">
              ...
              <el-collapse-item ref="itemInfo" :title="$t('purchaseDemand.itemInfo')" name="2">
                <div class="btn_line">
                  ...
                  <el-button
                    ...
                    @click="lookingINV"
                  >
                    {{ $t('cusEntry.supplement20250121.viewInventory') }}
                  </el-button>
                </div>
                <vxe-table
                  border
                ...
                >
                  ...
                  <vxe-column
                    v-if="!$attrs.params.isMobile"
                    field="materialCode"
                    :title="$t('cusEntry.inq.materialCode')"
                    align="center"
                    width="120"
                    fixed="left"
                    :edit-render="{}"
                  ...
                  <vxe-column
                    ...
                    align="center"
                    field="materialName"
                    :title="$t('cusEntry.inq.materialName')"
                    min-width="120"
                    :edit-render="{}"
                    fixed="left"
                    sortable
                  ...
                  <vxe-column
                    align="center"
                    field="materialFileId"
                    :title="$t('cusEntry.supplement20250314.materialImagePreview')"
                    min-width="130"
                    :edit-render="{}"
                  >
                    <template #edit="{ row }">
                      <SrmCommonFile
                        :extra-data="fileInfo"
                        :default-file="{
                          fileId: row.materialFileId,
                          fileName: row.materialFileName
                        }"
                        :readonly="true"
                      />
                    </template>
                  ...
                  <vxe-column
                    ...
                    :title="$t('cusEntry.inq.extPredictPrice1')"
                    min-width="170"
                    :edit-render="{}"
                    sortable
                  >
                  ...
                  <vxe-column
                    ...
                    :title="$t('cusEntry.supplement20250121.extPredictAmount')"
                    :edit-render="{}"
                    min-width="120"
                    sortable
                  >
                  ...
                  <vxe-column
                    ...
                    :title="$t('cusEntry.supplement20250121.accountingItems')"
                    :edit-render="{}"
                    min-width="120"
                    sortable
                  >
                    <template #edit="{ row, rowIndex }">
                      <dict-select
                        v-if="!isReadOnly"
                        v-model="row.accountingItems"
                        code="ACCOUNTING_ITEMS"
                      />
                      <span v-else>{{ row.accountingItems ? $getDictLabel('ACCOUNTING_ITEMS', row.accountingItems) : '' }}</span>
                    </template>
                    <template #default="{ row }">
                      {{ row.accountingItems ? $getDictLabel('ACCOUNTING_ITEMS', row.accountingItems) : '' }}
                    </template>
                  </vxe-column>
                  <!-- 预算限制 -->
                  <vxe-column
                    v-if="!$attrs.params.isMobile"
                    align="center"
                    field="extBudgetConstraint"
                    :title="$t('cusEntry.supplement20250121.extBudgetConstraint')"
                    :edit-render="{}"
                    min-width="120"
                    sortable
                  >
                    <template #edit="{ row, rowIndex }">
                      <el-input-number
                        v-if="!isReadOnly"
                        v-model="row.extBudgetConstraint"
                        :controls="false"
                        :precision="2"
                      />
                      <span v-else>{{ row.extBudgetConstraint }}</span>
                    </template>
                    <template #default="{ row }">
                      {{ row.extBudgetConstraint }}
                    </template>
                  </vxe-column>
                  <!-- 用途 -->
                  <vxe-column
                  ...
                  <vxe-column
                    ...
                    align="center"
                    field="categoryName"
                    :title="$t('cusEntry.common.categoryName')"
                    min-width="120"
                    :edit-render="{}"
                    sortable
                  >
                  ...
                  <vxe-column
                    ...
                    :title="$t('cusEntry.inq.useDeptName')"
                    min-width="120"
                    :edit-render="{}"
                    sortable
                  >
                  ...
                  <vxe-column
                    ...
                    :title="$t('cusEntry.supplement20250121.extUserName')"
                    min-width="130"
                    :edit-render="{}"
                    sortable
                  >
                    <template #edit="{ row }">
                      <QuickSearch
                        v-if="!isReadOnly && requirementHead.auditStatus !== 'APPROVED' && requirementHead.demandType !== 'Material_category'"
                      ...
                      />
                      <el-input
                        v-else-if="!isReadOnly && requirementHead.auditStatus !== 'APPROVED' && requirementHead.demandType === 'Material_category'"
                        v-model="row.extUserName"
                      />
                  ...
                  <vxe-column
                    align="center"
                    field="extUserPhone"
                    :title="$t('cusEntry.sup.extUserPhone')"
                    min-width="160"
                    :edit-render="{}"
                    sortable
                  >
                  ...
                  <vxe-column
                    ...
                    :title="$t('cusEntry.supplement20250121.requirementDate')"
                    min-width="150"
                    :edit-render="{}"
                    sortable
                  >
                    <template #edit="{ row, rowIndex }">
                      <el-date-picker
                        ...
                        value-format="yyyy-MM-dd"
                      />
                      <span v-else>{{ $parseTime(row.requirementDate) }}</span>
                    </template>
                    <template #default="{ row }">
                      {{ $parseTime(row.requirementDate) }}
                    </template>
                  </vxe-column>
                  <!-- 收货地址 -->
                  <vxe-column
                  ...
                  <vxe-column
                    ...
                    align="center"
                    field="extReceiver"
                    :title="$t('cusEntry.orderMod.extReceiveContact')"
                    min-width="120"
                    :edit-render="{}"
                    sortable
                  >
                  ...
                  <vxe-column
                    ...
                    :title="$t('cusEntry.orderMod.extReceiveTelephone')"
                    min-width="160"
                    :edit-render="{}"
                    sortable
                  >
                  ...
                  <vxe-column
                    ...
                    :title="$t('cusEntry.sup.extIsGoods')"
                    min-width="100"
                    sortable
                  >
                    <template #default="{ row }">
                  ...
                  <vxe-column
                    ...
                    align="center"
                    field="extShareStock"
                    :title="$t('cusEntry.supplement20250121.extShareStock')"
                    min-width="120"
                    sortable
                  >
                    <template #default="{ row }">
                  ...
                  <vxe-column
                    ...
                    align="center"
                    field="extIsHome"
                    :title="$t('cusEntry.supplement20250121.extIsHome')"
                    min-width="100"
                    sortable
                  >
                    <template #default="{ row }">
                      {{ row.extIsHome ? $getDictLabel('YES_OR_NO', row.extIsHome) : '' }}
                    </template>
                  </vxe-column>
                  <vxe-column
                    v-if="!$attrs.params.isMobile"
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        ...
        ceeaDepartmentName: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        ceeaPrType: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        extFixPriceType: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
      ...
      validRules: {
        extBudgetConstraint:  [{ required: true }],
  ...
  computed: {
    ...
    approveEditable () {
      // 审批环节-采购节点必填
      return ['approvalOnly'].includes(this.$attrs.params.flag) &&
        ['原价科负责人（俄籍）/Экономист Отдела по управлению затратами', '原价科负责人(中籍)/Руководитель Отдела по управлению затратами'].includes(this.flowData.taskName)
    },
    viewUpdateButton () {
      return ['add', 'edit'].includes(this.Viewflag)
    }
  },
  watch: {
  ...
  created () {
    ...
    this.buttonConfigInfo.save.view = this.viewUpdateButton
    this.buttonConfigInfo.submit.view = this.viewUpdateButton
    this.buttonConfigInfo.cancel.view = this.Viewflag != 'view'
    this.buttonConfigInfo.close.view = this.Viewflag == 'view'
  },
  methods: {
    getWorkflowBusinessType () {
      return 'MQL_PR_REQUIREMENT_I'
    },
    getWorkflowBusinessVariables () {
      const procTitleObj = {
        ifBid: this.requirementHead.ifBid,
        orgCode: this.requirementHead.orgCode,
        ceeaPrType: this.requirementHead.ceeaPrType,
        extFixPriceType: this.requirementHead.extFixPriceType,
    ...
    //     if (this.approveEditable) {
    //       let bol = this.requirementHead.reqLineList.some(item => isNull(item.extBudgetConstraint))
    //       if (bol) {
    //         this.$message.error(this.$t('cusEntry.supplement20250121.extBudgetConstraintTip')) // 预算限制不能为空!
    //         resolve(false)
    //         return
    //       }
    //       let allparam = this.initParams()
    //       const saveData = transformMQL.save('PurchaseRequirementHead', [allparam], 'saveOrUpdate')
    //       purchaseApplicationApi.save(saveData).then(res => {
    //         resolve(true)
    //       }).catch(err => {
    //         resolve(false)
    //       })
    ...
    handlePhoneBlur (index, row) {
      const bool = validatePhone(row.extUserPhone)
      if (!bool && row.extUserPhone) {
    ...
    bumenListFun () {
      let curParentId = this.requirementHead.orgId
    ...
    async handleSuccess (data) {
      ...
      const materialIds = attr.map(item => item.materialId)
      const resData = await this.getMaterialLang(materialIds)
      const newAttr = attr.map(item => {
      ...
      this.allreqLineList = reqLineList.concat(newAttr) // 总的数组需要重新渲染
    ...
    // 查询多语言物料信息
    async getMaterialLang (materialIds = []) {
    ...
    async getFormDetail (requirementHeadId) {
      ...
      purchaseApplicationApi.queryData(searchData).then(async (datas) => {
        ...
        const materialIds = reqLineList.map(item => item.materialId)
        const resData = await this.getMaterialLang(materialIds)
        const newReqLineList = reqLineList.map(item => {
          const data = resData.find(it => it.materialId === item.materialId)
          return {
            ...item,
            materialNameShow: data?.materialName,
        ...
        this.allreqLineList = newReqLineList
    ...
    async getCategoryObj (val, scope) {
      ...
      scope.extIsHome = val?.extIsHome
      scope.extProductFlag = val?.extProductFlag
      this.$set(scope, 'brand', val?.brand)
      this.$set(scope, 'extMaterialModel', val?.extMaterialModel)
      this.$set(scope, 'unitCode', val?.unit)
      this.$set(scope, 'unit', val?.unitName)
      this.$set(scope, 'extPredictPrice', val?.extPredictPrice)
      if (val) {
        const resData = await this.getMaterialLang([val.materialId])
        this.$set(scope, 'materialNameShow', resData[0].materialName)
        this.$set(scope, 'extMaterialModelShow', resData[0].extMaterialModel)
    ...
    setTotalAmount2 (row, index) {
      const total = (Number(row.extPredictPrice || 0) * Number(row.requirementQuantity || 0)).toFixed(2)
      if (total) {
    ...
    async preNextStepHandler () {
      ...
      if (flag) {
        let bol = false
        const reqLineList = allparam.reqLineList.filter(it => !it['$delete'])
        reqLineList.forEach(datas => {
          if (isNull(datas.extShareStock)) {
            bol = true
            return false
          }
        })
        if (bol) {
          // 请点击查看库存
          this.$message.error(this.$t('cusEntry.supplement20250121.pleaseTips1'))
          return false
        }
        // 校验物料编码是否有选择
        let bol2 = false
        ...
        if (bol2 || bol3) {
          // 物料明细行有必填项没有填写
          this.$message.error(this.$t('cusEntry.supplement20250121.pleaseTips2'))
          return false
        }
        // if (bol4) {
        //   return false
        ...
        this.requirementHead.requirementHeadNum = datas.data[0].requirementHeadNum
        this.$message({
    ...
    saveBill (allparam) {
      ...
      purchaseApplicationApi.save(saveData).then((result) => {
        this.$message({
          message: this.$t('priceModel.priceModel.tempSave'),
          type: 'success'
        })
    ...
    async getCheckForm () {
      ...
      if (this.requirementHead.reqLineList.length == 0) {
        return {
          flag: false,
          message: this.$t('cusEntry.supplement20250121.pleaseTips3') // 请填写物料信息
        }
      }
      let bol = false
      ...
      if (bol) {
        return {
          flag: false,
          message: this.$t('cusEntry.supplement20250121.pleaseTips2') // 物料明细行有必填项没有填写
        }
      }
...
::v-deep .light-color .el-input .el-input__inner {
  background-color: #f4b7b8;
}
::v-deep .light-color .el-input.is-disabled .el-input__inner {
  background-color: #f4b7b8;
}
