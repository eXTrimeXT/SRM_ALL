  ...
  <el-container class="flex-container the-purchaseApplicationDetail-detail" direction="vertical">
    <el-main>
      <CWorkflowMulti
        ...
        :showTopBtn="Viewflag != 'approveNumber'"
        ...
        <div class="form-container2">
          ...
          >
            <el-collapse v-model="activeDims" class="tab-form-style">
              <!-- 招标申请说明 -->
              <el-collapse-item ref="aptInfo" :title="$t('cusEntry.supplement20250121.aptInfo')" name="1">
                <srm-row>
                  <srm-col v-if="!$attrs.params.hidden">
                    <!-- 是否招标 -->
                    <el-form-item :label="$t('cusEntry.vendorMod.ifBid')">
                  ...
                  <srm-col v-if="!$attrs.params.isMobile">
                    <!-- 所属板块 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.orgBuName')">
                      <el-input v-model="requirementHead.orgBuName" disabled />
                    </el-form-item>
                  </srm-col>
                  <srm-col>
                    <!-- 申请公司 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.orgName')" prop="orgId">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('cusEntry.supplement20250121.orgName') }}</span>
                          <!-- 此处填写该招标项目的申请部门所属公司（即招标服务费的付款单位），而非该项目实际使用公司 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.orgNameTip')"
                            placement="top"
                  ...
                  <srm-col>
                    <!-- 技术专家 -->
                    <el-form-item
                      :label="$t('cusEntry.bidMod.techResponer')"
                      :rules="{
                        required: true,
                    ...
                    >
                      <QuickSearch
                        ...
                        @close-quicksearch="getUserObjNew"
                      />
                    </el-form-item>
                  </srm-col>
                  <srm-col v-if="!$attrs.params.isMobile">
                    <!-- 技术专家联系方式 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.techGroupPhone')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                  ...
                  <srm-col v-if="!$attrs.params.hidden">
                    <!-- 技术专家工作年限 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.techGroupWorkYear')">
                      <el-input
                  ...
                  <srm-col>
                    <!-- 需求来源 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.sourceFrom')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                  ...
                  <!-- 招标类型 -->
                  <srm-col>
                    <el-form-item :label="$t('bidMod.bidingType')" prop="extTenderType">
                      <dict-select
                        v-model="requirementHead.extTenderType"
                        :disabled="isReadOnly || requirementHead.auditStatus === 'APPROVED'"
                        code="TENDER_TYPE"
                      />
                    </el-form-item>
                  ...
                  <srm-col v-if="requirementHead.requireFrom == 'WITHOUT_PLAN'">
                    <!-- 未报月度计划原因 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.noReportMonthPlanReason')"
                  ...
                  <srm-col>
                    ...
                    >
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('contractMod.itemName') }}</span>
                          <!-- 项目名称组合 地区+类型+项目 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.itemNameTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col>
                    <el-form-item
                      :label="$t('cusEntry.supplement20250314.extInvestmentProject')"
                      :rules="{
                        required: requirementHead.totalAmountByTenKilo > 1200000,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                      prop="extInvestmentProject"
                    >
                      <el-input
                        v-model="requirementHead.extInvestmentProject"
                        :disabled="isReadOnly || requirementHead.auditStatus === 'APPROVED'"
                      />
                    </el-form-item>
                  </srm-col>
                  ...
                  <srm-col>
                    ...
                    <el-form-item
                      ...
                      :label="$t('cusEntry.supplement20250121.category')"
                      prop="categoryName"
                    >
                      <CategorySelect
                  ...
                  <srm-col v-if="!['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 规模数量 -->
                    <el-form-item
                      :label="$t('cusEntry.bidMod.scaleQuantity')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                  ...
                  <srm-col v-if="!['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 是否公示 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.needPublic')" prop="needPublic">
                      <DictSelect
                  ...
                  <srm-col v-if="requirementHead.needPublic == 'Y'">
                    <!-- 公示截止时间 -->
                    <el-form-item :label="$t('cusEntry.reportManagement.publicEndTime')" prop="publicEndTime">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('cusEntry.reportManagement.publicEndTime') }}</span>
                          <!-- 公示周期至少7天（不含法定节假日，含周六日）。若项目无需前置技术交流，则公示截止时间即为递交招标资料时间；合格流程到达招标部第二天开始计算 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.publicEndTimeTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col
                    v-if="!['YEAR', 'SPECIAL_SOU'].includes(requirementHead.requireFrom) && requirementHead.needPublic == 'N'"
                  >
                    <!-- 具体原因说明 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.noPublicReason')" prop="noPublicReason">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('cusEntry.supplement20250121.noPublicReason') }}</span>
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.noPublicReasonTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col v-if="!$attrs.params.isMobile && !['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 项目所在地 -->
                    <el-form-item
                    ...
                    >
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('cusEntry.supplement20250121.projectAddress') }}</span>
                          <!-- 省份+城市 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.projectAddressTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  >
                    <!-- 前置技术交流意向 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.prefixTechDiscussion')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                  ...
                  <srm-col
                    v-if="((requirementHead.prefixTechDiscussion != 'N' && requirementHead.requireFrom == 'MONTH') || (requirementHead.needPublic == 'N' && requirementHead.requireFrom == 'MONTH') || (requirementHead.requireFrom == 'WITHOUT_PLAN' && requirementHead.needPublic == 'N')) && !['YEAR'].includes(requirementHead.requireFrom)"
                  >
                    <!-- 递交招标资料时间 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.sendSouProfileEndDate')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                    ...
                    >
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('cusEntry.supplement20250121.sendSouProfileEndDate') }}</span>
                          <!-- 与公示截止时间间隔最多5天 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.sendSouProfileEndDateTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col v-if="['MONTH','WITHOUT_PLAN'].includes(requirementHead.requireFrom)">
                    <!-- 是否指定品牌 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.ifAppointBrand')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                  ...
                  <srm-col v-if="['MONTH','WITHOUT_PLAN'].includes(requirementHead.requireFrom) && requirementHead.ifAppointBrand == 'Y'">
                    <!-- 指定品牌原因 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.extAppointBandReason')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                    ...
                    >
                      <el-input
                        v-model="requirementHead.extAppointBandReason"
                        :disabled="isReadOnly || requirementHead.auditStatus === 'APPROVED'"
                      />
                    </el-form-item>
                  </srm-col>
                  <srm-col v-if="['MONTH','WITHOUT_PLAN'].includes(requirementHead.requireFrom)">
                    <!-- 是否限定单位 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.ifQualifyUnit')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                  ...
                  <srm-col v-if="['MONTH','WITHOUT_PLAN'].includes(requirementHead.requireFrom) && requirementHead.ifQualifyUnit == 'Y'">
                    <!-- 限定单位原因 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.extAppointUnitReason')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                    ...
                    >
                      <el-input
                        v-model="requirementHead.extAppointUnitReason"
                        :disabled="isReadOnly || requirementHead.auditStatus === 'APPROVED'"
                      />
                    </el-form-item>
                  </srm-col>
                  <srm-col v-if="requirementHead.orgBuCode == 'JSZX' && !['YEAR'].includes(requirementHead.requireFrom)">
                    <el-form-item :label="$t('vendorMod.planCodeNew')">
                      <QuickSearch
                  ...
                  <srm-col v-if="requirementHead.requireFrom == 'SPECIAL_SOU'">
                    <!-- 特殊招标类型 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.specialSouType')" prop="specialSouType">
                      <DictSelect
                  ...
                  >
                    <!-- 特定原因 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.specialReason')"
                      :rules="{
                  ...
                  <srm-col v-if="requirementHead.specialSouType == 'TIME_URGENT' && !['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 需求产生时间 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.requireProductDate')">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span style="color: red; font-size: 12px;">*</span>
                          <span>{{ $t('cusEntry.supplement20250121.requireProductDate')}}</span>
                          <!-- 领导什么时间安排的要开展本项目 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.requireProductDateTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col v-if="requirementHead.specialSouType == 'TIME_URGENT' && !$attrs.params.isMobile &&  !['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 需求产生时间附件 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.fileInfos')">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span style="color: red; font-size: 12px;">*</span>
                          <span>{{ $t('cusEntry.supplement20250121.fileInfos') }}</span>
                          <!-- 相应权限领导签字的申请、会议纪要、说明等文件均可，此处只能上传一份文件，文件多的请放到一个文件夹压缩后上传 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.fileInfosTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col v-if="requirementHead.specialSouType == 'TIME_URGENT' && !['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 工期交货期 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.deliveryDay')">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span style="color: red; font-size: 12px;">*</span>
                          <span>{{ $t('cusEntry.supplement20250121.deliveryDay') }}</span>
                          <!-- 供应商做这项工作需要几天 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.deliveryDayTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col v-if="requirementHead.specialSouType == 'TIME_URGENT' && !$attrs.params.isMobile && !['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 工期交货期附件 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.fileInfos2')">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span style="color: red; font-size: 12px;">*</span>
                          <span>{{ $t('cusEntry.supplement20250121.fileInfos2') }}</span>
                          <!-- 至少提供两家供应商加盖公章的工期文件，国外单位无公章的可以是正式邮件或签字文件，此处只能上传一份文件，文件多的请放到一个文件夹压缩后上传 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.fileInfos2Tip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col v-if="requirementHead.specialSouType == 'TIME_URGENT' && !['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 签合同用时 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.contractTime')">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span style="color: red; font-size: 12px;">*</span>
                          <span>{{ $t('cusEntry.supplement20250121.contractTime') }}</span>
                          <!-- 定厂后签合同大概需要几天 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.contractTimeTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col v-if="requirementHead.specialSouType == 'TIME_URGENT' && !['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 投入使用时间 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.putIntoUseDate')">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span style="color: red; font-size: 12px;">*</span>
                          <span>{{ $t('cusEntry.supplement20250121.putIntoUseDate') }}</span>
                          <!-- 什么时间必须投入使用或执行 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.putIntoUseDateTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col v-if="requirementHead.specialSouType == 'TIME_URGENT' && !$attrs.params.isMobile && !['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 投入使用时间附件 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.fileInfos3')">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span style="color: red; font-size: 12px;">*</span>
                          <span>{{ $t('cusEntry.supplement20250121.fileInfos3') }}</span>
                          <!-- 相应权限领导签字的申请、会议纪要、说明等文件均可，此处只能上传一份文件，文件多的请放到一个文件夹压缩后上传 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.fileInfos3Tip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col v-if="requirementHead.specialSouType == 'TIME_URGENT' && !['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 剩余时间 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.remainingDay')">
                  ...
                  <srm-col v-if="!['YEAR'].includes(requirementHead.requireFrom)">
                    ...
                    <el-form-item
                      ...
                      :label="$t('cusEntry.supplement20250121.afterTotalAmountByTenKilo')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                  ...
                  <srm-col :initCol="1" v-if="!['YEAR'].includes(requirementHead.requireFrom)">
                    <!-- 变更原因 -->
                    <el-form-item
                      v-if="Viewflag == 'change'"
                      label="$t('outsourceMaterialHead.comments')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                  ...
                  <srm-col v-if="requirementHead.requireFrom == 'SPECIAL_SOU'" :initCol="1">
                    <!-- 具体特殊招标原因说明 -->
                    <el-form-item
                      :label="$t('cusEntry.supplement20250121.otherSpecialReasonBid')"
                      :rules="{
                        required: true,
                        message: $t('contractMod.pleaseFillIn')
                      }"
                ...
                <div v-if="!['YEAR'].includes(requirementHead.requireFrom)" style="margin-bottom: 20px">
                  <p
                  ...
                  >
                    ...
                    />
                    <!-- 概算金额（卢布）大于1200000时至少推荐三家有效供应商，小于等于1200000时不做要求 -->
                    <span v-if="requirementHead.requireFrom != 'YEAR'" style="margin-left: 10px">
                      {{ $t('cusEntry.supplement20250121.vendorThree') }}
                    </span>
                  </p>
                  <el-table :data="requireGroup" style="width: 100%" border max-height="250px">
                    ...
                    <el-table-column
                      align="center"
                      prop="vendorName"
                      :label="$t('cusEntry.supplement20250121.vendorName')"
                    ...
                    <el-table-column
                      ...
                      :label="$t('cusEntry.supplement20250121.extTaxRecognizeMark')"
                    >
                      <template slot-scope="scope">
                        <el-input
                          v-if="!$attrs.params.isMobile"
                          v-model="scope.row.extTaxRecognizeMark"
                          :disabled="isReadOnly || requirementHead.auditStatus === 'APPROVED'"
                        />
                        <span v-else>{{ scope.row.extTaxRecognizeMark }}</span>
                      </template>
                    </el-table-column>
                    <el-table-column
                      align="center"
                    ...
                    <el-table-column
                      align="center"
                      prop="extReferrer"
                      :label="$t('cusEntry.supplement20250121.extReferrer')"
                      :render-header="_addStarToColumn"
                    >
                      <template slot-scope="scope">
                        <el-input
                          v-if="!$attrs.params.isMobile"
                          v-model="scope.row.extReferrer"
                          :disabled="isReadOnly || requirementHead.auditStatus === 'APPROVED'"
                          @blur="handleEmailBlur(scope.$index,scope.row)"
                        />
                        <span v-else>{{ scope.row.extReferrer }}</span>
                      </template>
                    </el-table-column>
                    <!-- 推荐原因 -->
                    <el-table-column
                      align="center"
                      prop="recommendFrom"
                      :label="$t('cusEntry.supplement20250121.recommendFrom')"
                      :render-header="_addStarToColumn"
                    >
                      <template slot-scope="scope">
                        <el-input
                ...
                <srm-row v-if="!['YEAR'].includes(requirementHead.requireFrom)">
                  <srm-col :init-col="1">
                    <!-- 项目概况及范围 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.projectOverview')"  prop="projectOverview">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('cusEntry.supplement20250121.projectOverview') }}</span>
                          <!-- ①工程类：本工程采取交钥匙工程形式，主要内容为XXXXX，包括设计、试验、制造、包装、运输、装卸、就位、安装、调试、培训、售后服务、生产陪同等的全部内容。②设备类：明确需要采购的设备清单③服务类：项目需要写明服务内容 -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.projectOverviewTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col :init-col="1">
                    <!-- 技术要求 -->
                    <el-form-item :label="$t('qualitySynergy.technicalRequirement')" prop="techRequire">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('qualitySynergy.technicalRequirement') }}</span>
                          <!-- 1.暂定工期/交货期:
                            2.填写提示：需要写明项目的核心要求。
                            ① 若为设备类项目需要填写设备的核心参数
                            ② 若为服务类项目需要供应商具备的能力等
                          ...
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.technicalRequirement')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col :init-col="1">
                    <!-- 资质要求 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.qualificationRequire')" prop="vendorQualificationRequire">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('cusEntry.supplement20250121.qualificationRequire') }}</span>
                          <!-- 
                            如基建类资质 注册资金：填写提示：资质要求必须符合项目实际背景，禁止过度要求或无理要求
                            招标公告内容不得将投标人的资产总额、营业收入、利润、纳税额等规模条件作为资格要求或者评审因素；
                            如需签订保密协议，在此处进行体现“该项目需要签订保密协议后方可发放招标文件”，并将保密协议模板传至附件处
                          -->
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.qualificationRequireTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
                  ...
                  <srm-col :init-col="1">
                    <!-- 业绩要求 -->
                    <el-form-item :label="$t('cusEntry.supplement20250121.performanceRequire')" prop="performanceRequire">
                      <template #label="{ column, $index }">
                        <div data-property="attributeValue" class="required-tag">
                          <span>{{ $t('cusEntry.supplement20250121.performanceRequire') }}</span>
                          <!-- 举例：
                          ...
                          <el-tooltip
                            effect="dark"
                            :content="$t('cusEntry.supplement20250121.performanceRequireTip')"
                            placement="top"
                            class="table-column-tooltip"
                          >
                            <em class="el-icon-warning tip-icon" />
              ...
              <!--附件上传-->
              <el-collapse-item
                v-if="!$attrs.params.isMobile && !['YEAR'].includes(requirementHead.requireFrom)"
              ...
              >
                <div style="display: flex">
                  ...
                  <div style="margin-left: 26px;margin-top:-14px; color:red">
                    <!-- 若有可上传：保密协议、清单明细（无价格内容、无与项目不相关插页等）、固定资产处置审批文件及物资明细表等 -->
                    <p>{{ $t('cusEntry.supplement20250121.promptTips47') }}</p>
                  </div>
                </div>
...
export default {
  ...
  data () {
    return {
      ...
      requirementHead: {
        ...
        extAppointBandReason: null,
        extAppointUnitReason: null,
        projectMonth: null,
        projectName: null,
        noReportMonthPlanReason: null,
        requireFrom: null,
        extTenderType: null,
        extInvestmentProject: null,
        orgBuName: null,
        iszhaobiao: 'N',
      ...
      activeDims: ['1', '2', '3'],
      rules: {
        orgId: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        fullName: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        phone: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        requireFrom: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        extTenderType: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        noReportMonthPlanReason: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        projectName: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        projectMonth: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        categoryName: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        requireQuantity: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        totalAmountByTenKilo: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        noPublicReason: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        projectAddress: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        prefixTechDiscussion: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        sendSouProfileEndDate: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        specialReason: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        publicEndTime: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        needPublic: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        projectOverview: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        techRequire: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        performanceRequire: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        vendorQualificationRequire: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }],
        specialSouType: [{ required: true, message: this.$t('contractMod.pleaseFillIn') }]
      },
  ...
  computed: {
    ...
    workflowBusinessId () {
      return this.Viewflag !== 'change' ? this.requirementHead.requirementHeadId : this.requirementHead.souReqHead?.changeRequirementHeadId
    },
    workflowTabDisabled () {
  ...
  methods: {
    formatDecimal(value) {
      if (value !== null && value !== undefined) {
        this.requirementHead.totalAmountByTenKilo = parseFloat(value).toFixed(2);
      }
    },
    ...
    getWorkflowBusinessVariables () {
      const procTitleObj = {
        ifBid: this.requirementHead.ifBid,
        requireFrom: this.requirementHead.requireFrom,
        requirementHeadNum: this.requirementHead.requirementHeadNum
      }
      return {
        ...procTitleObj,
        procTitleObj,
    ...
    handleExport () {
      downloadFileLinkByPost(
        ...
        // 推荐供应商导出文件.xlsx
        this.$t('cusEntry.supplement20250121.recommendSupplierFile'),
        { requirementHeadId: this.$attrs.params.row.requirementHeadId }
      ).catch(() => {
        // 导出失败！
        this.$message.error(this.$t('cusEntry.supplement20250121.exportFailed'))
      })
    },
    downLoadFile () {
      downloadFileLink(
        ...
        // 板块接口人名单.xlsx
        this.$t('cusEntry.supplement20250121.interfacePersonList')
      ).catch(() => {
    ...
    handleEmailBlur (index, row) {
      ...
      if (!bool && row.email) {
        // 第${index + 1}行邮箱格式错误，请修改
        this.$message.warning(this.$t('cusEntry.supplement20250121.promptTips48', { index: (index + 1) }))
        return false
      } else {
        return true
      }
    ...
    handlePhoneBlur (index, row, type) {
      ...
      if (!bool && row.phone) {
        if (type) {
          // 技术专家联系方式格式错误，请修改
          this.$message.warning(this.$t('cusEntry.supplement20250121.promptTips49'))
        } else {
          // 第${index + 1}行联系方式格式错误，请修改
          this.$message.warning(this.$t('cusEntry.supplement20250121.promptTips50', { index: (index + 1) }))
        }
        return false
      } else {
        return true
    ...
    handleTypeChange2 (val) {
      ...
      // 特殊招标设置默认值为空
      if (val === 'SPECIAL_SOU') {
        this.requirementHead.techRequire = '-'
        this.requirementHead.projectOverview = '-'
        this.requirementHead.vendorQualificationRequire = '-'
        this.requirementHead.performanceRequire = '-'
      } else if (val == 'YEAR') {
        let obj = {
          requireQuantity: null,
          totalAmountByTenKilo: null,
          ...
          sendSouProfileEndDate: null,
          ifAppointBrand: null,
          extAppointBandReason: '',
          ifQualifyUnit: null,
          extAppointUnitReason: '',
          planNo: null,
          specialSouType: null,
          specialReason: null,
          requireProductDate: null,
          ...
          requireProductFileName: null,
          deliveryDay: null,
          deliveryDayFileId: null,
          deliveryDayFileName: null,
          signContractDay: null,
          putIntoUseDate: null,
          putIntoUseDateFileId: null,
          putIntoUseDateFileName: null,
          remainingDay: null,
          afterTotalAmountByTenKilo: null,
          changeReason: null,
          otherSpecialReason: null,
          projectOverview: '',
          techRequire: '',
          vendorQualificationRequire: '',
          performanceRequire: ''
        }
        this.requireGroup = []
        this.requirementHead = Object.assign({}, this.requirementHead, obj)
      }
    ...
    async getVendorObj (val) {
      if (val) {
        const response = await getContactInfoByCompanyId(val.companyId)
        this.requireGroup.push({
          vendorName: val.companyName,
          extTaxRecognizeMark: val.lcCode,
          phone: response.data[0]?.ceeaContactMethod || null,
          email: response.data[0].email || null,
          extReferrer: null,
          recommendFrom: null
        })
      }
    ...
    getUserObjNew (val, scope) {
      this.user.username = val?.expertUsername
      this.user.fullName = val?.expertFullName
      this.user.userId = val?.expertUserId
      this.user.phone = val?.phone
    },
    getPlanNo (val, scope) {
      console.log(val)
    ...
    async preNextStepHandler () { // 下一步
      ...
      if (Number(this.requirementHead.totalAmountByTenKilo || 0) > 1200000 && this.requireGroup.length < 3) {
        this.$message({
          type: 'warning',
          // 概算金额（卢布）大于1200000时至少推荐三家有效供应商，小于等于1200000时不做要求
          message: this.$t('cusEntry.supplement20250121.vendorThree')
        })
        return false
      }
      if (this.requireGroup.length > 0) {
        let bol = false
        let flag = false
        this.requireGroup.some((data, index) => {
          ...
          if (!data.vendorName || !data.phone || !data.email || !data.extReferrer || !data.recommendFrom) {
            flag = true
            return true
          }
        })
        ...
        if (flag) {
          this.$message.warning(this.$t('cusEntry.supplement20250121.tableRequirdTips'))
          return false
        }
      }
      let validFlag
      ...
      if (!phone || !fullName || phone == '' || fullName == '') {
        // 请输入技术专家信息
        this.$message.error(this.$t('cusEntry.supplement20250121.promptTips51'))
        return false
      }
      ...
      if (this.Viewflag !== 'change') {
        ...
        if (datas && datas.data.records.length) {
          ...
          const requirementHeadId = datas.data.records[0].requirementHeadId
          this.requirementHead.requirementHeadId = requirementHeadId
          this.requirementHead.requirementHeadNum = datas.data.records[0].requirementHeadNum
