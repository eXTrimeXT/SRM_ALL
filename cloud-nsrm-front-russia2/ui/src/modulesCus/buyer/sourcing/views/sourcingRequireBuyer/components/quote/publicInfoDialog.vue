<template>
  ...
  > -->
  <SrmDialog
    :title="readonly ? $t('cusEntry.supplement20250121.viewTheDetailsOfPublicAnnouncementModifications') : $t('cusEntry.supplement20250121.modifyPublicInformation') "
    size="large"
    :visible.sync="dialogVisible"
    :close-on-click-modal="false"
    append-to-body
  >
    <el-form ref="form" :model="form" :rules="formRules">
      <SrmRow>
        <SrmCol :init-col="2">
          <!-- <h4>调整前信息</h4> -->
          <h4> {{ $t("cusEntry.supplement20250121.preAdjustmentInformation") }}</h4>
        </SrmCol>
        <SrmCol :init-col="2">
          <!-- <h4>调整后信息</h4> -->
          <h4> {{ $t("cusEntry.supplement20250121.adjustedInformation") }}</h4>
        </SrmCol>
        <SrmCol :init-col="2">
          <!-- <el-form-item prop="beforeProjectName" label="项目名称"> -->
          <el-form-item prop="beforeProjectName" :label="$t('bidMod.bidingName')">
            <el-input v-model="form.beforeProjectName" disabled />
          </el-form-item>
        </SrmCol>
        <SrmCol :init-col="2">
          <!-- <el-form-item prop="afterProjectName" label="项目名称"> -->
          <el-form-item prop="afterProjectName" :label="$t('bidMod.bidingName')">
        ...
        <SrmCol :init-col="2">
          ...
          <el-form-item prop="beforeProjectScope" :label="$t('cusEntry.bidMod.bidScope')">
            <el-input
        ...
        <SrmCol :init-col="2">
          ...
          <el-form-item prop="afterProjectScope" :label="$t('cusEntry.bidMod.bidScope')">
            <el-input
        ...
        <SrmCol :init-col="2">
          ...
          <el-form-item prop="beforeTechnicalReq" :label="$t('qualitySynergy.technicalRequirement')">
            <el-input
        ...
        <SrmCol :init-col="2">
          ...
          <el-form-item prop="afterTechnicalReq" :label="$t('qualitySynergy.technicalRequirement')">
            <el-input
        ...
        <SrmCol :init-col="2">
          <!-- <el-form-item prop="beforeVendorQualReq" label="资质要求"> -->
          <el-form-item prop="beforeVendorQualReq" :label="$t('cusEntry.supplement20250121.qualificationRequirements')">
            <el-input v-model="form.beforeVendorQualReq" disabled type="textarea" :autosize="{minRows:3,maxRows:5}" />
          </el-form-item>
        </SrmCol>
        <SrmCol :init-col="2">
          <!-- <el-form-item prop="afterVendorQualReq" label="资质要求"> -->
          <el-form-item prop="afterVendorQualReq" :label="$t('cusEntry.supplement20250121.qualificationRequirements')">
            <el-input
        ...
        <SrmCol :init-col="2">
          ...
          <el-form-item prop="beforePerformanceReq" :label="$t('cusEntry.supplement20250121.performanceRequirements')">
        ...
        <SrmCol :init-col="2">
          ...
          <el-form-item prop="afterPerformanceReq" :label="$t('cusEntry.supplement20250121.performanceRequirements')">
            <el-input
        ...
        <SrmCol :init-col="1">
          ...
          <el-form-item prop="updateReason" :label="$t('cusEntry.supplement20250121.reasonForModification')">
        ...
        <SrmCol :init-col="1">
          ...
          <el-form-item prop="archiveFileId" :label="$t('cusEntry.supplement20250121.archiveAttachments_notPubliclyAvailable')">
            <SrmCommonFile
              :default-file="{
    ...
    <div class="file">
      <!-- <h4>修改公示附件</h4> -->
      <h4> {{ $t("cusEntry.supplement20250121.modifyThePublicAnnouncementAttachment") }}</h4>
      <FileDynamic
        v-if="!readonly"
        ref="sceneAttachment"
        ...
        if (valid) {
          for (let item of this.sceneFileList) {
            if (!item.fileuploadId) {
              ...
              return this.$message.warning(this.$t("cusEntry.supplement20250121.attachmentCannotBeEmpty"))
            }
          }
          let count = 0
          ...
          if (!count) {
            ...
            return this.$message.warning(this.$t("cusEntry.supplement20250121.thePublicInformationHasNotBeenModifiedAndSubmissionIsNotAllowed"))
          }
          this.$emit('confirm', {
            ...this.form,
