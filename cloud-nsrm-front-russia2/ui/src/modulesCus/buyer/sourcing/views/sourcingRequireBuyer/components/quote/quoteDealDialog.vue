<template>
  ...
  > -->
  <SrmDialog
    :title="$t('cusEntry.supplement20250121.registrationProcessing')"
    size="middle"
    :visible.sync="dialogVisible"
    :close-on-click-modal="false"
  >
    <el-form ref="form" :model="form" :rules="formRules">
      <SrmRow>
        <SrmCol :init-col="1">
          ...
          <el-form-item prop="applyHandleType" :label="$t('cusEntry.reportManagement.applyHandleType')">
            <DictSelect
        ...
        <SrmCol v-if="form.applyHandleType !== 'ALREADY_PAID'" :init-col="1">
          ...
          <el-form-item prop="applyHandleReason" :label="$t('cusEntry.reportManagement.applyHandleReason')">
