<template>
  ...
  > -->
  <SrmDialog
    :title="$t('cusEntry.supplement20250121.reasonForClosingThePublicNotice')"
    size="middle"
    :visible.sync="dialogVisible"
    :close-on-click-modal="false"
  >
    <el-form ref="form" :model="form" :rules="formRules">
      <SrmRow>
        <SrmCol :init-col="1">
          ...
          <el-form-item prop="closePublicReason" :label="$t('cusEntry.supplement20250121.reasonForClosingThePublicNotice')">
