<template>
  <SrmRow>
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('cusEntry.supplement20250121.sourceSeekingPublicityTemplate')" prop="pubconfigName">
        <!--  :pre-query-data="{
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('purchaseDemand.requirementDepartment')" prop="reqDepartment">
        <el-input v-model="baseForm.reqDepartment" disabled />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- <el-form-item label="需求人" prop="reqUserName"> -->
      <el-form-item :label="$t('cusEntry.supplement20250121.demander')" prop="reqUserName">
        <el-input v-model="baseForm.reqUserName" disabled />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- <el-form-item label="供应商专家" prop="responsibilityUserName"> -->
      <el-form-item :label="$t('cusEntry.bidSuperviseReport.vendorPrincipal')" prop="responsibilityUserName">
        <el-input v-model="baseForm.responsibilityUserName" disabled />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- <el-form-item label="招标专家" prop="souPersonUserName"> -->
      <el-form-item :label="$t('cusEntry.bidSuperviseReport.souPrincipal')" prop="souPersonUserName">
        <el-input v-model="baseForm.souPersonUserName" disabled />
      </el-form-item>
    </SrmCol>
    <SrmCol :init-col="4">
      <!-- <el-form-item label="是否前置交流" prop="isPreComm"> -->
      <el-form-item :label="$t('cusEntry.supplement20250121.isTherePreCommunication')" prop="isPreComm">
        <DictSelect
    ...
    <SrmCol :init-col="4">
      ...
      <el-form-item :label="$t('vendorMod.relegation.documentStatus')" prop="status">
        <DictSelect
    ...
    <SrmCol v-if="baseForm.status==='ABANDON'" :init-col="1">
      ...
      <el-form-item :label="$t('cusEntry.supplement20250121.abandoned')" prop="reasonDesc">
