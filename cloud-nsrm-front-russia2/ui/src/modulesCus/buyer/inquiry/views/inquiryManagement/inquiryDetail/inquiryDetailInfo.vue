  ...
  <div class="inquiry-detail-info">
    ...
    >
      <el-collapse v-model="activeDims" class="tab-form-style">
        ...
        <!--c 投标控制 5-->
        <el-collapse-item :title="$t('cusEntry.bidMod.inqControl')" name="5">
      ...
      return new Promise(resolve => {
        this.$refs.form.validate(async valid => {
          if (valid) {
            ...
            // this.__focus_error__('请检查全部必填字段是否填写正确')
            this.__focus_error__(this.$t('components.msgCompleteAllFields'))
            resolve(false)
          }
        })
      })
