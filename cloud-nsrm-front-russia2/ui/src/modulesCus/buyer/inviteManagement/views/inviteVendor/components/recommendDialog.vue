...
<!-- <SrmDialog
  ...
  >
    ...
    >
      ...
      <el-form-item prop="categoryName" :label="$t('dataConfMod.selectCategory')">
        <CCategorySelect
  ...
  data () {
    return {
      ...
      rules: {
        ...
        categoryName: [{ required: true, message: this.$t("common.requiredField"), trigger: 'change' }]
      }
    }
  },
  computed: {
