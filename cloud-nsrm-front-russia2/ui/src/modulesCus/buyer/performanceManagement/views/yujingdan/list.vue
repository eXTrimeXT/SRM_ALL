...
export default {
  ...
  data () {
    return {
      ...
      isModify: false,
      preArr: [
        { prop: 'warningCode', label: this.$t('cusEntry.supplement20250205.warningOrderNumber') },  // '预警单号'
        { prop: 'companyName', label: this.$t('common.companyName') },  // '供应商名称'
        {
          prop: 'perfModelType',
          label: this.$t('cusEntry.supplement20250205.alertType'),  // '预警类型'
          type: 'dict', // 字典类型
        ...
        { prop: 'contractManagerFullPath', label: this.$t('cusEntry.supplement20250205.contractHandlerDepartment') }  // '合同经办人部门'
      ],
      queryParam: {},
      pubRangeList: [],
      projectTypeList: []
  ...
  mounted () {
    ...
    this.buyerTableHeader = [
      {
        prop: 'warningCode',
        label: this.$t('cusEntry.supplement20250205.warningOrderNumber'),  // '预警单号'
        minWidth: 150,
        showType: 'button',
        btnStyle: 'text',
      ...
      { prop: "bidManager", label: this.$t('cusEntry.bidSuperviseReport.souPrincipal'), width: 120 },  // '招标专家'
      { prop: "bidManagerFullPath", label: this.$t('cusEntry.supplement20250205.bidExpertCompanyDept'), width: 120 },  // '招标专家公司部门'
      { prop: "contractManager", label:this.$t('cusEntry.supplement20250205.contractManager'), width: 120 },  // '合同经办人'
      { prop: "contractManagerFullPath", label:this.$t('cusEntry.supplement20250205.contractHandlerCompanyDepartment'), width: 120 }, // '合同经办人公司部门'
      {
        prop: "createdBy",
      ...
      {
        prop: 'readStatus',
        label: this.$t('cusEntry.supplement20250205.checkStatus'), // '查看状态'
        width: 100,
        dataType: 'dict', // 数据类型为字典
      ...
      },
      {
        ...
        buttons: [
          ...
          },
          {
            ...
            formattor (val) {
              return this.$t('components.common.delete')  // '删除'
            },
            show: function (row) {
              // 拟定和撤回的单据可以编辑
              if (row.warningStatus === 'DRAFT' && _this.$store.getters.userType == 'BUYER') {
    ...
    this.suplierTableHeader = [
      ...
      { prop: "createdBy", label:this.$t('common.creator'), width: 120 },  // '创建人'
      {
        prop: 'readStatus',
        label: this.$t('cusEntry.supplement20250205.checkStatus'),  // '查看状态'
        width: 100,
  ...
  methods: {
    ...
    addOne () {
      this.$emit('tab-add', {
        ...
        title: this.$t('cusEntry.supplement20250205.addWarningOrder'),  // '新增预警单'
    ...
    delRowData (row) {
      console.log(row)
      // '确认删除该单据'
      this.$confirm(this.$t('cusEntry.supplement20250205.confirmDeleteThisDocument'), {
