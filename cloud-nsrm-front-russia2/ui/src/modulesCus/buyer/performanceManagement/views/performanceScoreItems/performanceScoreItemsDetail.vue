              ...
              <el-collapse v-model="activeDims" class="tab-form-style">
                ...
                <el-collapse-item ref="projectInfo" :title="$t('perfMod.projectInformation')" name="1">
                  <srm-row>
                    ...
                    <srm-col>
                      <!-- 评分结束时间 -->
                      <el-form-item :label="$t('cusEntry.supplement20250205.scoreEndTime')" prop="scoreEndTime">
                        <el-date-picker
                    ...
                    <srm-col>
                      <!-- 创建人部门 -->
                      <el-form-item :label="$t('cusEntry.supplement20250205.creatorDepartment')" prop="fullPathId">
  ...
  data () {
    return {
      ...
      rules: {
        ...
        templateHeadId: [{ required: true, message: this.$t('perfMod.selectPerformanceModel') }],
        perStartMonth: [{ required: true, message: this.$t('perfMod.performanceStartMonth') }],
        perEndMonth: [{ required: true, message: this.$t('perfMod.performanceEndMonth') }],
        scoreStartTime: [{ required: true, message: this.$t('perfMod.gradingStartTime') }],
        scoreEndTime: [{ required: true, message: this.$t('perfMod.gradingEndTime') }]
      },
