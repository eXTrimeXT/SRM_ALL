...
export default {
  ...
  data () {
    return {
      ...
      preArr: [
        ...
        {
          prop: 'approveStatus',
          label: this.$t('common.approvalStatus'), // 项目状态  '审批状态'
          type: 'dict', // 字典类型
  ...
  created () {
    ...
    this.tableHeader = [
      ...
      { prop: 'contractNo', label: this.$t('bidMod.category_contractCode'), width: 120 },  // '合同编码'
      { prop: 'contractName', label: this.$t('vendorMod.contractName'), width: 120 },  // '合同名称'
      { prop: 'categoryName', label: this.$t('common.category'), width: 120 },  // '品类'
      {
        prop: 'performanceCode',
        label: this.$t('cusEntry.supplement20250121.performanceStage'),  // '履约阶段'
        width: 120,
      ...
      { prop: 'scoreManName', label: this.$t('vendorMod.reviewPerson'), width: 120 },  // '评分人'
      {
        prop: 'perStartMonth',
      ...
      {
        prop: 'perEndMonth',
        label: this.$t('cusEntry.supplement20250205.scoreEndTime'),  // '评分结束时间'
        width: 120
      },
      {
        prop: 'scoreDate',
        label: this.$t('cusEntry.supplement20250205.actualRatingTime'),  // '实际评分时间'
        width: 120,
        dataType: 'dateTime'
      },
      {
        ...
        buttons: [
          {
            ...
            formattor (val) {
              return this.$t('bidMod.score1')  // '评分'
            },
            show: function (row) {
              // 拟定和撤回的单据可以编辑
