...
export default {
  ...
  data () {
    return {
      ...
      isModify: false,
      preArr: [
        { prop: 'projectName', label: this.$t('perfMod.projectName2') },
        {
        ...
        {
          prop: 'status',
          label: this.$t('cusEntry.supplement20250205.reviewStatus'),
          type: 'dict', // 字典类型
        ...
        buttons: [
          {
            ...
            formattor (val) {
              // 复核
              return this.$t('cusEntry.supplement20250205.reviewCheck')
            },
            show: function (row) {
              if (
