...
export const pdcaPage = {
  ...
  pcdaPageCondition: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcPdcaRecordBuyer/pageCondition'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  saveOrUpdate: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcPdcaRecordBuyer/update'),
      method: 'POST',
      data,
      loading: true
    })
...
export const qualityProject = {
  ...
  pageCondition: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcMonitorListBuyer/pageCondition'),
      method: 'POST',
      data
    }),
  // 项目管理列表
  ...
  addMonitors: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcMonitorListBuyer/save'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  deleteMonitors: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcMonitorListBuyer/delete'),
      method: 'POST',
      data,
      loading: true
    }),
  // 失效
  stopMonitors: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcMonitorListBuyer/inValidMonitorList'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  // 判异规则保存
  saveMonitorSpcParam: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcRuleParam/save'),
      method: 'POST',
      data,
      loading: true
    })
...
export const spcData = {
  ...
  historyPageCondition: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcDataInputBuyer/historyPageCondition'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  historyGraphDatas: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcDataInputBuyer/historyGraphDatas'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  historyAnalysisDatas: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcDataInputBuyer/historyAnalysisDatas'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  historyAnalysisDatasFromIds: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcDataInputBuyer/historyAnalysisDatasFromIds'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  spcInputAdd: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcDataInputBuyer/add'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  spcListPageData: async data =>
    http({
      url: getUrl('/api-qc/api-ql/spcDataInputBuyer/inputPageAnalysisData'),
      method: 'POST',
      data,
      loading: true
    })
...
export const spcStandard = {
  ...
  spcStandardAdd: async data =>
    http({
      url: getUrl('/api-qc/api-ql/SpcRuleStandardBuyer/create'),
      method: 'POST',
      data,
      loading: true
    }),
  ...
  spcStandardModify: async data =>
    http({
      url: getUrl('/api-qc/api-ql/SpcRuleStandardBuyer/update'),
      method: 'POST',
      data,
      loading: true
    }),
  // spc标准数据生效
  spcStandardValid: async data =>
    http({
      url: getUrl('/api-qc/api-ql/SpcRuleStandardBuyer/validRuleStandard'),
      method: 'POST',
      data,
      loading: true
    }),
  // spc标准数据失效
  spcStandardInvalid: async data =>
    http({
      url: getUrl('/api-qc/api-ql/SpcRuleStandardBuyer/inValidRuleStandard'),
      method: 'POST',
      data,
      loading: true
    })
