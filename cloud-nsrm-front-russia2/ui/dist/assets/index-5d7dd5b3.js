import{N as NavTabs}from"./index-9a7f2446.js";import{ad as expression,ae as i18nExpression,af as yearMonthDaySelectorSegment,aD as requiredValidatorSegment,ah as generateXindexInOrder,ak as defineComponent,al as usePageHelper,aq as defineSchemas,bS as exportExcelSegment,bT as queryFieldStatePropertyExpression,bD as changeFieldVisibleByDeps,ar as RenderEngine,at as DictSelect,n as normalizeComponent}from"./index-6b6051d8.js";import{D as DialogMainCategory,s as sitereviewplanconfirmEdit}from"./edit-engine-d56bd3cf.js";import{s as siteAssessmentDetail}from"./siteAssessmentDetailEngine-70d606b9.js";import"./supApi-98b2a23d.js";import"./vendorAccessAttachment-04264be9.js";/* empty css                                                                          */import"./vendorManagement-b6129894.js";import"./index-2c71d18e.js";/* empty css                                              */import"./printer-c24f03b5.js";const DialogMain={type:"void","x-query-engine":{service:"sup",type:"SiteReviewPlan",actions:{save:{cascadeDeletion:!0}}},"x-component":"QueryEngine",properties:{Dialog:{type:"void",title:"{{$t('vendorMod.detail')}}","x-component":"RDialog","x-component-props":{class:"dialogMain",size:"large",cancelText:'{{ $t("common.staging") }}',okText:'{{ $t("common.submit") }}',beforeClose:expression(`(done, type,closeLoading) => {
            ...
            if ( type === 'ok') {
              ...
              }`)},"x-render-table-column":{width:130}},planStartDate:{title:"{{$t('vendorMod.planStartDate')}}",...yearMonthDaySelectorSegment,"x-component-props":{...yearMonthDaySelectorSegment["x-component-props"],formatter:expression(`({ cellValue, row, column }) => {
