import{N as NavTabs}from"./index-9a7f2446.js";import{ad as expression,ae as i18nExpression,af as yearMonthDaySelectorSegment,ag as radioGroupByYOrNSegment,ah as generateXindexInOrder,ai as editTableFormItemValid,aj as feedbackLayoutIsPopover,ak as defineComponent,al as usePageHelper,am as useAttrs,an as ref$1,ao as useAutoMountInstanceToField,ap as h,bY as computed,aq as defineSchemas,ar as RenderEngine,as as performPlanService,at as DictSelect,au as observer,v as validEmail,a as validatePhone,av as CommonFile,a6 as CCategorySelect,n as normalizeComponent,b$ as dataTimeSelectorSegment,bD as changeFieldVisibleByDeps}from"./index-6b6051d8.js";import{C as CAddress}from"./index-baa5f2f5.js";import{F as FileDynamic}from"./file-dynamic-25a093c4.js";import{C as CFillProgress}from"./index-2c71d18e.js";/* empty css                                                              */import"./file-dynamic-7fc2d358.js";import"./MainHeader-2d842985.js";/* empty css                                                                   */import"./file-dynamic.vue_vue_type_style_index_0_scoped_516fdfc3_lang-f2c1a82d.js";import"./tree-utils-7df6be59.js";import"./basicSetting-fc46a2d9.js";import"./BaseTableBind-b1f76fc9.js";import"./util-1e55288f.js";import"./index-4d512f00.js";/* empty css                                                                      */import"./fileApi-05bbbbcc.js";/* empty css                                              */const Steps={steps:{type:"void","x-decorator":"div","x-decorator-props":{class:"stepDiv"},"x-component":"Steps","x-component-props":{alignCenter:!0,finishStatus:"success"},"x-reactions":{dependencies:["status"],fulfill:{state:{"component[1].active":expression(`
          ...
          `)}}},properties:{step1:{type:"void","x-component":"el-step","x-component-props":{title:expression("$t('vendorMod.finishCompanyInfo')")}},step2:{type:"void","x-component":"el-step","x-component-props":{title:expression("$t('common.successSubmit')")}},step3:{type:"void","x-component":"el-step","x-component-props":{title:expression("$t('vendorMod.approvalSuccess')")}}}}},userInfoForm={userInfoForm:{type:"void","x-component":"CollapseItem","x-component-props":{title:i18nExpression("vendorMod.vendorUserInfo")},"x-query-engine-skip":!0,properties:{userInfo:{type:"object","x-decorator":"FormLayout","x-decorator-props":{layout:"vertical"},"x-component":"FormGrid","x-component-props":{maxColumns:3,columnGap:32,rowGap:0},"x-query-engine-skip":!0,properties:{username:{type:"string","x-decorator":"FormItem","x-component":"Input",title:expression("$t('vendorMod.userName')"),"x-component-props":{disabled:expression("$disabled"),placeholder:i18nExpression("userInfo.onlyNumOrEn"),"@change":expression(`() => {
                              ...
                              }`)},"x-validator":{required:!0,message:i18nExpression("vendorMod.enterUserName")}},nickname:{type:"string","x-decorator":"FormItem","x-component":"Input",title:expression("$t('dataConfMod.userName')"),"x-component-props":{disabled:expression("$disabled")},"x-validator":{required:!0,message:i18nExpression("vendorMod.msgInputNickname")}},email:{type:"string","x-decorator":"FormItem","x-component":"Input",title:expression("$t('common.email')"),"x-component-props":{disabled:expression("$disabled")},"x-validator":{required:!0,message:i18nExpression("vendorMod.pleaseInputEmail"),validator:expression(`(value, rule) => {
                if(value && !validEmail(value)){
                  return ${i18nExpression("vendorMod.correctEmail")}
                }
              }`)}},phone:{type:"string","x-decorator":"FormItem","x-component":"Input",title:expression("$t('vendorMod.contactPhone')"),"x-component-props":{disabled:expression("$disabled")},"x-validator":{required:!0,message:i18nExpression("cusEntry.supplement20250211.contactPhoneInput"),validator:expression(`(value, rule) => {
                if(value && !validatePhone(value)){
                  return ${i18nExpression("vendorMod.correctPhoneNumber")}
                }
            ...
            `)},"x-validator":{required:expression("!['GETI','FEIYINGLI'].includes($form.query('.companyType').take().value)"),message:i18nExpression("vendorMod.msgRegisteredCapital")}},companyCreationDate:{...yearMonthDaySelectorSegment,"x-decorator":"FormItem","x-component-props":{...yearMonthDaySelectorSegment["x-component-props"],"value-format":"yyyy-MM-dd",disabled:expression("$disabled")},title:expression("$t('vendorMod.creationDate')"),"x-validator":{required:expression("!['FEIYINGLI'].includes($form.query('.companyType').take().value)"),message:i18nExpression("vendorMod.msgCreationDate")}},businessStartDate:{type:"date","x-hidden":!0},businessEndDate:{type:"date","x-hidden":!0},businessDate:{type:"string","x-component":"DatePicker","x-decorator":"FormItem","x-component-props":{...yearMonthDaySelectorSegment["x-component-props"],type:"daterange",disabled:expression("$disabled")},title:expression("$t('vendorMod.dateBusiness')"),"x-validator":{required:expression("!['FEIYINGLI'].includes($form.query('.companyType').take().value)"),message:i18nExpression("vendorMod.msgCreationDate")}},companyShortName:{type:"string","x-decorator":"FormItem","x-component":"Input",title:expression("$t('vendorMod.companyShortName')"),"x-component-props":{disabled:expression("$disabled")}},registrationAuthority:{type:"string","x-decorator":"FormItem","x-component":"Input",title:expression("$t('vendorMod.registrationAuthority')"),"x-component-props":{disabled:expression("$disabled")}},businessScope:{type:"string","x-decorator":"FormItem","x-component":"Input",title:expression("$t('vendorMod.businessScope')"),"x-component-props":{disabled:expression("$disabled"),type:"textarea"}}}}}}}}},companyBaseInfo={companyBaseInfo:{type:"void","x-component":"CollapseItem","x-component-props":{title:i18nExpression("vendorMod.companyBaseInfo")},"x-query-engine-skip":!0,properties:{layout:{type:"void","x-decorator":"FormLayout","x-decorator-props":{layout:"vertical"},"x-component":"FormGrid","x-component-props":{maxColumns:3,columnGap:32,rowGap:0},properties:{ceeaAgentBrand:{type:"string","x-decorator":"FormItem","x-component":"Input",title:expression("$t('vendorMod.agencyBrand')"),"x-component-props":{disabled:expression("$disabled")},"x-validator":{required:!1,message:i18nExpression("vendorMod.msgAgencyBrand")}},categoryName:{type:"string","x-hidden":!0},cateJournalList:{type:"Array","x-hidden":!0},cateJournalListAll:{type:"Array","x-decorator":"FormItem","x-component":"CCategorySelect",title:expression("$t('vendorMod.mainCategory')"),"x-query-engine-skip":!0,"x-component-props":{disabled:expression("$disabled"),"select-type":"input",class:"categoryName",multiple:!0,"selected-lines":expression("$form.query('.cateJournalList').take().value"),placeholder:expression("$form.query('.categoryName').take().value"),"@select":expression(`(val) => {
              ...
              }`)},"x-validator":{required:!1,message:i18nExpression("vendorMod.msgAgencyBrand")}},ceeaIfListed:{title:i18nExpression("vendorMod.ifListed"),...radioGroupByYOrNSegment,"x-component-props":{disabled:expression("$disabled")}},ceeaListedTime:{...yearMonthDaySelectorSegment,"x-visible":"{{$form.query('.ceeaIfListed').take().value == 'Y'}}","x-decorator":"FormItem","x-component-props":{...yearMonthDaySelectorSegment["x-component-props"],disabled:expression("$disabled")},title:expression("$t('vendorMod.listedDate')"),"x-validator":{required:!0,message:i18nExpression("请选择上市时间")}},listedExchange:{type:"string","x-visible":"{{$form.query('.ceeaIfListed').take().value == 'Y'}}","x-decorator":"FormItem","x-component-props":{disabled:expression("$disabled")},title:expression("$t('vendorMod.listedExchange')"),"x-validator":{required:!0,message:i18nExpression("请选择上市交易所")}},ceeaBusinessModel:{type:"string","x-decorator":"FormItem","x-component":"DictSelect","x-component-props":{disabled:expression("$disabled"),code:"BIZ_MODEL"},title:expression("$t('vendorMod.bizModel')")},companyCountry:{type:"string",title:i18nExpression("components.address.country"),"x-decorator":"FormItem","x-component":"DictSelect","x-component-props":{code:"country",placeholder:expression("$t('common.pleaseSelect')"),disabled:expression("$disabled"),"@change":expression(`(val) => {
                let row = $form.values
                // 选择国外就清理省市区，并且禁用
