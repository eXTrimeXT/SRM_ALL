import{N as NavTabs}from"./index-9a7f2446.js";import{ae as i18nExpression,ad as expression,af as yearMonthDaySelectorSegment,n as normalizeComponent,ak as defineComponent,al as usePageHelper,am as useAttrs,an as ref$1,ao as useAutoMountInstanceToField,ap as h,aq as defineSchemas,ah as generateXindexInOrder,ar as RenderEngine,bD as changeFieldVisibleByDeps}from"./index-6b6051d8.js";import{a as blackComApi}from"./black-6d4b8132.js";import{o as orgCatForm}from"./supApi-98b2a23d.js";const forms={vendorId:{type:"string","x-decorator":"FormItem","x-hidden":!0},vendorCode:{type:"string","x-decorator":"FormItem","x-hidden":!0},vendorName:{type:"string",title:i18nExpression("common.vendorName"),"x-decorator":"FormItem","x-component":"QuickSearchWrapper","x-component-props":{readPretty:"{{$form.readPretty}}",showKey:"vendorName",propKey:"vendorName",name:"scc_sup_company_info2","@close-quicksearch":expression(`async (val) => {
          if (val) {
