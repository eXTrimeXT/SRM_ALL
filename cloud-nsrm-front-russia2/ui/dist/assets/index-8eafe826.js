import{N as NavTabs}from"./index-9a7f2446.js";import{ah as generateXindexInOrder,cf as formGridSegment,ad as expression,ae as i18nExpression,af as yearMonthDaySelectorSegment,ak as defineComponent,al as usePageHelper,am as useAttrs,an as ref$1,bY as computed,ar as RenderEngine,aq as defineSchemas,n as normalizeComponent,cl as onActivated,c0 as queryFieldValueExpression,bT as queryFieldStatePropertyExpression,bD as changeFieldVisibleByDeps,at as DictSelect}from"./index-6b6051d8.js";import{s as supCommonApi}from"./supApi-98b2a23d.js";const DialogMainCategory={type:"void",title:"{{$t('dataConfMod.categoryDetails')}}","x-decorator":"QueryEngine","x-component":"RDialog","x-component-props":{class:"dialogMain",size:"middle",footer:!1},properties:{categoryList:{type:"array","x-component":"RenderTable","x-component-props":{style:"height:250px",preColumns:"seq",pagination:!1},"x-query-engine-skip":!0,properties:generateXindexInOrder({categoryCode:{type:"string",title:"{{$t('common.categoryCode')}}","x-component":"QuickSearchWrapper","x-component-props":{disabled:!0,showKey:"companyName",propKey:"companyName",name:"scc_base_purchase_category2"},"x-render-table-column":{minWidth:150,skipEditable:!0}},categoryName:{type:"string",title:"{{$t('common.categoryName')}}","x-render-table-column":{minWidth:120,skipEditable:!0}}})}}},formMain={type:"void",...formGridSegment,"x-reactions":expression(`() => {
    setTimeout(() => {
      ...
      $self.form.setValues(datas)
              ...
              supCommonApi.findCategory(val.vendorId).then(res => {
                ...
                $form.query('.tableAddress').take().setValue(obj)
                  ...
                  }`)}},userName:{type:"string",title:i18nExpression("vendorMod.userName2"),"x-render-table-column":{minWidth:100,skipEditable:!0}},userTel:{type:"string",title:i18nExpression("vendorMod.mobilePhone"),"x-render-table-column":{minWidth:100,skipEditable:!0}},userEmail:{type:"string",title:i18nExpression("vendorMod.emailAddress"),"x-render-table-column":{minWidth:100,skipEditable:!0}},userPost:{type:"string",title:i18nExpression("bidMod.position"),"x-component-props":{disabled:"{{$form.readPretty}}"},"x-render-table-column":{minWidth:100}},onSiteFlag:{type:"string",title:i18nExpression("vendorMod.onSiteFlag"),"x-component":"Checkbox","x-component-props":{"true-label":"Y","false-label":"N",disabled:"{{$form.readPretty}}"},"x-render-table-column":{minWidth:100}},operation:{type:"void",title:"{{$t('common.operation')}}","x-render-table-column":{width:150,fixed:"right"},"x-component":"RenderTableButtonList",properties:{delete:{type:"void",title:"{{$t('common.delete')}}","x-component-props":{type:"text","@click":expression(`({ row }) => {
                        $table.remove($self.index)
                      }`)}}}}})}}},visitingAddress:{type:"void","x-component":"CollapseItem","x-component-props":{title:expression('$t("vendorMod.visitingAddress")')},"x-query-engine-skip":!0,properties:{toolbar:{type:"void","x-component":"ButtonList","x-component-props":{class:"list-form__toolbar"},properties:{add:{type:"void",title:i18nExpression("common.add"),"x-hidden":"{{$form.readPretty}}","x-component-props":{type:"primary","@click":expression('({ rowIndex }) => $form.query(".tableAddress").take().componentProps.componentInstance.addRow("unshift")')}}}},tableAddress:{type:"array","x-component":"RenderTable","x-component-props":{preColumns:"seq",class:"table-view-vxe-table",editMode:"multi-row"},"x-query-engine-skip":!0,"x-query-engine-relation":"siteReviewPlanConfirmAddress:*",properties:generateXindexInOrder({country:{type:"string",title:i18nExpression("components.address.country"),"x-component":"DictSelect","x-component-props":{disabled:"{{$form.readPretty}}",code:"country",filterable:!0,"@change-value":expression(`(_, node) => {
                    const row = $table.getRowByIndex($self.index)
                    // 选择国外就清理省市区，并且禁用
                      if (row.country !== 'CN') {
                        row.province = null
                        ...
                        $table.remove($self.index)
                      }`)}}}}})}}}})},_sfc_main$2=defineComponent({__name:"edit-engine",setup(__props){const{app,emitTabRemove,t,vendor}=usePageHelper(),attrs=useAttrs(),workflowStatus=ref$1("DRAFT"),$disabledFlag=computed(()=>!0),customUpdateButton=computed(()=>!$disabledFlag.value&&["SUPPLIER_SUBMITTED"].includes(workflowStatus.value)),viewUpdateButton=()=>{const flag=attrs.params.flag,readOnly=attrs.params.readOnly;return flag=="approve"||!readOnly},disabledUpdateButton=()=>!attrs.params.readOnly,initButtonConfig=$form=>{setTimeout(()=>{const componentInstance=$form.query(".SchemaWorkflow").take().componentProps.componentInstance;componentInstance.buttonConfigInfo.save.view=viewUpdateButton(),componentInstance.buttonConfigInfo.submit.view=viewUpdateButton(),componentInstance.buttonConfigInfo.cancel.view=!0,componentInstance.buttonConfigInfo.close.view=!1;const approveStatus=attrs.params.row?.approveStatus||null;[null,"DRAFT"].includes(approveStatus)&&(componentInstance.buttonConfigInfo.save.name=t("common.staging"),componentInstance.buttonConfigInfo.submit.name=t("common.submit"))},50)},updateButtonConfig=$form=>{setTimeout(()=>{const componentInstance=$form.query(".SchemaWorkflow").take().componentProps.componentInstance;componentInstance.buttonConfigInfo.save.view=disabledUpdateButton(),componentInstance.buttonConfigInfo.submit.view=disabledUpdateButton(),componentInstance.buttonConfigInfo.cancel.view=!1,componentInstance.buttonConfigInfo.close.view=!1},50)},schema=defineSchemas({SiteReviewPlanConfirm:{type:"void","x-decorator":"QueryEngine","x-component":"el-container","x-component-props":{class:"flex-container siteReviewPlanConfirm",direction:"vertical"},"x-query-engine":{service:"sup",actions:{query:{immediate:!0,ready:expression(`() => {
          ...
          }`)},properties:{layout:{type:"void","x-component":"FormContainer",properties:{form:{...formMain},layout:{type:"void","x-component":"FormContainer",properties:{collapse:{...collapseMain}}}}}}}}}}),$back=$bus=>{emitTabRemove(attrs.tabName),$bus.$emit("ModelHead")},$submits=(type,$form,$queryEngine,$message,$t,$bus)=>{let values=$form.values;const tableAddress=$form.query(".tableAddress").get("value"),tableStaff=$form.query(".tableStaff").get("value");values.siteReviewPlanConfirmAddress=tableAddress,values.siteReviewPlanConfirmPersons=tableStaff;const planConfirmId=attrs.params.row?.planConfirmId||null;type=="SAVE"?[null,"DRAFT"].includes(planConfirmId)?(values.approveStatus="DRAFT",$queryEngine.request.save(values,{query:{"*":{}}}).then(()=>{$message.success($t("common.successSave"))})):$queryEngine.request.save(values,{query:{"*":{}}}).then(()=>{$message.success($t("common.successSave"))}):[null,"DRAFT"].includes(planConfirmId)?(values.approveStatus="RELEASED",$queryEngine.request.save(values,{query:{"*":{}}}).then(()=>{$message.success($t("common.successSubmit"))})):$queryEngine.request.save(values,{query:{"*":{}}}).then(res=>{const componentInstance=$form.query(".SchemaWorkflow").take().componentProps.componentInstance;componentInstance.setWorkflowBusinessId(res.data[0]?.planConfirmId||null),componentInstance.setWorkflowTabDisabled(!0),componentInstance.setWorkflowBusinessVariables({}),componentInstance.handlerAfter(type.toUpperCase(),()=>{$bus.$emit("SiteReviewPlanConfirm")})})};return{__sfc:!0,app,emitTabRemove,t,vendor,attrs,workflowStatus,$disabledFlag,customUpdateButton,viewUpdateButton,disabledUpdateButton,initButtonConfig,updateButtonConfig,schema,$back,$submits,scope:{app,t,$attrs:attrs,$disabledFlag,emitTabRemove,initButtonConfig,$back,supCommonApi,$submits},components:{},RenderEngine}}});var _sfc_render$2=function(){var _vm=this,_c=_vm._self._c,_setup=_vm._self._setupProxy;return _c(_setup.RenderEngine,{attrs:{schemaKey:"vendorSiteReviewPlanConfirmDetail",pageAttrs:_vm.$attrs,schema:_setup.schema,scope:_setup.scope,components:_setup.components}})},_sfc_staticRenderFns$2=[],__component__$2=normalizeComponent(_sfc_main$2,_sfc_render$2,_sfc_staticRenderFns$2,!1,null,null,null,null);const sitereviewplanconfirmEdit=__component__$2.exports,_sfc_main$1=defineComponent({__name:"list-engine",setup(__props){const{emitTabAdd,app}=usePageHelper();onActivated(()=>{if(app.$route.params.from==="fromFun"&&app.$route?.params.taskIndex===2){let row={planConfirmId:app.$route?.params?.formId,planConfirmCode:app.$route?.params?.formNo};const tab={component:sitereviewplanconfirmEdit,params:{readOnly:!0,row,flag:"view"},title:row.planConfirmCode,name:"sitereviewplanconfirmEdit"+row.planConfirmId};emitTabAdd(tab)}});const schema=defineSchemas({SiteReviewPlanConfirm:{type:"void","x-query-engine":{service:"sup",actions:{paginationQuery:{transformRequest:expression(`(data, headers) => {
              data.query = {
                '*': {}
              }
              return data
            ...
            $queryEngine.state.paginationManagement.refresh()
          }`)}},query:{type:"object","x-query-engine-skip":!0,"x-component":"QueryFormByQueryEngine","x-component-props":{immediateQueryForm:!0},properties:generateXindexInOrder({planName:{type:"string",title:"{{$t('vendorMod.planName')}}"},planType:{type:"string",title:"{{$t('vendorMod.planType')}}","x-component":"DictSelect","x-component-props":{code:"planType"}},categoryCode:{type:"string",title:"{{$t('common.categoryName')}}","x-component":"QuickSearchWrapper","x-component-props":{showKey:"categoryName",propKey:"categoryCode",name:"scc_base_purchase_category2"}},orgId:{type:"string",title:"{{$t('vendorMod.orgId')}}","x-component":"OrganizationSelector","x-component-props":{multiple:!1}},planConfirmCode:{type:"string",title:"{{$t('vendorMod.planCode')}}","x-query-engine-query-operator":"contains","x-reactions":{effects:["onFieldInit"],fulfill:{state:{value:expression("app.$route?.params.from === 'fromFun' && app.$route?.params.taskIndex === 1 ? app.$route?.params?.formNo : ''")}}}}})},toolbar:{type:"void","x-component":"Space","x-component-props":{style:"margin-bottom: 16px"},properties:{exportExcel:{type:"void","x-component":"ExportExcel","x-component-props":{type:"default",pageUrl:"/api-sup/sup/sitereviewplanconfirm/listPage",exportMode:"front",filterParams:queryFieldValueExpression("query"),tableHeader:queryFieldStatePropertyExpression("SiteReviewPlanConfirm.table","data.columns"),dictCodes:{planType:"planType",approveStatus:"approveStatus"}}}}},table:{type:"array","x-component":"RenderTable","x-component-props":{preColumns:"seq",class:"table-view-vxe-table",openCustomTable:!0,editMode:"multi-row"},properties:generateXindexInOrder({creationDate:{type:"string","x-hidden":!0,"x-query-engine-sort":"desc"},planConfirmId:{type:"string","x-hidden":!0},orgName:{type:"string","x-query-engine-skip":!0,title:"{{$t('vendorMod.orgName')}}","x-render-table-column":{width:100,skipEditable:!0}},categoryName:{title:"{{$t('vendorMod.viewCategory')}}","x-component":"TableButton","x-query-engine-skip":!0,"x-component-props":{type:"text","@click":expression(`({row}) => {
              ...
              }`)},"x-render-table-column":{title:i18nExpression("vendorMod.categoryName"),minWidth:100,skipEditable:!0,customRender:!0}},planType:{type:"string","x-query-engine-skip":!0,title:"{{$t('vendorMod.planType')}}","x-component":"DictSelect","x-component-props":{code:"planType"},"x-render-table-column":{width:100,skipEditable:!0}},planName:{type:"string",title:"{{$t('vendorMod.planName3')}}","x-render-table-column":{width:100,skipEditable:!0}},personList:{title:"{{$t('vendorMod.check')}}","x-component":"TableButton","x-query-engine-skip":!0,"x-component-props":{type:"text","@click":expression(`({row}) => {
                  const tab = {
            ...
            }`)},planSetOutTime:{title:"{{$t('vendorMod.planSetOutTime')}}",...yearMonthDaySelectorSegment,"x-component-props":{...yearMonthDaySelectorSegment["x-component-props"],formatter:expression(`({ cellValue, row, column }) => {
                parseTime(row.planSetOutTime, '{y}-{m}-{d}')
              }`)},"x-render-table-column":{width:130,skipEditable:!0}},planVisitTime:{title:"{{$t('vendorMod.planVisitTime')}}",...yearMonthDaySelectorSegment,"x-component-props":{...yearMonthDaySelectorSegment["x-component-props"],formatter:expression(`({ cellValue, row, column }) => {
                parseTime(row.planVisitTime, '{y}-{m}-{d}')
              }`)},"x-render-table-column":{width:130,skipEditable:!0}},visitDays:{type:"string",title:"{{$t('vendorMod.visitDays')}}","x-render-table-column":{width:130,skipEditable:!0}},approveStatus:{type:"string",title:"{{$t('vendorMod.status')}}","x-component":"DictSelect","x-component-props":{code:"approveStatus"},"x-render-table-column":{width:120,skipEditable:!0}},operation:{type:"void",title:"{{$t('common.operation')}}","x-render-table-column":{width:150,fixed:"right"},"x-component":"RenderTableButtonList",properties:{confirm:{type:"void",title:i18nExpression("components.common.confirm"),"x-reactions":changeFieldVisibleByDeps([".approveStatus"],"['RELEASED'].includes($deps[0])"),"x-component-props":{type:"text","@click":expression(`({ row, rowIndex }) => {
                    let rows = row
                  ...
                  }`)}},refuse:{type:"void",title:i18nExpression("common.toRefuse"),"x-reactions":changeFieldVisibleByDeps([".approveStatus"],"['RELEASED'].includes($deps[0])"),"x-component-props":{type:"text","@click":expression(`({ row, rowIndex }) => {
                    let rows = row
                    const vendorContact = rows.vendorContact
                    const vendorContactTel = rows.vendorContactTel
                    if (!vendorContact || !vendorContactTel || vendorContact == '' || vendorContactTel == '') {
                  ...
                  }`)}}}}})},DialogCategory:{...DialogMainCategory}}}});return{__sfc:!0,emitTabAdd,app,schema,scope:{emitTabAdd,app,sitereviewplanconfirmEdit},components:{Cselect:DictSelect},RenderEngine}}});var _sfc_render$1=function(){var _vm=this,_c=_vm._self._c,_setup=_vm._self._setupProxy;return _c(_setup.RenderEngine,{staticClass:"contractPaymentType",attrs:{schemaKey:"vendorSiteReviewPlanConfirmList",schema:_setup.schema,scope:_setup.scope,components:_setup.components}})},_sfc_staticRenderFns$1=[],__component__$1=normalizeComponent(_sfc_main$1,_sfc_render$1,_sfc_staticRenderFns$1,!1,null,null,null,null);const vendorSiteReviewPlanConfirmEngine=__component__$1.exports,_sfc_main={name:"VendorSiteReviewPlanConfirm",components:{NavTabs},data(){return{activeTab:"vendorSiteReviewPlanConfirmEngine",tabs:[{title:this.$t("route.vendorSiteReviewPlanConfirm"),name:"vendorSiteReviewPlanConfirmEngine",component:vendorSiteReviewPlanConfirmEngine,closable:!1}]}},activated(){this.activeTab==="vendorSiteReviewPlanConfirmEngine"&&this.dolayout()},methods:{dolayout(){this.$nextTick(()=>{const data={name:"vendorSiteReviewPlanConfirmEngine",methods:"dolayout",params:null,random:Math.random()};this.$store.commit("navTabs/SET_NAV_TABS_TODO",data)})},tabChange(tab){tab==="vendorSiteReviewPlanConfirmEngine"&&this.dolayout(),this.activeTab=tab}}};var _sfc_render=function(){var _vm=this,_c=_vm._self._c;return _c("NavTabs",{ref:"tabs",attrs:{"tabs-list":_vm.tabs,"cur-tab":_vm.activeTab},on:{"tab-change":_vm.tabChange}})},_sfc_staticRenderFns=[],__component__=normalizeComponent(_sfc_main,_sfc_render,_sfc_staticRenderFns,!1,null,null,null,null);const index=__component__.exports;export{index as default};
