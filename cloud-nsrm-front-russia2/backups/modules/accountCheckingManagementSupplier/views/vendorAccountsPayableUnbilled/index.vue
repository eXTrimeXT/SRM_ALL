...
export default {
  ...
  data () {
    return {
      ...
      iModal: {
        ...
        upLoadUrl:
          '/api-sup-ce/reconciliation/shouldPayOpenBill/saveByExcel'
      },
      extraData: {
        fileModular: 'sup-ce',
        fileFunction: 'vendorAccountsPayableUnbilled',
        fileType: 'excel'
      },
      total: 15,
      gridData: [],
  ...
  methods: {
    ...
    downloadTemplate () {
      downloadFileLink(
        '/api-file/template/supcooperate/应付未开票明细模板.xls',
        this.$t('accountMod.payableUninvoicedDetailTemp')
      ).catch(() => {
