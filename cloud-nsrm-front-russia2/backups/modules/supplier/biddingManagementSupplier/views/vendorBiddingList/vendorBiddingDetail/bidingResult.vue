<template>
  <div class="biding-result">
    <FormWrapper
      ...
      @getFormData="getBidingOrderResult"
    />
...
export default {
  ...
  methods: {
    ...
    /* 查询列表数据 */
    getBidingOrderResult (searchFormData = {}) {
      if (!this.bidingId) return

      this.$http({
        url: '/api-bid/supplierCooperate/orderHead/getBiding/orderResult',
        method: 'POST',
        data: {
