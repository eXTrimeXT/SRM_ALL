            ...
            >
              <el-row :gutter="32">
                ...
                <el-col :span="6">
                  ...
                  >
                    <el-input
                      v-model="contractHead.createdBy"
                      disabled
                    />
                  </el-form-item>
                </el-col>
...
export default {
  ...
  methods: {
    ...
    setCurrencyObj (row) {
      if (this.currencyList.filter((v) => v.value === row.currencyCode)) {
        row.currencyId = this.currencyList.filter((v) => v.value === row.currencyCode)[0].id
        row.currencyName = this.currencyList.filter((v) => v.value === row.currencyCode)[0].label
      } else {
        row.currencyId = ''
        row.currencyName = ''
      }
    ...
    backBill () {
      this.$emit('tab-remove', 'contractMaintainDetailRead' + this.$attrs.params.row.contractName)
